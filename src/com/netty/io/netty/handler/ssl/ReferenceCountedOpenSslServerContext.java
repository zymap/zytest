...
public final class ReferenceCountedOpenSslServerContext extends ReferenceCountedOpenSslContext {
    private static final InternalLogger logger =
            InternalLoggerFactory.getInstance(io.netty.handler.ssl.ReferenceCountedOpenSslServerContext.class);
    ...
    static ServerContext newSessionContext(ReferenceCountedOpenSslContext thiz, long ctx, io.netty.handler.ssl.OpenSslEngineMap engineMap,
    ...
    private static final class OpenSslSniHostnameMatcher implements SniHostNameMatcher {
        ...
        OpenSslSniHostnameMatcher(io.netty.handler.ssl.OpenSslEngineMap engineMap) {

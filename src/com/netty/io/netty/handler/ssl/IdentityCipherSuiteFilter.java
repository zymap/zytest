...
public final class IdentityCipherSuiteFilter implements CipherSuiteFilter {
     ...
     */
    public static final io.netty.handler.ssl.IdentityCipherSuiteFilter INSTANCE = new io.netty.handler.ssl.IdentityCipherSuiteFilter(true);
    ...
    public static final io.netty.handler.ssl.IdentityCipherSuiteFilter INSTANCE_DEFAULTING_TO_SUPPORTED_CIPHERS =
            new io.netty.handler.ssl.IdentityCipherSuiteFilter(false);

...
/**
 * Adapter class which allows to wrap another {@link io.netty.handler.ssl.SslContext} and init {@link SSLEngine} instances.
 */
public abstract class DelegatingSslContext extends io.netty.handler.ssl.SslContext {

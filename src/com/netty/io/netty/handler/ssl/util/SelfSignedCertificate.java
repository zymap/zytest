...
public final class SelfSignedCertificate {
    ...
    public SelfSignedCertificate(String fqdn, Date notBefore, Date notAfter) throws CertificateException {
        ...
        this(fqdn, io.netty.handler.ssl.util.ThreadLocalInsecureRandom.current(), 1024, notBefore, notAfter);
    }
    ...
    public SelfSignedCertificate(String fqdn, SecureRandom random, int bits, Date notBefore, Date notAfter)
        ...
        try {
            ...
            try {
                ...
                paths = io.netty.handler.ssl.util.BouncyCastleSelfSignedCertGenerator.generate(fqdn, keypair, random, notBefore, notAfter);
            } catch (Throwable t2) {

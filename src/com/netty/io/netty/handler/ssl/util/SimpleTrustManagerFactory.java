...
package com.netty.io.netty.handler.ssl.util;
...
public abstract class SimpleTrustManagerFactory extends TrustManagerFactory {
    ...
    /**
     * {@link SimpleTrustManagerFactorySpi} must have a reference to {@link io.netty.handler.ssl.util.SimpleTrustManagerFactory}
     * to delegate its callbacks back to {@link io.netty.handler.ssl.util.SimpleTrustManagerFactory}.  However, it is impossible to do so,
    ...
    static final class SimpleTrustManagerFactorySpi extends TrustManagerFactorySpi {
        ...
        void init(io.netty.handler.ssl.util.SimpleTrustManagerFactory parent) {
            this.parent = parent;
        }

 ...
 * user to pass PEM/PKCS#8 encoded key material straight into {@link io.netty.handler.ssl.OpenSslContext}
...
public final class PemPrivateKey extends AbstractReferenceCounted implements PrivateKey, PemEncoded {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    io.netty.handler.ssl.PemValue value = new io.netty.handler.ssl.PemValue(pem, true);
                    success = true;
                    return value;
                } finally {
    ...
    /**
     * Creates a {@link io.netty.handler.ssl.PemPrivateKey} from raw {@code byte[]}.
     *
     ...
     */
    public static io.netty.handler.ssl.PemPrivateKey valueOf(byte[] key) {
        return valueOf(Unpooled.wrappedBuffer(key));
    }

    /**
     * Creates a {@link io.netty.handler.ssl.PemPrivateKey} from raw {@code ByteBuf}.
     *
     * ATTENTION: It's assumed that the given argument is a PEM/PKCS#8 encoded value.
     * No input validation is performed to validate it.
     */
    public static io.netty.handler.ssl.PemPrivateKey valueOf(ByteBuf key) {
        return new io.netty.handler.ssl.PemPrivateKey(key);
    }
    ...
    @Override
    public io.netty.handler.ssl.PemPrivateKey replace(ByteBuf content) {
        return new io.netty.handler.ssl.PemPrivateKey(content);
    }
    ...
    @Override
    public io.netty.handler.ssl.PemPrivateKey touch(Object hint) {
        content.touch(hint);
        return this;
    }
    ...
    public io.netty.handler.ssl.PemPrivateKey retain() {
        return (io.netty.handler.ssl.PemPrivateKey) super.retain();
    }

    @Override
    public io.netty.handler.ssl.PemPrivateKey retain(int increment) {
        return (io.netty.handler.ssl.PemPrivateKey) super.retain(increment);
    }

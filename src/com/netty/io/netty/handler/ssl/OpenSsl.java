...
public final class OpenSsl {
    ...
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.handler.ssl.OpenSsl.class);
    ...
    static {
        ...
        try {
            Class.forName("io.netty.internal.tcnative.SSL", false, io.netty.handler.ssl.OpenSsl.class.getClassLoader());
        } catch (ClassNotFoundException t) {
            cause = t;
            logger.debug(
                    "netty-tcnative not in the classpath; " +
                    io.netty.handler.ssl.OpenSslEngine.class.getSimpleName() + " will be unavailable.");
        }
            ...
            try {
                ...
                logger.debug(
                    "Failed to load netty-tcnative; " +
                        io.netty.handler.ssl.OpenSslEngine.class.getSimpleName() + " will be unavailable, unless the " +
        ...
        if (cause == null) {
            ...
            for (String cipher: AVAILABLE_OPENSSL_CIPHER_SUITES) {
                ...
                availableJavaCipherSuites.add(io.netty.handler.ssl.CipherSuiteConverter.toJava(cipher, "TLS"));
                availableJavaCipherSuites.add(io.netty.handler.ssl.CipherSuiteConverter.toJava(cipher, "SSL"));
            }
    ...
    public static boolean isCipherSuiteAvailable(String cipherSuite) {
        String converted = io.netty.handler.ssl.CipherSuiteConverter.toOpenSsl(cipherSuite);
        if (converted != null) {

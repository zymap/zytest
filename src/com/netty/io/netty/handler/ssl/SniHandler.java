...
public class SniHandler extends AbstractSniHandler<SslContext> {
    ...
    /**
     * The default implementation of this method will simply replace {@code this} {@link io.netty.handler.ssl.SniHandler}
     * instance with a {@link io.netty.handler.ssl.SslHandler}. Users may override this method to implement custom behavior.
     *
    ...
    protected void replaceHandler(ChannelHandlerContext ctx, String hostname, SslContext sslContext) throws Exception {
        io.netty.handler.ssl.SslHandler sslHandler = null;
        try {

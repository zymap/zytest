...
public final class SslContextBuilder {
    ...
    public static io.netty.handler.ssl.SslContextBuilder forClient() {
        return new io.netty.handler.ssl.SslContextBuilder(false);
    }
    ...
    public static io.netty.handler.ssl.SslContextBuilder forServer(File keyCertChainFile, File keyFile) {
        return new io.netty.handler.ssl.SslContextBuilder(true).keyManager(keyCertChainFile, keyFile);
    }
     ...
     */
    public static io.netty.handler.ssl.SslContextBuilder forServer(InputStream keyCertChainInputStream, InputStream keyInputStream) {
        return new io.netty.handler.ssl.SslContextBuilder(true).keyManager(keyCertChainInputStream, keyInputStream);
    }
     ...
     */
    public static io.netty.handler.ssl.SslContextBuilder forServer(PrivateKey key, X509Certificate... keyCertChain) {
        return new io.netty.handler.ssl.SslContextBuilder(true).keyManager(key, keyCertChain);
    }
     ...
     */
    public static io.netty.handler.ssl.SslContextBuilder forServer(
            File keyCertChainFile, File keyFile, String keyPassword) {
        return new io.netty.handler.ssl.SslContextBuilder(true).keyManager(keyCertChainFile, keyFile, keyPassword);
    }
    ...
    public static io.netty.handler.ssl.SslContextBuilder forServer(
        ...
        return new io.netty.handler.ssl.SslContextBuilder(true).keyManager(keyCertChainInputStream, keyInputStream, keyPassword);
    }
    ...
    public static io.netty.handler.ssl.SslContextBuilder forServer(
        ...
        return new io.netty.handler.ssl.SslContextBuilder(true).keyManager(key, keyPassword, keyCertChain);
    }
     ...
     */
    public static io.netty.handler.ssl.SslContextBuilder forServer(KeyManagerFactory keyManagerFactory) {
        return new io.netty.handler.ssl.SslContextBuilder(true).keyManager(keyManagerFactory);
    }
    ...
    private CipherSuiteFilter cipherFilter = io.netty.handler.ssl.IdentityCipherSuiteFilter.INSTANCE;
     ...
     */
    public io.netty.handler.ssl.SslContextBuilder sslProvider(SslProvider provider) {
     ...
     */
    public io.netty.handler.ssl.SslContextBuilder sslContextProvider(Provider sslContextProvider) {
     ...
     */
    public io.netty.handler.ssl.SslContextBuilder trustManager(File trustCertCollectionFile) {
        try {
     ...
     * contain an X.509 certificate collection in PEM format. {@code null} uses the system default.
     */
    public io.netty.handler.ssl.SslContextBuilder trustManager(InputStream trustCertCollectionInputStream) {
        try {
     ...
     */
    public io.netty.handler.ssl.SslContextBuilder trustManager(X509Certificate... trustCertCollection) {
     ...
     */
    public io.netty.handler.ssl.SslContextBuilder trustManager(TrustManagerFactory trustManagerFactory) {
     ...
     * @param keyFile a PKCS#8 private key file in PEM format
     */
    public io.netty.handler.ssl.SslContextBuilder keyManager(File keyCertChainFile, File keyFile) {
     ...
     * @param keyInputStream an input stream for a PKCS#8 private key in PEM format
     */
    public io.netty.handler.ssl.SslContextBuilder keyManager(InputStream keyCertChainInputStream, InputStream keyInputStream) {
     ...
     */
    public io.netty.handler.ssl.SslContextBuilder keyManager(PrivateKey key, X509Certificate... keyCertChain) {
     ...
     *     password-protected
     */
    public io.netty.handler.ssl.SslContextBuilder keyManager(File keyCertChainFile, File keyFile, String keyPassword) {
     ...
     * @param keyCertChain an X.509 certificate chain
     */
    public io.netty.handler.ssl.SslContextBuilder keyManager(PrivateKey key, String keyPassword, X509Certificate... keyCertChain) {
        if (forServer) {
     ...
     */
    public io.netty.handler.ssl.SslContextBuilder keyManager(KeyManagerFactory keyManagerFactory) {
        if (forServer) {
     ...
     * cipher suites.
     */
    public io.netty.handler.ssl.SslContextBuilder ciphers(Iterable<String> ciphers) {
     ...
     */
    public io.netty.handler.ssl.SslContextBuilder ciphers(Iterable<String> ciphers, CipherSuiteFilter cipherFilter) {
     ...
     */
    public io.netty.handler.ssl.SslContextBuilder applicationProtocolConfig(ApplicationProtocolConfig apn) {
        this.apn = apn;
        return this;
    }
     ...
     * default value.
     */
    public io.netty.handler.ssl.SslContextBuilder sessionCacheSize(long sessionCacheSize) {
     ...
     * default value.
     */
    public io.netty.handler.ssl.SslContextBuilder sessionTimeout(long sessionTimeout) {
     ...
     */
    public io.netty.handler.ssl.SslContextBuilder clientAuth(ClientAuth clientAuth) {
     ...
     */
    public io.netty.handler.ssl.SslContextBuilder protocols(String... protocols) {
     ...
     */
    public io.netty.handler.ssl.SslContextBuilder startTls(boolean startTls) {
     ...
     */
    @UnstableApi
    public io.netty.handler.ssl.SslContextBuilder enableOcsp(boolean enableOcsp) {

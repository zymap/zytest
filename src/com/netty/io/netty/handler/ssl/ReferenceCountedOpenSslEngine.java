 ...
 */
public class ReferenceCountedOpenSslEngine extends SSLEngine implements ReferenceCounted, io.netty.handler.ssl.ApplicationProtocolAccessor {

    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.handler.ssl.ReferenceCountedOpenSslEngine.class);

    private static final SSLException BEGIN_HANDSHAKE_ENGINE_CLOSED = ThrowableUtil.unknownStackTrace(
            new SSLException("engine closed"), io.netty.handler.ssl.ReferenceCountedOpenSslEngine.class, "beginHandshake()");
    private static final SSLException HANDSHAKE_ENGINE_CLOSED = ThrowableUtil.unknownStackTrace(
            new SSLException("engine closed"), io.netty.handler.ssl.ReferenceCountedOpenSslEngine.class, "handshake()");
    private static final SSLException RENEGOTIATION_UNSUPPORTED =  ThrowableUtil.unknownStackTrace(
            new SSLException("renegotiation unsupported"), io.netty.handler.ssl.ReferenceCountedOpenSslEngine.class, "beginHandshake()");
    private static final ResourceLeakDetector<io.netty.handler.ssl.ReferenceCountedOpenSslEngine> leakDetector =
            ResourceLeakDetectorFactory.instance().newResourceLeakDetector(io.netty.handler.ssl.ReferenceCountedOpenSslEngine.class);
    ...
    private static final AtomicIntegerFieldUpdater<io.netty.handler.ssl.ReferenceCountedOpenSslEngine> DESTROYED_UPDATER =
            AtomicIntegerFieldUpdater.newUpdater(io.netty.handler.ssl.ReferenceCountedOpenSslEngine.class, "destroyed");
    ...
    // Reference Counting
    private final ResourceLeakTracker<io.netty.handler.ssl.ReferenceCountedOpenSslEngine> leak;
    private final AbstractReferenceCounted refCnt = new AbstractReferenceCounted() {
        ...
        public ReferenceCounted touch(Object hint) {
            ...
            return io.netty.handler.ssl.ReferenceCountedOpenSslEngine.this;
        }
        ...
        protected void deallocate() {
            shutdown();
            if (leak != null) {
                boolean closed = leak.close(io.netty.handler.ssl.ReferenceCountedOpenSslEngine.this);
                assert closed;
            }
        }
    };
    ...
    /**
     * Returns the pointer to the {@code SSL} object for this {@link io.netty.handler.ssl.ReferenceCountedOpenSslEngine}.
    ...
    public final synchronized SSLParameters getSSLParameters() {
        ...
        if (version >= 7) {
            ...
            io.netty.handler.ssl.Java7SslParametersUtils.setAlgorithmConstraints(sslParameters, algorithmConstraints);
            if (version >= 8) {
    ...
    private final class OpenSslSession implements SSLSession {
        ...
        @Override
        public byte[] getId() {
            synchronized (io.netty.handler.ssl.ReferenceCountedOpenSslEngine.this) {
                if (id == null) {
        ...
        public long getLastAccessedTime() {
            long lastAccessed = io.netty.handler.ssl.ReferenceCountedOpenSslEngine.this.lastAccessed;
            ...
            switch (apn.protocol()) {
                ...
                case ALPN:
                    ...
                    if (applicationProtocol != null) {
                        io.netty.handler.ssl.ReferenceCountedOpenSslEngine.this.applicationProtocol = selectApplicationProtocol(
        ...
        public String getPeerHost() {
            return io.netty.handler.ssl.ReferenceCountedOpenSslEngine.this.getPeerHost();
        }

        @Override
        public int getPeerPort() {
            return io.netty.handler.ssl.ReferenceCountedOpenSslEngine.this.getPeerPort();
        }

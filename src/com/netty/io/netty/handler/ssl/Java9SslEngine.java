...
final class Java9SslEngine extends JdkSslEngine {
    ...
    Java9SslEngine(SSLEngine engine, JdkApplicationProtocolNegotiator applicationNegotiator, boolean isServer) {
        ...
        if (isServer) {
            ...
            io.netty.handler.ssl.Java9SslUtils.setHandshakeApplicationProtocolSelector(engine, alpnSelector);
        } else {
            selectionListener = applicationNegotiator.protocolListenerFactory()
                    .newListener(this, applicationNegotiator.protocols());
            alpnSelector = null;
            io.netty.handler.ssl.Java9SslUtils.setApplicationProtocols(engine, applicationNegotiator.protocols());
        }
    }
    ...
    public String getApplicationProtocol() {
        return io.netty.handler.ssl.Java9SslUtils.getApplicationProtocol(getWrappedEngine());
    }

    public String getHandshakeApplicationProtocol() {
        return io.netty.handler.ssl.Java9SslUtils.getHandshakeApplicationProtocol(getWrappedEngine());
    }

    public void setHandshakeApplicationProtocolSelector(BiFunction<SSLEngine, List<String>, String> selector) {
        io.netty.handler.ssl.Java9SslUtils.setHandshakeApplicationProtocolSelector(getWrappedEngine(), selector);
    }

    public BiFunction<SSLEngine, List<String>, String> getHandshakeApplicationProtocolSelector() {
        return io.netty.handler.ssl.Java9SslUtils.getHandshakeApplicationProtocolSelector(getWrappedEngine());
    }
}

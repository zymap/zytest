 ...
 * {@link io.netty.handler.ssl.SslContext} sslCtx = {@link SslContextBuilder#forServer(File, File) SslContextBuilder.forServer(...)}.build();
 ...
 * // In your {@link ChannelInitializer}:
 * {@link ChannelPipeline} p = channel.pipeline();
 * {@link io.netty.handler.ssl.SslContext} sslCtx = {@link SslContextBuilder#forClient() SslContextBuilder.forClient()}.build();
...
public abstract class SslContext {
    ...
    /**
     * Creates a new server-side {@link io.netty.handler.ssl.SslContext}.
     *
     * @param certChainFile an X.509 certificate chain file in PEM format
     * @param keyFile a PKCS#8 private key file in PEM format
     * @return a new server-side {@link io.netty.handler.ssl.SslContext}
     * @deprecated Replaced by {@link SslContextBuilder}
     */
    @Deprecated
    public static io.netty.handler.ssl.SslContext newServerContext(File certChainFile, File keyFile) throws SSLException {
     ...
     */
    @Deprecated
    public static io.netty.handler.ssl.SslContext newServerContext(
     ...
     * Creates a new server-side {@link io.netty.handler.ssl.SslContext}.
     *
     * @param provider the {@link io.netty.handler.ssl.SslContext} implementation to use.
     ...
     */
    @Deprecated
    public static io.netty.handler.ssl.SslContext newServerContext(SslProvider provider,
                                                                   File certChainFile, File keyFile, String keyPassword,
                                                                   Iterable<String> ciphers, CipherSuiteFilter cipherFilter, ApplicationProtocolConfig apn,
                                                                   long sessionCacheSize, long sessionTimeout) throws SSLException {
    ...
    static io.netty.handler.ssl.SslContext newServerContextInternal(
            SslProvider provider,
    ...
    /**
     * Creates a new client-side {@link io.netty.handler.ssl.SslContext}.
     *
     * @return a new client-side {@link io.netty.handler.ssl.SslContext}
     * @deprecated Replaced by {@link SslContextBuilder}
     */
    @Deprecated
    public static io.netty.handler.ssl.SslContext newClientContext() throws SSLException {
     ...
     */
    @Deprecated
    public static io.netty.handler.ssl.SslContext newClientContext(File certChainFile) throws SSLException {
     ...
     */
    @Deprecated
    public static io.netty.handler.ssl.SslContext newClientContext(TrustManagerFactory trustManagerFactory) throws SSLException {
     ...
     */
    @Deprecated
    public static io.netty.handler.ssl.SslContext newClientContext(SslProvider provider) throws SSLException {
     ...
     */
    @Deprecated
    public static io.netty.handler.ssl.SslContext newClientContext(SslProvider provider, File certChainFile) throws SSLException {
    ...
    static io.netty.handler.ssl.SslContext newClientContextInternal(
            SslProvider provider,
            Provider sslContextProvider,

...
/**
 * {@link io.netty.handler.ssl.OptionalSslHandler} is a utility decoder to support both SSL and non-SSL handlers
...
public class OptionalSslHandler extends ByteToMessageDecoder {
    ...
    protected void decode(ChannelHandlerContext context, ByteBuf in, List<Object> out) throws Exception {
        if (in.readableBytes() < io.netty.handler.ssl.SslUtils.SSL_RECORD_HEADER_LENGTH) {
            return;
        }
     ...
     * @return the {@link SslHandler} which will replace the {@link io.netty.handler.ssl.OptionalSslHandler} in the pipeline if the
     * traffic is SSL.
     */
     ...
     * @param context the {@link ChannelHandlerContext} to use.
     * @return the {@link ChannelHandler} which will replace the {@link io.netty.handler.ssl.OptionalSslHandler} in the pipeline
     * or {@code null} to simply remove the {@link io.netty.handler.ssl.OptionalSslHandler} if the traffic is non-SSL.
     */

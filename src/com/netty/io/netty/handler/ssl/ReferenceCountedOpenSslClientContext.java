...
public final class ReferenceCountedOpenSslClientContext extends ReferenceCountedOpenSslContext {
    private static final InternalLogger logger =
            InternalLoggerFactory.getInstance(io.netty.handler.ssl.ReferenceCountedOpenSslClientContext.class);
        ...
        try {
            if (!OpenSsl.useKeyManagerFactory()) {
                ...
                if (keyManagerFactory != null) {
                    ...
                    io.netty.handler.ssl.OpenSslKeyMaterialManager materialManager = useExtendedKeyManager(keyManager) ?
                            new io.netty.handler.ssl.OpenSslExtendedKeyMaterialManager(
                                    (X509ExtendedKeyManager) keyManager, keyPassword) :
                            new io.netty.handler.ssl.OpenSslKeyMaterialManager(keyManager, keyPassword);
    ...
    private static final class TrustManagerVerifyCallback extends AbstractCertificateVerifier {
        ...
        TrustManagerVerifyCallback(io.netty.handler.ssl.OpenSslEngineMap engineMap, X509TrustManager manager) {
            super(engineMap);
    ...
    private static final class ExtendedTrustManagerVerifyCallback extends AbstractCertificateVerifier {
        ...
        ExtendedTrustManagerVerifyCallback(io.netty.handler.ssl.OpenSslEngineMap engineMap, X509ExtendedTrustManager manager) {
            super(engineMap);
            this.manager = manager;
        }
    ...
    private static final class OpenSslCertificateRequestedCallback implements CertificateRequestedCallback {
        ...
        OpenSslCertificateRequestedCallback(io.netty.handler.ssl.OpenSslEngineMap engineMap, io.netty.handler.ssl.OpenSslKeyMaterialManager keyManagerHolder) {
        ...
        private static String clientKeyType(byte clientCertificateType) {
            ...
            switch (clientCertificateType) {
                case CertificateRequestedCallback.TLS_CT_RSA_SIGN:
                    return io.netty.handler.ssl.OpenSslKeyMaterialManager.KEY_TYPE_RSA; // RFC rsa_sign
                case CertificateRequestedCallback.TLS_CT_RSA_FIXED_DH:
                    return io.netty.handler.ssl.OpenSslKeyMaterialManager.KEY_TYPE_DH_RSA; // RFC rsa_fixed_dh
                case CertificateRequestedCallback.TLS_CT_ECDSA_SIGN:
                    return io.netty.handler.ssl.OpenSslKeyMaterialManager.KEY_TYPE_EC; // RFC ecdsa_sign
                case CertificateRequestedCallback.TLS_CT_RSA_FIXED_ECDH:
                    return io.netty.handler.ssl.OpenSslKeyMaterialManager.KEY_TYPE_EC_RSA; // RFC rsa_fixed_ecdh
                case CertificateRequestedCallback.TLS_CT_ECDSA_FIXED_ECDH:
                    return io.netty.handler.ssl.OpenSslKeyMaterialManager.KEY_TYPE_EC_EC; // RFC ecdsa_fixed_ecdh
                default:
                    return null;
            }
        }

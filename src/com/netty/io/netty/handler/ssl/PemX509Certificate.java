 ...
 * the user to pass PEM/PKCS#8 encoded data straight into {@link io.netty.handler.ssl.OpenSslContext} without
...
public final class PemX509Certificate extends X509Certificate implements PemEncoded {
    ...
    static PemEncoded toPEM(ByteBufAllocator allocator, boolean useDirect,
        ...
        try {
            ...
            io.netty.handler.ssl.PemValue value = new io.netty.handler.ssl.PemValue(pem, false);
            success = true;
            return value;
        } finally {
    ...
    /**
     * Creates a {@link io.netty.handler.ssl.PemX509Certificate} from raw {@code byte[]}.
     *
     ...
     */
    public static io.netty.handler.ssl.PemX509Certificate valueOf(byte[] key) {
        return valueOf(Unpooled.wrappedBuffer(key));
    }

    /**
     * Creates a {@link io.netty.handler.ssl.PemX509Certificate} from raw {@code ByteBuf}.
     *
     * ATTENTION: It's assumed that the given argument is a PEM/PKCS#8 encoded value.
     * No input validation is performed to validate it.
     */
    public static io.netty.handler.ssl.PemX509Certificate valueOf(ByteBuf key) {
        return new io.netty.handler.ssl.PemX509Certificate(key);
    }
    ...
    @Override
    public io.netty.handler.ssl.PemX509Certificate replace(ByteBuf content) {
        return new io.netty.handler.ssl.PemX509Certificate(content);
    }
    ...
    @Override
    public io.netty.handler.ssl.PemX509Certificate retain(int increment) {
    ...
    @Override
    public io.netty.handler.ssl.PemX509Certificate touch(Object hint) {
        content.touch(hint);
        return this;
    }
    ...
    public boolean equals(Object o) {
        if (o == this) {
            return true;
        } else if (!(o instanceof io.netty.handler.ssl.PemX509Certificate)) {
            return false;
        }

        io.netty.handler.ssl.PemX509Certificate other = (io.netty.handler.ssl.PemX509Certificate) o;

...
public abstract class AbstractSniHandler<T> extends ByteToMessageDecoder implements ChannelOutboundHandler {
    ...
    private static final InternalLogger logger =
            InternalLoggerFactory.getInstance(io.netty.handler.ssl.AbstractSniHandler.class);
                    ...
                    switch (command) {
                        ...
                        case SslUtils.SSL_CONTENT_TYPE_ALERT:
                            ...
                            if (len == SslUtils.NOT_ENCRYPTED) {
                                ...
                                io.netty.handler.ssl.NotSslRecordException e = new io.netty.handler.ssl.NotSslRecordException(

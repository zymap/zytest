...
/**
 * An {@link io.netty.handler.ssl.SslContext} which uses JDK's SSL/TLS implementation.
 */
public class JdkSslContext extends SslContext {

    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.handler.ssl.JdkSslContext.class);
    ...
    /**
     * Creates a new {@link io.netty.handler.ssl.JdkSslContext} from a pre-configured {@link SSLContext}.
     *
    ...
    public JdkSslContext(SSLContext sslContext, boolean isClient,
        ...
        this(sslContext, isClient, null, IdentityCipherSuiteFilter.INSTANCE,
                io.netty.handler.ssl.JdkDefaultApplicationProtocolNegotiator.INSTANCE, clientAuth, null, false);
    }
    ...
    static JdkApplicationProtocolNegotiator toNegotiator(ApplicationProtocolConfig config, boolean isServer) {
        if (config == null) {
            return io.netty.handler.ssl.JdkDefaultApplicationProtocolNegotiator.INSTANCE;
        }

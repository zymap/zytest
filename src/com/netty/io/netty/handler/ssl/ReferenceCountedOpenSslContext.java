...
/**
 * An implementation of {@link io.netty.handler.ssl.SslContext} which works with libraries that support the
...
public abstract class ReferenceCountedOpenSslContext extends SslContext implements ReferenceCounted {
    private static final InternalLogger logger =
            InternalLoggerFactory.getInstance(io.netty.handler.ssl.ReferenceCountedOpenSslContext.class);
    ...
    private static final ResourceLeakDetector<io.netty.handler.ssl.ReferenceCountedOpenSslContext> leakDetector =
            ResourceLeakDetectorFactory.instance().newResourceLeakDetector(io.netty.handler.ssl.ReferenceCountedOpenSslContext.class);
    ...
    // Reference Counting
    private final ResourceLeakTracker<io.netty.handler.ssl.ReferenceCountedOpenSslContext> leak;
    private final AbstractReferenceCounted refCnt = new AbstractReferenceCounted() {
        ...
        public ReferenceCounted touch(Object hint) {
            ...
            return io.netty.handler.ssl.ReferenceCountedOpenSslContext.this;
        }
        ...
        protected void deallocate() {
            destroy();
            if (leak != null) {
                boolean closed = leak.close(io.netty.handler.ssl.ReferenceCountedOpenSslContext.this);
                assert closed;
            }
        }
    };
    ...
    /**
     * Returns the pointer to the {@code SSL_CTX} object for this {@link io.netty.handler.ssl.ReferenceCountedOpenSslContext}.

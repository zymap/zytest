 ...
 * under the License.
 */
package com.netty.io.netty.handler.traffic;
 ...
 * {@code checkInterval}, and calls the {@link AbstractTrafficShapingHandler#doAccounting(io.netty.handler.traffic.TrafficCounter)} method back.
...
public class TrafficCounter {
    ...
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.handler.traffic.TrafficCounter.class);
    ...
    private final class TrafficMonitoringTask implements Runnable {
        ...
        public void run() {
            ...
            if (trafficShapingHandler != null) {
                trafficShapingHandler.doAccounting(io.netty.handler.traffic.TrafficCounter.this);
            }
     ...
     * from {@link io.netty.handler.traffic.GlobalChannelTrafficCounter}.
     * @param name

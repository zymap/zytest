...
public abstract class AbstractTrafficShapingHandler extends ChannelDuplexHandler {
    private static final InternalLogger logger =
            InternalLoggerFactory.getInstance(io.netty.handler.traffic.AbstractTrafficShapingHandler.class);
    /**
    ...
    */
    ...
    static final AttributeKey<Boolean> READ_SUSPENDED = AttributeKey
            .valueOf(io.netty.handler.traffic.AbstractTrafficShapingHandler.class.getName() + ".READ_SUSPENDED");
    static final AttributeKey<Runnable> REOPEN_TASK = AttributeKey.valueOf(io.netty.handler.traffic.AbstractTrafficShapingHandler.class
            .getName() + ".REOPEN_TASK");

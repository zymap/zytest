...
public class ArrayRedisMessage extends AbstractReferenceCounted implements RedisMessage {
    ...
    /**
     * Creates a {@link io.netty.handler.codec.redis.ArrayRedisMessage} for the given {@code content}.
     *
    ...
    @Override
    public io.netty.handler.codec.redis.ArrayRedisMessage touch(Object hint) {
        for (RedisMessage msg : children) {
    ...
    /**
     * A predefined null array instance for {@link io.netty.handler.codec.redis.ArrayRedisMessage}.
     */
    public static final io.netty.handler.codec.redis.ArrayRedisMessage NULL_INSTANCE = new io.netty.handler.codec.redis.ArrayRedisMessage() {
        @Override
        public boolean isNull() {
            return true;
        }
        ...
        @Override
        public io.netty.handler.codec.redis.ArrayRedisMessage retain(int increment) {
            return this;
        }
    ...
    /**
     * A predefined empty array instance for {@link io.netty.handler.codec.redis.ArrayRedisMessage}.
     */
    public static final io.netty.handler.codec.redis.ArrayRedisMessage EMPTY_INSTANCE = new io.netty.handler.codec.redis.ArrayRedisMessage() {
        @Override
        public boolean isNull() {
            return false;
        }

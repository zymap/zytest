...
public class BulkStringHeaderRedisMessage implements RedisMessage {
    ...
    /**
     * Creates a {@link io.netty.handler.codec.redis.BulkStringHeaderRedisMessage}.
     *
    ...
    public boolean isNull() {
        return bulkStringLength == io.netty.handler.codec.redis.RedisConstants.NULL_VALUE;
    }
}

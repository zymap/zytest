...
public final class DefaultLastBulkStringRedisContent extends DefaultBulkStringRedisContent
    ...
    /**
     * Creates a {@link io.netty.handler.codec.redis.DefaultLastBulkStringRedisContent} for the given {@code content}.
    ...
    public LastBulkStringRedisContent replace(ByteBuf content) {
        return new io.netty.handler.codec.redis.DefaultLastBulkStringRedisContent(content);
    }

...
public final class FixedRedisMessagePool implements RedisMessagePool {
    ...
    private static final long MIN_CACHED_INTEGER_NUMBER = io.netty.handler.codec.redis.RedisConstants.NULL_VALUE; // inclusive
    ...
    /**
     * A shared object for {@link io.netty.handler.codec.redis.FixedRedisMessagePool}.
     */
    public static final io.netty.handler.codec.redis.FixedRedisMessagePool INSTANCE = new io.netty.handler.codec.redis.FixedRedisMessagePool();
    ...
    /**
     * Creates a {@link io.netty.handler.codec.redis.FixedRedisMessagePool} instance.
     */
    private FixedRedisMessagePool() {
        ...
        for (long value = MIN_CACHED_INTEGER_NUMBER; value < MAX_CACHED_INTEGER_NUMBER; value++) {
            byte[] keyBytes = io.netty.handler.codec.redis.RedisCodecUtil.longToAsciiBytes(value);

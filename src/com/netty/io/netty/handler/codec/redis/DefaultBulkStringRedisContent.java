...
public class DefaultBulkStringRedisContent extends DefaultByteBufHolder implements BulkStringRedisContent {
    ...
    /**
     * Creates a {@link io.netty.handler.codec.redis.DefaultBulkStringRedisContent} for the given {@code content}.
     *
    ...
    public BulkStringRedisContent replace(ByteBuf content) {
        return new io.netty.handler.codec.redis.DefaultBulkStringRedisContent(content);
    }

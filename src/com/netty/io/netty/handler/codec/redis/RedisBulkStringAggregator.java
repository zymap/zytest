 ...
 * p.addLast("aggregator", <b>new {@link io.netty.handler.codec.redis.RedisBulkStringAggregator}()</b>);
 * ...
 * p.addLast("handler", new HttpRequestHandler());
 * </pre>
 * Be aware that you need to have the {@link RedisEncoder} before the {@link io.netty.handler.codec.redis.RedisBulkStringAggregator}
...
public final class RedisBulkStringAggregator extends MessageAggregator<RedisMessage, BulkStringHeaderRedisMessage,
    ...
    public RedisBulkStringAggregator() {
        super(io.netty.handler.codec.redis.RedisConstants.REDIS_MESSAGE_MAX_LENGTH);
    }

...
/**
 * {@link UnsupportedOperationException} will be thrown from all {@link io.netty.handler.codec.ValueConverter} methods.
 */
public final class UnsupportedValueConverter<V> implements ValueConverter<V> {
    @SuppressWarnings("rawtypes")
    private static final io.netty.handler.codec.UnsupportedValueConverter INSTANCE = new io.netty.handler.codec.UnsupportedValueConverter();
    private UnsupportedValueConverter() { }

    @SuppressWarnings("unchecked")
    public static <V> io.netty.handler.codec.UnsupportedValueConverter<V> instance() {
        return (io.netty.handler.codec.UnsupportedValueConverter<V>) INSTANCE;
    }

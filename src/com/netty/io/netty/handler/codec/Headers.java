...
/**
 * Common interface for {@link io.netty.handler.codec.Headers} which represents a mapping of key to value.
 ...
 */
public interface Headers<K, V, T extends io.netty.handler.codec.Headers<K, V, T>> extends Iterable<Entry<K, V>> {
    /**
     ...
     * @return {@code this}
     */
    T add(io.netty.handler.codec.Headers<? extends K, ? extends V, ?> headers);
     ...
     * @return {@code this}
     */
    T set(io.netty.handler.codec.Headers<? extends K, ? extends V, ?> headers);
     ...
     * @return {@code this}
     */
    T setAll(io.netty.handler.codec.Headers<? extends K, ? extends V, ?> headers);

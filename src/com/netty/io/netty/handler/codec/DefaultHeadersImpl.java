...
/**
 * A concrete implementation of {@link io.netty.handler.codec.DefaultHeaders} that allows for direct instantiation.
 * @param <K> the type of the header name.
 * @param <V> the type of the header value.
 */
public final class DefaultHeadersImpl<K, V> extends DefaultHeaders<K, V, io.netty.handler.codec.DefaultHeadersImpl<K, V>> {

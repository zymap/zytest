...
public class Lz4FrameDecoder extends ByteToMessageDecoder {
    ...
    public Lz4FrameDecoder(LZ4Factory factory, Checksum checksum) {
        ...
        this.checksum = checksum == null ? null : io.netty.handler.codec.compression.ByteBufChecksum.wrapChecksum(checksum);
    }
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) throws Exception {
        try {
            ...
            case DECOMPRESS_DATA:
                ...
                final io.netty.handler.codec.compression.ByteBufChecksum checksum = this.checksum;
                ...
                try {
                    switch (blockType) {
                        ...
                        case BLOCK_TYPE_COMPRESSED:
                            ...
                            decompressor.decompress(io.netty.handler.codec.compression.CompressionUtil.safeNioBuffer(in),
                    ...
                    if (checksum != null) {
                        io.netty.handler.codec.compression.CompressionUtil.checkChecksum(checksum, uncompressed, currentChecksum);
                    }

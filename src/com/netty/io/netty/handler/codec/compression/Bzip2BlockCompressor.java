 ...
 * 2. Burrows Wheeler Transform - {@link #close(ByteBuf)} (through {@link io.netty.handler.codec.compression.Bzip2DivSufSort})<br>
...
final class Bzip2BlockCompressor {
    ...
    void close(ByteBuf out) {
        ...
        io.netty.handler.codec.compression.Bzip2DivSufSort divSufSort = new io.netty.handler.codec.compression.Bzip2DivSufSort(block, bwtBlock, blockLength);
        ...
        io.netty.handler.codec.compression.Bzip2MTFAndRLE2StageEncoder mtfEncoder = new io.netty.handler.codec.compression.Bzip2MTFAndRLE2StageEncoder(bwtBlock, blockLength,
                                                                                    blockValuesPresent);
        mtfEncoder.encode();

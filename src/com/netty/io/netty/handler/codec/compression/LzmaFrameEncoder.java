...
public class LzmaFrameEncoder extends MessageToByteEncoder<ByteBuf> {
    ...
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.handler.codec.compression.LzmaFrameEncoder.class);
     ...
     * @param endMarkerMode
     *        indicates should {@link io.netty.handler.codec.compression.LzmaFrameEncoder} use end of stream marker or not.
     *        Note, that {@link io.netty.handler.codec.compression.LzmaFrameEncoder} always sets size of uncompressed data

...
abstract class ByteBufChecksum implements Checksum {
    ...
    static io.netty.handler.codec.compression.ByteBufChecksum wrapChecksum(Checksum checksum) {
    ...
    private static class SlowByteBufChecksum extends io.netty.handler.codec.compression.ByteBufChecksum {

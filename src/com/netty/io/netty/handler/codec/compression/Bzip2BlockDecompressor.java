 ...
 * under the License.
 */
package com.netty.io.netty.handler.codec.compression;
...
final class Bzip2BlockDecompressor {
    ...
    /* Move To Front stage */
    /**
     * Counts of each byte value within the {@link io.netty.handler.codec.compression.Bzip2BlockDecompressor#huffmanSymbolMap} data.
     ...
     */
    private final io.netty.handler.codec.compression.Bzip2MoveToFrontTable symbolMTF = new io.netty.handler.codec.compression.Bzip2MoveToFrontTable();
    ...
    Bzip2BlockDecompressor(final int blockSize, final int blockCRC, final boolean blockRandomised,
                           final int bwtStartPointer, final io.netty.handler.codec.compression.Bzip2BitReader reader) {
    ...
    boolean decodeHuffmanData(final Bzip2HuffmanStageDecoder huffmanDecoder) {
        final io.netty.handler.codec.compression.Bzip2BitReader reader = this.reader;
        ...
        final io.netty.handler.codec.compression.Bzip2MoveToFrontTable symbolMTF = this.symbolMTF;

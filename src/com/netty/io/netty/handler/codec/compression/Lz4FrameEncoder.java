...
public class Lz4FrameEncoder extends MessageToByteEncoder<ByteBuf> {
    private static final EncoderException ENCODE_FINSHED_EXCEPTION = unknownStackTrace(new EncoderException(
                    ...
                    io.netty.handler.codec.compression.Lz4FrameEncoder.class, "encode");
    ...
    public Lz4FrameEncoder(LZ4Factory factory, boolean highCompressor, int blockSize,
        ...
        this.checksum = io.netty.handler.codec.compression.ByteBufChecksum.wrapChecksum(checksum);
    ...
    /**
     * Close this {@link io.netty.handler.codec.compression.Lz4FrameEncoder} and so finish the encoding.
     *

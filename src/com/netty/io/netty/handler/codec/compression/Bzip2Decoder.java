...
public class Bzip2Decoder extends ByteToMessageDecoder {
     ...
     */
    private final io.netty.handler.codec.compression.Bzip2BitReader reader = new io.netty.handler.codec.compression.Bzip2BitReader();
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) throws Exception {
        ...
        for (;;) {
            ...
            case RECEIVE_SELECTORS:
                ...
                final io.netty.handler.codec.compression.Bzip2MoveToFrontTable tableMtf = huffmanStageDecoder.tableMTF;

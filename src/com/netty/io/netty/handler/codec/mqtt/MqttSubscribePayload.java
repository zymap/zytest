...
public final class MqttSubscribePayload {
    ...
    private final List<io.netty.handler.codec.mqtt.MqttTopicSubscription> topicSubscriptions;

    public MqttSubscribePayload(List<io.netty.handler.codec.mqtt.MqttTopicSubscription> topicSubscriptions) {

...
final class MqttCodecUtil {
    ...
    static boolean isValidClientId(io.netty.handler.codec.mqtt.MqttVersion mqttVersion, String clientId) {
        if (mqttVersion == io.netty.handler.codec.mqtt.MqttVersion.MQTT_3_1) {

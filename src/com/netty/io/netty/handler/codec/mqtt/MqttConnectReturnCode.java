...
public enum MqttConnectReturnCode {
    ...
    private static final Map<Byte, io.netty.handler.codec.mqtt.MqttConnectReturnCode> VALUE_TO_CODE_MAP;

    static {
        final Map<Byte, io.netty.handler.codec.mqtt.MqttConnectReturnCode> valueMap = new HashMap<Byte, io.netty.handler.codec.mqtt.MqttConnectReturnCode>();
        for (io.netty.handler.codec.mqtt.MqttConnectReturnCode code: values()) {
    ...
    public static io.netty.handler.codec.mqtt.MqttConnectReturnCode valueOf(byte b) {

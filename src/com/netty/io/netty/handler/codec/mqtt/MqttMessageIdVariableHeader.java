...
public final class MqttMessageIdVariableHeader {
    ...
    public static io.netty.handler.codec.mqtt.MqttMessageIdVariableHeader from(int messageId) {
      if (messageId < 1 || messageId > 0xffff) {
        throw new IllegalArgumentException("messageId: " + messageId + " (expected: 1 ~ 65535)");
      }
      return new io.netty.handler.codec.mqtt.MqttMessageIdVariableHeader(messageId);
    }

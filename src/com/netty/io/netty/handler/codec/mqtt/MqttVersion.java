...
public enum MqttVersion {
    ...
    public static io.netty.handler.codec.mqtt.MqttVersion fromProtocolNameAndLevel(String protocolName, byte protocolLevel) {
        for (io.netty.handler.codec.mqtt.MqttVersion mv : values()) {

...
public class DefaultSocks4CommandRequest extends AbstractSocks4Message implements Socks4CommandRequest {
     ...
     */
    public DefaultSocks4CommandRequest(io.netty.handler.codec.socksx.v4.Socks4CommandType type, String dstAddr, int dstPort) {
     ...
     */
    public DefaultSocks4CommandRequest(io.netty.handler.codec.socksx.v4.Socks4CommandType type, String dstAddr, int dstPort, String userId) {
        if (type == null) {

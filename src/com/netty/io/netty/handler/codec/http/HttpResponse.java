...
public interface HttpResponse extends HttpMessage {
    ...
    /**
     * Returns the status of this {@link io.netty.handler.codec.http.HttpResponse}.
     *
     * @return The {@link HttpResponseStatus} of this {@link io.netty.handler.codec.http.HttpResponse}
     */
    HttpResponseStatus status();

    /**
     * Set the status of this {@link io.netty.handler.codec.http.HttpResponse}.
     */
    io.netty.handler.codec.http.HttpResponse setStatus(HttpResponseStatus status);

    @Override
    io.netty.handler.codec.http.HttpResponse setProtocolVersion(HttpVersion version);
}

...
public interface InterfaceHttpPostRequestDecoder {
     ...
     *             errors
     */
    io.netty.handler.codec.http.multipart.InterfaceHttpPostRequestDecoder offer(HttpContent content);
    ...
    /**
     * Destroy the {@link io.netty.handler.codec.http.multipart.InterfaceHttpPostRequestDecoder} and release all it resources. After this method

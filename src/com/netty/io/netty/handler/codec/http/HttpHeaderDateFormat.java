...
public final class HttpHeaderDateFormat extends SimpleDateFormat {
    ...
    private static final FastThreadLocal<io.netty.handler.codec.http.HttpHeaderDateFormat> dateFormatThreadLocal =
            new FastThreadLocal<io.netty.handler.codec.http.HttpHeaderDateFormat>() {
                @Override
                protected io.netty.handler.codec.http.HttpHeaderDateFormat initialValue() {
                    return new io.netty.handler.codec.http.HttpHeaderDateFormat();
                }
            };

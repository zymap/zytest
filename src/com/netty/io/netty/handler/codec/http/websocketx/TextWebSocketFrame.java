...
public class TextWebSocketFrame extends WebSocketFrame {
    ...
    public io.netty.handler.codec.http.websocketx.TextWebSocketFrame copy() {
        return (io.netty.handler.codec.http.websocketx.TextWebSocketFrame) super.copy();
    }

    @Override
    public io.netty.handler.codec.http.websocketx.TextWebSocketFrame duplicate() {
        return (io.netty.handler.codec.http.websocketx.TextWebSocketFrame) super.duplicate();
    }

    @Override
    public io.netty.handler.codec.http.websocketx.TextWebSocketFrame retainedDuplicate() {
        return (io.netty.handler.codec.http.websocketx.TextWebSocketFrame) super.retainedDuplicate();
    }

    @Override
    public io.netty.handler.codec.http.websocketx.TextWebSocketFrame replace(ByteBuf content) {
        return new io.netty.handler.codec.http.websocketx.TextWebSocketFrame(isFinalFragment(), rsv(), content);
    }
    ...
    @Override
    public io.netty.handler.codec.http.websocketx.TextWebSocketFrame retain(int increment) {
    ...
    @Override
    public io.netty.handler.codec.http.websocketx.TextWebSocketFrame touch(Object hint) {
        super.touch(hint);
        return this;
    }
}

 ...
 * under the License.
 */
package com.netty.io.netty.handler.codec.http.multipart;
...
public class HttpPostMultipartRequestDecoder implements InterfaceHttpPostRequestDecoder {
    ...
    private final Map<String, List<InterfaceHttpData>> bodyMapHttpData = new TreeMap<String, List<InterfaceHttpData>>(
            io.netty.handler.codec.http.multipart.CaseIgnoringComparator.INSTANCE);
    ...
    private void checkDestroyed() {
        if (destroyed) {
            throw new IllegalStateException(io.netty.handler.codec.http.multipart.HttpPostMultipartRequestDecoder.class.getSimpleName()
     ...
     */
    @Override
    public io.netty.handler.codec.http.multipart.HttpPostMultipartRequestDecoder offer(HttpContent content) {
        checkDestroyed();
    ...
    private InterfaceHttpData findMultipartDisposition() {
        ...
        if (currentStatus == MultiPartStatus.DISPOSITION) {
            currentFieldAttributes = new TreeMap<CharSequence, Attribute>(io.netty.handler.codec.http.multipart.CaseIgnoringComparator.INSTANCE);
        }
        ...
        if (currentFileUpload == null) {
            ...
            try {
                ...
                if (contentTypeAttribute != null) {
                    ...
                    contentType = io.netty.handler.codec.http.multipart.HttpPostBodyUtil.DEFAULT_BINARY_CONTENT_TYPE;
                }
    ...
    /**
     * Destroy the {@link io.netty.handler.codec.http.multipart.HttpPostMultipartRequestDecoder} and release all it resources. After this method
    ...
    private static String[] splitMultipartHeader(String sb) {
        ...
        int valueStart;
        int valueEnd;
        nameStart = io.netty.handler.codec.http.multipart.HttpPostBodyUtil.findNonWhitespace(sb, 0);
        ...
        valueStart = io.netty.handler.codec.http.multipart.HttpPostBodyUtil.findNonWhitespace(sb, colonEnd);
        valueEnd = io.netty.handler.codec.http.multipart.HttpPostBodyUtil.findEndOfString(sb);

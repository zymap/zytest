...
/**
 * Encodes an {@link io.netty.handler.codec.http.HttpMessage} or an {@link HttpContent} into
 * a {@link ByteBuf}.
 *
 * <h3>Extensibility</h3>
 *
 ...
 */
public abstract class HttpObjectEncoder<H extends io.netty.handler.codec.http.HttpMessage> extends MessageToMessageEncoder<Object> {
    ...
    protected void encodeHeaders(HttpHeaders headers, ByteBuf buf) {
        ...
        while (iter.hasNext()) {
            ...
            io.netty.handler.codec.http.HttpHeadersEncoder.encoderHeader(header.getKey(), header.getValue(), buf);
        }
    }

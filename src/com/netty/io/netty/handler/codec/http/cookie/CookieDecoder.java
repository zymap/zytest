...
public abstract class CookieDecoder {
    ...
    protected io.netty.handler.codec.http.cookie.DefaultCookie initCookie(String header, int nameBegin, int nameEnd, int valueBegin, int valueEnd) {
        ...
        io.netty.handler.codec.http.cookie.DefaultCookie cookie = new DefaultCookie(name, unwrappedValue.toString());
        cookie.setWrap(wrap);
        return cookie;
    }
}

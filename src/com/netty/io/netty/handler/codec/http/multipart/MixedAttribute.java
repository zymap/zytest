...
public class MixedAttribute implements Attribute {
    ...
    public MixedAttribute(String name, long limitSize, Charset charset) {
        ...
        attribute = new io.netty.handler.codec.http.multipart.MemoryAttribute(name, charset);
    }

    public MixedAttribute(String name, long definedSize, long limitSize, Charset charset) {
        this.limitSize = limitSize;
        attribute = new io.netty.handler.codec.http.multipart.MemoryAttribute(name, definedSize, charset);
    }
    ...
    public MixedAttribute(String name, String value, long limitSize, Charset charset) {
        ...
        if (value.length() > this.limitSize) {
            try {
                ...
                try {
                    attribute = new io.netty.handler.codec.http.multipart.MemoryAttribute(name, value, charset);
    ...
    public void addContent(ByteBuf buffer, boolean last) throws IOException {
        if (attribute instanceof io.netty.handler.codec.http.multipart.MemoryAttribute) {
            ...
            if (attribute.length() + buffer.readableBytes() > limitSize) {
                ...
                if (((io.netty.handler.codec.http.multipart.MemoryAttribute) attribute).getByteBuf() != null) {
                    diskAttribute.addContent(((io.netty.handler.codec.http.multipart.MemoryAttribute) attribute)
                        .getByteBuf(), false);
                }

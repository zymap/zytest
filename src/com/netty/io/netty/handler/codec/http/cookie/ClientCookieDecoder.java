...
public final class ClientCookieDecoder extends CookieDecoder {
     ...
     * defined in RFC6265
     */
    public static final io.netty.handler.codec.http.cookie.ClientCookieDecoder STRICT = new io.netty.handler.codec.http.cookie.ClientCookieDecoder(true);

    /**
     * Lax instance that doesn't validate name and value
     */
    public static final io.netty.handler.codec.http.cookie.ClientCookieDecoder LAX = new io.netty.handler.codec.http.cookie.ClientCookieDecoder(false);

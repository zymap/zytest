...
public abstract class DefaultHttpMessage extends DefaultHttpObject implements HttpMessage {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof io.netty.handler.codec.http.DefaultHttpMessage)) {
            return false;
        }

        io.netty.handler.codec.http.DefaultHttpMessage other = (io.netty.handler.codec.http.DefaultHttpMessage) o;

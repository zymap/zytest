 ...
 * under the License.
 */
package com.netty.io.netty.handler.codec.http.websocketx.extensions.compression;
...
public final class PerMessageDeflateServerExtensionHandshaker implements WebSocketServerExtensionHandshaker {
    ...
    private static class PermessageDeflateExtension implements WebSocketServerExtension {
        ...
        public WebSocketExtensionEncoder newExtensionEncoder() {
            return new io.netty.handler.codec.http.websocketx.extensions.compression.PerMessageDeflateEncoder(compressionLevel, clientWindowSize, clientNoContext);
        }

        @Override
        public WebSocketExtensionDecoder newExtensionDecoder() {
            return new io.netty.handler.codec.http.websocketx.extensions.compression.PerMessageDeflateDecoder(serverNoContext);
        }

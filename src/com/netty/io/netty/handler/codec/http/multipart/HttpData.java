...
public interface HttpData extends InterfaceHttpData, ByteBufHolder {
    ...
    @Override
    io.netty.handler.codec.http.multipart.HttpData copy();

    @Override
    io.netty.handler.codec.http.multipart.HttpData duplicate();

    @Override
    io.netty.handler.codec.http.multipart.HttpData retainedDuplicate();

    @Override
    io.netty.handler.codec.http.multipart.HttpData replace(ByteBuf content);

    @Override
    io.netty.handler.codec.http.multipart.HttpData retain();

    @Override
    io.netty.handler.codec.http.multipart.HttpData retain(int increment);

    @Override
    io.netty.handler.codec.http.multipart.HttpData touch();

    @Override
    io.netty.handler.codec.http.multipart.HttpData touch(Object hint);
}

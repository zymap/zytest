...
public class HttpPostStandardRequestDecoder implements InterfaceHttpPostRequestDecoder {
    ...
    private void checkDestroyed() {
        if (destroyed) {
            throw new IllegalStateException(io.netty.handler.codec.http.multipart.HttpPostStandardRequestDecoder.class.getSimpleName()
     ...
     */
    @Override
    public io.netty.handler.codec.http.multipart.HttpPostStandardRequestDecoder offer(HttpContent content) {
        checkDestroyed();
    ...
    /**
     * Destroy the {@link io.netty.handler.codec.http.multipart.HttpPostStandardRequestDecoder} and release all it resources. After this method

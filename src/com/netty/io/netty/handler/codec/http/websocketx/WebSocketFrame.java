...
public abstract class WebSocketFrame extends DefaultByteBufHolder {
    ...
    public io.netty.handler.codec.http.websocketx.WebSocketFrame copy() {
        return (io.netty.handler.codec.http.websocketx.WebSocketFrame) super.copy();
    }

    @Override
    public io.netty.handler.codec.http.websocketx.WebSocketFrame duplicate() {
        return (io.netty.handler.codec.http.websocketx.WebSocketFrame) super.duplicate();
    }

    @Override
    public io.netty.handler.codec.http.websocketx.WebSocketFrame retainedDuplicate() {
        return (io.netty.handler.codec.http.websocketx.WebSocketFrame) super.retainedDuplicate();
    }

    @Override
    public abstract io.netty.handler.codec.http.websocketx.WebSocketFrame replace(ByteBuf content);
    ...
    @Override
    public io.netty.handler.codec.http.websocketx.WebSocketFrame retain(int increment) {
    ...
    @Override
    public io.netty.handler.codec.http.websocketx.WebSocketFrame touch(Object hint) {
        super.touch(hint);
        return this;
    }
}

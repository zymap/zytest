...
public class WebSocketClientHandshaker07 extends WebSocketClientHandshaker {
    ...
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.handler.codec.http.websocketx.WebSocketClientHandshaker07.class);
    ...
    protected FullHttpRequest newHandshakeRequest() {
        ...
        byte[] nonce = io.netty.handler.codec.http.websocketx.WebSocketUtil.randomBytes(16);
        String key = io.netty.handler.codec.http.websocketx.WebSocketUtil.base64(nonce);

        String acceptSeed = key + MAGIC_GUID;
        byte[] sha1 = io.netty.handler.codec.http.websocketx.WebSocketUtil.sha1(acceptSeed.getBytes(CharsetUtil.US_ASCII));
        expectedChallengeResponseString = io.netty.handler.codec.http.websocketx.WebSocketUtil.base64(sha1);

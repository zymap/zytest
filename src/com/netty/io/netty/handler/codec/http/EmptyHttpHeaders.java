...
public class EmptyHttpHeaders extends io.netty.handler.codec.http.HttpHeaders {
    ...
    public static final io.netty.handler.codec.http.EmptyHttpHeaders INSTANCE = instance();

    /**
     * @see InstanceInitializer#EMPTY_HEADERS
     * @deprecated Use {@link io.netty.handler.codec.http.EmptyHttpHeaders#INSTANCE}
     * <p>
     * This is needed to break a cyclic static initialization loop between {@link io.netty.handler.codec.http.HttpHeaders} and {@link
    ...
    /**
     * This class is needed to break a cyclic static initialization loop between {@link io.netty.handler.codec.http.HttpHeaders} and
     * {@link io.netty.handler.codec.http.EmptyHttpHeaders}.
     */
    @Deprecated
    private static final class InstanceInitializer {
        /**
         * The instance is instantiated here to break the cyclic static initialization between {@link io.netty.handler.codec.http.EmptyHttpHeaders}
         * and {@link io.netty.handler.codec.http.HttpHeaders}. The issue is that if someone accesses {@link io.netty.handler.codec.http.EmptyHttpHeaders#INSTANCE} before
         * {@link io.netty.handler.codec.http.HttpHeaders#EMPTY_HEADERS} then {@link HttpHeaders#EMPTY_HEADERS} will be {@code null}.
         */
        @Deprecated
        private static final io.netty.handler.codec.http.EmptyHttpHeaders EMPTY_HEADERS = new io.netty.handler.codec.http.EmptyHttpHeaders();

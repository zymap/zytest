 ...
 * io.netty.handler.codec.http.HttpServerKeepAliveHandler} will automatically close the channel for any LastHttpContent that corresponds to a client
 ...
 * <p>
 * Since {@link io.netty.handler.codec.http.HttpServerKeepAliveHandler} expects {@link HttpObject}s it should be added after {@link HttpServerCodec}
 ...
 *  p.addLast("httpKeepAlive", <b>new {@link io.netty.handler.codec.http.HttpServerKeepAliveHandler}()</b>);

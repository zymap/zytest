...
public final class HttpScheme {
     ...
     */
    public static final io.netty.handler.codec.http.HttpScheme HTTP = new io.netty.handler.codec.http.HttpScheme(80, "http");

    /**
     * Scheme for secure HTTP connection.
     */
    public static final io.netty.handler.codec.http.HttpScheme HTTPS = new io.netty.handler.codec.http.HttpScheme(443, "https");
    ...
    public boolean equals(Object o) {
        if (!(o instanceof io.netty.handler.codec.http.HttpScheme)) {
            return false;
        }
        io.netty.handler.codec.http.HttpScheme other = (io.netty.handler.codec.http.HttpScheme) o;

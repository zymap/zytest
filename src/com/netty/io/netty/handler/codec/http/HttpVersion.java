 ...
 */
public class HttpVersion implements Comparable<io.netty.handler.codec.http.HttpVersion> {
     ...
     * HTTP/1.0
     */
    public static final io.netty.handler.codec.http.HttpVersion HTTP_1_0 = new io.netty.handler.codec.http.HttpVersion("HTTP", 1, 0, false, true);

    /**
     * HTTP/1.1
     */
    public static final io.netty.handler.codec.http.HttpVersion HTTP_1_1 = new io.netty.handler.codec.http.HttpVersion("HTTP", 1, 1, true, true);

    /**
     * Returns an existing or new {@link io.netty.handler.codec.http.HttpVersion} instance which matches to
     ...
     * will be returned.  Otherwise, a new {@link io.netty.handler.codec.http.HttpVersion} instance will be
     * returned.
     */
    public static io.netty.handler.codec.http.HttpVersion valueOf(String text) {
        if (text == null) {
        ...
        //
        io.netty.handler.codec.http.HttpVersion version = version0(text);
        if (version == null) {
            version = new io.netty.handler.codec.http.HttpVersion(text, true);
        }
        return version;
    }

    private static io.netty.handler.codec.http.HttpVersion version0(String text) {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof io.netty.handler.codec.http.HttpVersion)) {
            return false;
        }

        io.netty.handler.codec.http.HttpVersion that = (io.netty.handler.codec.http.HttpVersion) o;
    ...
    @Override
    public int compareTo(io.netty.handler.codec.http.HttpVersion o) {

...
/**
 * Default implementation of {@link io.netty.handler.codec.http.HttpHeaders}.
 */
public class DefaultHttpHeaders extends io.netty.handler.codec.http.HttpHeaders {
    ...
    public io.netty.handler.codec.http.HttpHeaders add(io.netty.handler.codec.http.HttpHeaders headers) {
        if (headers instanceof io.netty.handler.codec.http.DefaultHttpHeaders) {
            this.headers.add(((io.netty.handler.codec.http.DefaultHttpHeaders) headers).headers);
            return this;
        } else {
    ...
    public io.netty.handler.codec.http.HttpHeaders set(io.netty.handler.codec.http.HttpHeaders headers) {
        if (headers instanceof io.netty.handler.codec.http.DefaultHttpHeaders) {
            this.headers.set(((io.netty.handler.codec.http.DefaultHttpHeaders) headers).headers);
            return this;
        } else {
    ...
    public boolean equals(Object o) {
        return o instanceof io.netty.handler.codec.http.DefaultHttpHeaders
                && headers.equals(((io.netty.handler.codec.http.DefaultHttpHeaders) o).headers, CASE_SENSITIVE_HASHER);
    }
    ...
    public HttpHeaders copy() {
        return new io.netty.handler.codec.http.DefaultHttpHeaders(headers.copy());
    }

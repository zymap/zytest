...
public enum HttpStatusClass {
     ...
     */
    public static io.netty.handler.codec.http.HttpStatusClass valueOf(int code) {
     ...
     */
    public static io.netty.handler.codec.http.HttpStatusClass valueOf(CharSequence code) {

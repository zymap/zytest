...
public class ContinuationWebSocketFrame extends WebSocketFrame {
    ...
    public io.netty.handler.codec.http.websocketx.ContinuationWebSocketFrame copy() {
        return (io.netty.handler.codec.http.websocketx.ContinuationWebSocketFrame) super.copy();
    }

    @Override
    public io.netty.handler.codec.http.websocketx.ContinuationWebSocketFrame duplicate() {
        return (io.netty.handler.codec.http.websocketx.ContinuationWebSocketFrame) super.duplicate();
    }

    @Override
    public io.netty.handler.codec.http.websocketx.ContinuationWebSocketFrame retainedDuplicate() {
        return (io.netty.handler.codec.http.websocketx.ContinuationWebSocketFrame) super.retainedDuplicate();
    }

    @Override
    public io.netty.handler.codec.http.websocketx.ContinuationWebSocketFrame replace(ByteBuf content) {
        return new io.netty.handler.codec.http.websocketx.ContinuationWebSocketFrame(isFinalFragment(), rsv(), content);
    }
    ...
    @Override
    public io.netty.handler.codec.http.websocketx.ContinuationWebSocketFrame retain(int increment) {
    ...
    @Override
    public io.netty.handler.codec.http.websocketx.ContinuationWebSocketFrame touch(Object hint) {
        super.touch(hint);
        return this;
    }
}

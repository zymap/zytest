...
public class DefaultFullHttpRequest extends DefaultHttpRequest implements FullHttpRequest {
    ...
    public FullHttpRequest replace(ByteBuf content) {
        FullHttpRequest request = new io.netty.handler.codec.http.DefaultFullHttpRequest(protocolVersion(), method(), uri(), content,
    ...
    public boolean equals(Object o) {
        if (!(o instanceof io.netty.handler.codec.http.DefaultFullHttpRequest)) {
            return false;
        }

        io.netty.handler.codec.http.DefaultFullHttpRequest other = (io.netty.handler.codec.http.DefaultFullHttpRequest) o;

...
public class CloseWebSocketFrame extends WebSocketFrame {
    ...
    public io.netty.handler.codec.http.websocketx.CloseWebSocketFrame copy() {
        return (io.netty.handler.codec.http.websocketx.CloseWebSocketFrame) super.copy();
    }

    @Override
    public io.netty.handler.codec.http.websocketx.CloseWebSocketFrame duplicate() {
        return (io.netty.handler.codec.http.websocketx.CloseWebSocketFrame) super.duplicate();
    }

    @Override
    public io.netty.handler.codec.http.websocketx.CloseWebSocketFrame retainedDuplicate() {
        return (io.netty.handler.codec.http.websocketx.CloseWebSocketFrame) super.retainedDuplicate();
    }

    @Override
    public io.netty.handler.codec.http.websocketx.CloseWebSocketFrame replace(ByteBuf content) {
        return new io.netty.handler.codec.http.websocketx.CloseWebSocketFrame(isFinalFragment(), rsv(), content);
    }
    ...
    @Override
    public io.netty.handler.codec.http.websocketx.CloseWebSocketFrame retain(int increment) {
    ...
    @Override
    public io.netty.handler.codec.http.websocketx.CloseWebSocketFrame touch(Object hint) {
        super.touch(hint);
        return this;
    }
}

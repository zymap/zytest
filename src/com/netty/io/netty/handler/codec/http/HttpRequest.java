...
public interface HttpRequest extends HttpMessage {
    ...
    /**
     * Returns the {@link HttpMethod} of this {@link io.netty.handler.codec.http.HttpRequest}.
     *
     * @return The {@link HttpMethod} of this {@link io.netty.handler.codec.http.HttpRequest}
     */
    HttpMethod method();

    /**
     * Set the {@link HttpMethod} of this {@link io.netty.handler.codec.http.HttpRequest}.
     */
    io.netty.handler.codec.http.HttpRequest setMethod(HttpMethod method);
     ...
     */
    io.netty.handler.codec.http.HttpRequest setUri(String uri);

    @Override
    io.netty.handler.codec.http.HttpRequest setProtocolVersion(HttpVersion version);
}

 ...
 * {@link io.netty.handler.codec.http.LastHttpContent} will be written.
 * <p>
...
public class HttpChunkedInput implements ChunkedInput<HttpContent> {
    ...
    public HttpChunkedInput(ChunkedInput<ByteBuf> input) {
        this.input = input;
        lastHttpContent = io.netty.handler.codec.http.LastHttpContent.EMPTY_LAST_CONTENT;
    }
     ...
     * chunk.
     * @param input {@link ChunkedInput} containing data to write
     * @param lastHttpContent {@link io.netty.handler.codec.http.LastHttpContent} that will be written as the terminating chunk. Use this for
     *            training headers.
     */

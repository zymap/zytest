...
public abstract class HttpHeaders implements Iterable<Entry<String, String>> {
     ...
     * {@link io.netty.handler.codec.http.HttpHeaders}. The issue is that if someone accesses {@link EmptyHttpHeaders#INSTANCE} before
     * {@link io.netty.handler.codec.http.HttpHeaders#EMPTY_HEADERS} then {@link io.netty.handler.codec.http.HttpHeaders#EMPTY_HEADERS} will be {@code null}.
     */
    @Deprecated
    public static final io.netty.handler.codec.http.HttpHeaders EMPTY_HEADERS = EmptyHttpHeaders.instance();
     ...
     * <p>
     * Create a new {@link CharSequence} which is optimized for reuse as {@link io.netty.handler.codec.http.HttpHeaders} name or value.
     ...
     */
    public abstract io.netty.handler.codec.http.HttpHeaders add(String name, Object value);
     ...
     */
    public abstract io.netty.handler.codec.http.HttpHeaders add(String name, Iterable<?> values);
     ...
     * @return {@code this}
     */
    public abstract io.netty.handler.codec.http.HttpHeaders addInt(CharSequence name, int value);
     ...
     * @return {@code this}
     */
    public abstract io.netty.handler.codec.http.HttpHeaders addShort(CharSequence name, short value);

    /**
     * @see #set(CharSequence, Object)
     */
    public abstract io.netty.handler.codec.http.HttpHeaders set(String name, Object value);
     ...
     */
    public abstract io.netty.handler.codec.http.HttpHeaders set(String name, Iterable<?> values);
     ...
     * @return {@code this}
     */
    public abstract io.netty.handler.codec.http.HttpHeaders setInt(CharSequence name, int value);
     ...
     * @return {@code this}
     */
    public abstract io.netty.handler.codec.http.HttpHeaders setShort(CharSequence name, short value);

    /**
     * @see #remove(CharSequence)
     */
    public abstract io.netty.handler.codec.http.HttpHeaders remove(String name);
    ...
    /**
     * Returns a deap copy of the passed in {@link io.netty.handler.codec.http.HttpHeaders}.
     */

 ...
 * under the License.
 */
package com.netty.io.netty.handler.codec.http.websocketx.extensions;
...
public class WebSocketClientExtensionHandler extends ChannelDuplexHandler {
    ...
    public void write(final ChannelHandlerContext ctx, Object msg, ChannelPromise promise) throws Exception {
        if (msg instanceof HttpRequest && io.netty.handler.codec.http.websocketx.extensions.WebSocketExtensionUtil.isWebsocketUpgrade(((HttpRequest) msg).headers())) {
            ...
            for (WebSocketClientExtensionHandshaker extensionHandshaker : extensionHandshakers) {
                ...
                headerValue = io.netty.handler.codec.http.websocketx.extensions.WebSocketExtensionUtil.appendExtension(headerValue,
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg)
        ...
        if (msg instanceof HttpResponse) {
            ...
            if (io.netty.handler.codec.http.websocketx.extensions.WebSocketExtensionUtil.isWebsocketUpgrade(response.headers())) {

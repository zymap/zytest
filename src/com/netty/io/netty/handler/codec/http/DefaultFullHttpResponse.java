...
public class DefaultFullHttpResponse extends DefaultHttpResponse implements FullHttpResponse {
    ...
    public FullHttpResponse replace(ByteBuf content) {
        FullHttpResponse response = new io.netty.handler.codec.http.DefaultFullHttpResponse(protocolVersion(), status(), content,
    ...
    public boolean equals(Object o) {
        if (!(o instanceof io.netty.handler.codec.http.DefaultFullHttpResponse)) {
            return false;
        }

        io.netty.handler.codec.http.DefaultFullHttpResponse other = (io.netty.handler.codec.http.DefaultFullHttpResponse) o;

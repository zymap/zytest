...
public final class ServerCookieDecoder extends CookieDecoder {
     ...
     * defined in RFC6265
     */
    public static final io.netty.handler.codec.http.cookie.ServerCookieDecoder STRICT = new io.netty.handler.codec.http.cookie.ServerCookieDecoder(true);

    /**
     * Lax instance that doesn't validate name and value
     */
    public static final io.netty.handler.codec.http.cookie.ServerCookieDecoder LAX = new io.netty.handler.codec.http.cookie.ServerCookieDecoder(false);
    ...
    /**
     * Decodes the specified Set-Cookie HTTP header value into a {@link io.netty.handler.codec.http.cookie.Cookie}.
     *
     * @return the decoded {@link io.netty.handler.codec.http.cookie.Cookie}
     */
    public Set<io.netty.handler.codec.http.cookie.Cookie> decode(String header) {
        ...
        Set<io.netty.handler.codec.http.cookie.Cookie> cookies = new TreeSet<Cookie>();

...
public final class WebSocketExtensionUtil {
    ...
    public static List<io.netty.handler.codec.http.websocketx.extensions.WebSocketExtensionData> extractExtensions(String extensionHeader) {
        String[] rawExtensions = extensionHeader.split(EXTENSION_SEPARATOR);
        if (rawExtensions.length > 0) {
            List<io.netty.handler.codec.http.websocketx.extensions.WebSocketExtensionData> extensions = new ArrayList<io.netty.handler.codec.http.websocketx.extensions.WebSocketExtensionData>(rawExtensions.length);

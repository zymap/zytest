...
public class BinaryWebSocketFrame extends WebSocketFrame {
    ...
    public io.netty.handler.codec.http.websocketx.BinaryWebSocketFrame copy() {
        return (io.netty.handler.codec.http.websocketx.BinaryWebSocketFrame) super.copy();
    }

    @Override
    public io.netty.handler.codec.http.websocketx.BinaryWebSocketFrame duplicate() {
        return (io.netty.handler.codec.http.websocketx.BinaryWebSocketFrame) super.duplicate();
    }

    @Override
    public io.netty.handler.codec.http.websocketx.BinaryWebSocketFrame retainedDuplicate() {
        return (io.netty.handler.codec.http.websocketx.BinaryWebSocketFrame) super.retainedDuplicate();
    }

    @Override
    public io.netty.handler.codec.http.websocketx.BinaryWebSocketFrame replace(ByteBuf content) {
        return new io.netty.handler.codec.http.websocketx.BinaryWebSocketFrame(isFinalFragment(), rsv(), content);
    }
    ...
    @Override
    public io.netty.handler.codec.http.websocketx.BinaryWebSocketFrame retain(int increment) {
    ...
    @Override
    public io.netty.handler.codec.http.websocketx.BinaryWebSocketFrame touch(Object hint) {
        super.touch(hint);
        return this;
    }
}

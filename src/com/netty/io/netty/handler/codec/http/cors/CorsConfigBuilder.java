...
public final class CorsConfigBuilder {
    ...
    public static io.netty.handler.codec.http.cors.CorsConfigBuilder forAnyOrigin() {
        return new io.netty.handler.codec.http.cors.CorsConfigBuilder();
    }

    /**
     * Creates a {@link io.netty.handler.codec.http.cors.CorsConfigBuilder} instance with the specified origin.
     *
     * @return {@link io.netty.handler.codec.http.cors.CorsConfigBuilder} to support method chaining.
     */
    public static io.netty.handler.codec.http.cors.CorsConfigBuilder forOrigin(final String origin) {
        if ("*".equals(origin)) {
            return new io.netty.handler.codec.http.cors.CorsConfigBuilder();
        }
        return new io.netty.handler.codec.http.cors.CorsConfigBuilder(origin);
    }

    /**
     * Creates a {@link io.netty.handler.codec.http.cors.CorsConfigBuilder} instance with the specified origins.
     *
     * @return {@link io.netty.handler.codec.http.cors.CorsConfigBuilder} to support method chaining.
     */
    public static io.netty.handler.codec.http.cors.CorsConfigBuilder forOrigins(final String... origins) {
        return new io.netty.handler.codec.http.cors.CorsConfigBuilder(origins);
    }
     ...
     * @return {@link io.netty.handler.codec.http.cors.CorsConfigBuilder} to support method chaining.
     */
    public io.netty.handler.codec.http.cors.CorsConfigBuilder exposeHeaders(final String... headers) {
     ...
     * @return {@link io.netty.handler.codec.http.cors.CorsConfigBuilder} to support method chaining.
     */
    public io.netty.handler.codec.http.cors.CorsConfigBuilder exposeHeaders(final CharSequence... headers) {
     ...
     * @return {@link io.netty.handler.codec.http.cors.CorsConfigBuilder} to support method chaining.
     */
    public io.netty.handler.codec.http.cors.CorsConfigBuilder maxAge(final long max) {
        maxAge = max;
        return this;
    }
     ...
     * @return {@link io.netty.handler.codec.http.cors.CorsConfigBuilder} to support method chaining.
     */
    public io.netty.handler.codec.http.cors.CorsConfigBuilder allowedRequestMethods(final HttpMethod... methods) {
     ...
     * @return {@link io.netty.handler.codec.http.cors.CorsConfigBuilder} to support method chaining.
     */
    public io.netty.handler.codec.http.cors.CorsConfigBuilder allowedRequestHeaders(final String... headers) {
     ...
     * @return {@link io.netty.handler.codec.http.cors.CorsConfigBuilder} to support method chaining.
     */
    public io.netty.handler.codec.http.cors.CorsConfigBuilder allowedRequestHeaders(final CharSequence... headers) {
        for (CharSequence header: headers) {
     ...
     * @return {@link io.netty.handler.codec.http.cors.CorsConfigBuilder} to support method chaining.
     */
    public io.netty.handler.codec.http.cors.CorsConfigBuilder preflightResponseHeader(final CharSequence name, final Object... values) {
        if (values.length == 1) {
     ...
     * @return {@link io.netty.handler.codec.http.cors.CorsConfigBuilder} to support method chaining.
     */
    public <T> io.netty.handler.codec.http.cors.CorsConfigBuilder preflightResponseHeader(final CharSequence name, final Iterable<T> value) {
     ...
     * @return {@link io.netty.handler.codec.http.cors.CorsConfigBuilder} to support method chaining.
     */
    public <T> io.netty.handler.codec.http.cors.CorsConfigBuilder preflightResponseHeader(final CharSequence name, final Callable<T> valueGenerator) {

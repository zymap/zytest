...
final class InternalAttribute extends AbstractReferenceCounted implements InterfaceHttpData {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof io.netty.handler.codec.http.multipart.InternalAttribute)) {
            return false;
        }
        io.netty.handler.codec.http.multipart.InternalAttribute attribute = (io.netty.handler.codec.http.multipart.InternalAttribute) o;
    ...
    public int compareTo(InterfaceHttpData o) {
        ...
        return compareTo((io.netty.handler.codec.http.multipart.InternalAttribute) o);
    }

    public int compareTo(io.netty.handler.codec.http.multipart.InternalAttribute o) {

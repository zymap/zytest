 ...
 * res.setHeader("Set-Cookie", {@link io.netty.handler.codec.http.cookie.ServerCookieEncoder}.encode("JSESSIONID", "1234"));
 * </pre>
 *
...
public final class ServerCookieEncoder extends CookieEncoder {
     ...
     */
    public static final io.netty.handler.codec.http.cookie.ServerCookieEncoder STRICT = new io.netty.handler.codec.http.cookie.ServerCookieEncoder(true);

    /**
     * Lax instance that doesn't validate name and value, and that allows multiple
     * cookies with the same name.
     */
    public static final io.netty.handler.codec.http.cookie.ServerCookieEncoder LAX = new io.netty.handler.codec.http.cookie.ServerCookieEncoder(false);

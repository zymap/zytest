...
public class WebSocketClientHandshaker00 extends WebSocketClientHandshaker {
    ...
    protected FullHttpRequest newHandshakeRequest() {
        // Make keys
        int spaces1 = io.netty.handler.codec.http.websocketx.WebSocketUtil.randomNumber(1, 12);
        int spaces2 = io.netty.handler.codec.http.websocketx.WebSocketUtil.randomNumber(1, 12);

        int max1 = Integer.MAX_VALUE / spaces1;
        int max2 = Integer.MAX_VALUE / spaces2;

        int number1 = io.netty.handler.codec.http.websocketx.WebSocketUtil.randomNumber(0, max1);
        int number2 = io.netty.handler.codec.http.websocketx.WebSocketUtil.randomNumber(0, max2);
        ...
        byte[] key3 = io.netty.handler.codec.http.websocketx.WebSocketUtil.randomBytes(8);
        ...
        expectedChallengeResponseBytes = Unpooled.wrappedBuffer(io.netty.handler.codec.http.websocketx.WebSocketUtil.md5(challenge));
    ...
    private static String insertRandomCharacters(String key) {
        int count = io.netty.handler.codec.http.websocketx.WebSocketUtil.randomNumber(1, 12);
        ...
        for (int i = 0; i < count; i++) {
            int split = io.netty.handler.codec.http.websocketx.WebSocketUtil.randomNumber(0, key.length());
    ...
    private static String insertSpaces(String key, int spaces) {
        for (int i = 0; i < spaces; i++) {
            int split = io.netty.handler.codec.http.websocketx.WebSocketUtil.randomNumber(1, key.length() - 1);
            String part1 = key.substring(0, split);
            String part2 = key.substring(split);
            key = part1 + ' ' + part2;
        }

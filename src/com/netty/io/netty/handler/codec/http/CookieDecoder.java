 ...
 * Set&lt;{@link Cookie}&gt; cookies = {@link io.netty.handler.codec.http.CookieDecoder}.decode(value);
 * </pre>
 *
...
public final class CookieDecoder {
    ...
    private static final io.netty.handler.codec.http.CookieDecoder STRICT = new io.netty.handler.codec.http.CookieDecoder(true);

    private static final io.netty.handler.codec.http.CookieDecoder LAX = new io.netty.handler.codec.http.CookieDecoder(false);

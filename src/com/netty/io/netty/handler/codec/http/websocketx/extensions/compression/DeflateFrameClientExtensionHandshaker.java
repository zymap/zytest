...
public final class DeflateFrameClientExtensionHandshaker implements WebSocketClientExtensionHandshaker {
    ...
    private static class DeflateFrameClientExtension implements WebSocketClientExtension {
        ...
        public WebSocketExtensionEncoder newExtensionEncoder() {
            return new io.netty.handler.codec.http.websocketx.extensions.compression.PerFrameDeflateEncoder(compressionLevel, 15, false);
        }

        @Override
        public WebSocketExtensionDecoder newExtensionDecoder() {
            return new io.netty.handler.codec.http.websocketx.extensions.compression.PerFrameDeflateDecoder(false);
        }
    }

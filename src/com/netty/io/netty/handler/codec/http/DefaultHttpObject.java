...
public class DefaultHttpObject implements HttpObject {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof io.netty.handler.codec.http.DefaultHttpObject)) {
            return false;
        }

        io.netty.handler.codec.http.DefaultHttpObject other = (io.netty.handler.codec.http.DefaultHttpObject) o;

...
public class WebSocketServerProtocolHandler extends WebSocketProtocolHandler {
    ...
    public void handlerAdded(ChannelHandlerContext ctx) {
        ...
        if (cp.get(io.netty.handler.codec.http.websocketx.Utf8FrameValidator.class) == null) {
            // Add the UFT8 checking before this one.
            ctx.pipeline().addBefore(ctx.name(), io.netty.handler.codec.http.websocketx.Utf8FrameValidator.class.getName(),

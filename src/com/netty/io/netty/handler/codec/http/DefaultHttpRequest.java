...
public class DefaultHttpRequest extends DefaultHttpMessage implements HttpRequest {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof io.netty.handler.codec.http.DefaultHttpRequest)) {
            return false;
        }

        io.netty.handler.codec.http.DefaultHttpRequest other = (io.netty.handler.codec.http.DefaultHttpRequest) o;

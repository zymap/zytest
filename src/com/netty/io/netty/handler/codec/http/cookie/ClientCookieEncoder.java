 ...
 * res.setHeader("Cookie", {@link io.netty.handler.codec.http.cookie.ClientCookieEncoder}.encode("JSESSIONID", "1234"));
 * </pre>
 *
...
public final class ClientCookieEncoder extends CookieEncoder {
     ...
     */
    public static final io.netty.handler.codec.http.cookie.ClientCookieEncoder STRICT = new io.netty.handler.codec.http.cookie.ClientCookieEncoder(true);
     ...
     */
    public static final io.netty.handler.codec.http.cookie.ClientCookieEncoder LAX = new io.netty.handler.codec.http.cookie.ClientCookieEncoder(false);

 ...
 * under the License.
 */
package com.netty.io.netty.handler.codec.marshalling;
...
public class CompatibleMarshallingDecoder extends ReplayingDecoder<Void> {
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf buffer, List<Object> out) throws Exception {
        ...
        if (maxObjectSize != Integer.MAX_VALUE) {
            input = new io.netty.handler.codec.marshalling.LimitingByteInput(input, maxObjectSize);
        }
        try {
            ...
            unmarshaller.finish();
            out.add(obj);
        } catch (io.netty.handler.codec.marshalling.LimitingByteInput.TooBigObjectException ignored) {

...
public interface SpdyGoAwayFrame extends SpdyFrame {
     ...
     * cannot be negative.
     */
    io.netty.handler.codec.spdy.SpdyGoAwayFrame setLastGoodStreamId(int lastGoodStreamId);
     ...
     */
    io.netty.handler.codec.spdy.SpdyGoAwayFrame setStatus(SpdySessionStatus status);
}

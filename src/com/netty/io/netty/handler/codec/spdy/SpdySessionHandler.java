...
public class SpdySessionHandler extends ChannelDuplexHandler {
    ...
    private static final SpdyProtocolException PROTOCOL_EXCEPTION = ThrowableUtil.unknownStackTrace(
            new SpdyProtocolException(), io.netty.handler.codec.spdy.SpdySessionHandler.class, "handleOutboundMessage(...)");
    private static final SpdyProtocolException STREAM_CLOSED = ThrowableUtil.unknownStackTrace(
            new SpdyProtocolException("Stream closed"), io.netty.handler.codec.spdy.SpdySessionHandler.class, "removeStream(...)");

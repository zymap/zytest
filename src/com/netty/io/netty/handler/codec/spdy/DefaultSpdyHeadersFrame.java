...
/**
 * The default {@link io.netty.handler.codec.spdy.SpdyHeadersFrame} implementation.
 */
public class DefaultSpdyHeadersFrame extends DefaultSpdyStreamFrame
        implements io.netty.handler.codec.spdy.SpdyHeadersFrame {
    ...
    @Override
    public io.netty.handler.codec.spdy.SpdyHeadersFrame setStreamId(int streamId) {
        super.setStreamId(streamId);
        return this;
    }

    @Override
    public io.netty.handler.codec.spdy.SpdyHeadersFrame setLast(boolean last) {
        super.setLast(last);
        return this;
    }

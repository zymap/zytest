...
public class DefaultSpdyHeaders extends DefaultHeaders<CharSequence, CharSequence, io.netty.handler.codec.spdy.SpdyHeaders> implements SpdyHeaders {
    private static final NameValidator<CharSequence> SpdyNameValidator = new NameValidator<CharSequence>() {
        @Override
        public void validateName(CharSequence name) {
            io.netty.handler.codec.spdy.SpdyCodecUtil.validateHeaderName(name);
        }
    };
    ...
    private static final class HeaderValueConverterAndValidator extends CharSequenceValueConverter {
        ...
        public CharSequence convertObject(Object value) {
            ...
            io.netty.handler.codec.spdy.SpdyCodecUtil.validateHeaderValue(seq);
            return seq;
        }
    }
}

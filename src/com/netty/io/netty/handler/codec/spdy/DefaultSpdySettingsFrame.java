...
/**
 * The default {@link io.netty.handler.codec.spdy.SpdySettingsFrame} implementation.
 */
public class DefaultSpdySettingsFrame implements io.netty.handler.codec.spdy.SpdySettingsFrame {
    ...
    @Override
    public io.netty.handler.codec.spdy.SpdySettingsFrame setValue(int id, int value) {
        return setValue(id, value, false, false);
    }

    @Override
    public io.netty.handler.codec.spdy.SpdySettingsFrame setValue(int id, int value, boolean persistValue, boolean persisted) {
    ...
    @Override
    public io.netty.handler.codec.spdy.SpdySettingsFrame removeValue(int id) {
    ...
    @Override
    public io.netty.handler.codec.spdy.SpdySettingsFrame setPersistValue(int id, boolean persistValue) {
        final Setting setting = settingsMap.get(id);
        if (setting != null) {
            setting.setPersist(persistValue);
        }
    ...
    @Override
    public io.netty.handler.codec.spdy.SpdySettingsFrame setPersisted(int id, boolean persisted) {
        final Setting setting = settingsMap.get(id);
        if (setting != null) {
            setting.setPersisted(persisted);
        }

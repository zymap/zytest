...
/**
 * A combination of {@link SpdyHttpDecoder} and {@link io.netty.handler.codec.spdy.SpdyHttpEncoder}
 */
public final class SpdyHttpCodec extends CombinedChannelDuplexHandler<SpdyHttpDecoder, io.netty.handler.codec.spdy.SpdyHttpEncoder> {
    /**
     * Creates a new instance with the specified decoder options.
     */
    public SpdyHttpCodec(SpdyVersion version, int maxContentLength) {
        super(new SpdyHttpDecoder(version, maxContentLength), new io.netty.handler.codec.spdy.SpdyHttpEncoder(version));
    }

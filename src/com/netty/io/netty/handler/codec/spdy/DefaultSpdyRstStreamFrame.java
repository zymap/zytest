...
/**
 * The default {@link io.netty.handler.codec.spdy.SpdyRstStreamFrame} implementation.
 */
public class DefaultSpdyRstStreamFrame extends DefaultSpdyStreamFrame
        implements io.netty.handler.codec.spdy.SpdyRstStreamFrame {
    ...
    @Override
    public io.netty.handler.codec.spdy.SpdyRstStreamFrame setStreamId(int streamId) {
        super.setStreamId(streamId);
        return this;
    }

    @Override
    public io.netty.handler.codec.spdy.SpdyRstStreamFrame setLast(boolean last) {
        super.setLast(last);
        return this;
    }

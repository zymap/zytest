...
abstract class SpdyHeaderBlockDecoder {
    ...
    static io.netty.handler.codec.spdy.SpdyHeaderBlockDecoder newInstance(SpdyVersion spdyVersion, int maxHeaderSize) {
        return new io.netty.handler.codec.spdy.SpdyHeaderBlockZlibDecoder(spdyVersion, maxHeaderSize);
    }

...
public class SpdyHttpDecoder extends MessageToMessageDecoder<SpdyFrame> {
     ...
     */
    public SpdyHttpDecoder(io.netty.handler.codec.spdy.SpdyVersion version, int maxContentLength) {
     ...
     */
    public SpdyHttpDecoder(io.netty.handler.codec.spdy.SpdyVersion version, int maxContentLength, boolean validateHeaders) {
     ...
     */
    protected SpdyHttpDecoder(io.netty.handler.codec.spdy.SpdyVersion version, int maxContentLength, Map<Integer, FullHttpMessage> messageMap) {
    ...
    protected void decode(ChannelHandlerContext ctx, SpdyFrame msg, List<Object> out)
        ...
        if (msg instanceof SpdySynStreamFrame) {
            ...
            if (io.netty.handler.codec.spdy.SpdyCodecUtil.isServerId(streamId)) {

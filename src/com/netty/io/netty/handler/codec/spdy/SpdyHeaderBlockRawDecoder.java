...
public class SpdyHeaderBlockRawDecoder extends SpdyHeaderBlockDecoder {
    ...
    @Override
    void decode(ByteBufAllocator alloc, ByteBuf headerBlock, io.netty.handler.codec.spdy.SpdyHeadersFrame frame) throws Exception {
        if (headerBlock == null) {
    ...
    protected void decodeHeaderBlock(ByteBuf headerBlock, io.netty.handler.codec.spdy.SpdyHeadersFrame frame) throws Exception {
        int skipLength;

...
public interface SpdySettingsFrame extends SpdyFrame {
     ...
     */
    io.netty.handler.codec.spdy.SpdySettingsFrame setValue(int id, int value);
     ...
     * The ID cannot be negative and cannot exceed 16777215.
     */
    io.netty.handler.codec.spdy.SpdySettingsFrame setValue(int id, int value, boolean persistVal, boolean persisted);

    /**
     * Removes the value of the setting ID.
     * Removes all persistence information for the setting.
     */
    io.netty.handler.codec.spdy.SpdySettingsFrame removeValue(int id);
     ...
     */
    io.netty.handler.codec.spdy.SpdySettingsFrame setPersistValue(int id, boolean persistValue);
     ...
     * Has no effect if the setting ID has no value.
     */
    io.netty.handler.codec.spdy.SpdySettingsFrame setPersisted(int id, boolean persisted);
     ...
     */
    io.netty.handler.codec.spdy.SpdySettingsFrame setClearPreviouslyPersistedSettings(boolean clear);
}

 ...
 *
 * // Encoder
 * pipeline.addLast("lineEncoder", new {@link io.netty.handler.codec.string.LineEncoder}(LineSeparator.UNIX, CharsetUtil.UTF_8));
 * </pre>
...
public class LineEncoder extends MessageToMessageEncoder<CharSequence> {
     ...
     */
    public LineEncoder() {
        this(io.netty.handler.codec.string.LineSeparator.DEFAULT, CharsetUtil.UTF_8);
    }

    /**
     * Creates a new instance with the specified line separator and UTF-8 charset encoding.
     */
    public LineEncoder(io.netty.handler.codec.string.LineSeparator lineSeparator) {
    ...
    public LineEncoder(Charset charset) {
        this(io.netty.handler.codec.string.LineSeparator.DEFAULT, charset);
    }

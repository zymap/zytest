...
public final class DateFormatter {
    ...
    private static final FastThreadLocal<io.netty.handler.codec.DateFormatter> INSTANCES =
            new FastThreadLocal<io.netty.handler.codec.DateFormatter>() {
                @Override
                protected io.netty.handler.codec.DateFormatter initialValue() {
                    return new io.netty.handler.codec.DateFormatter();
                }
            };
    ...
    private static io.netty.handler.codec.DateFormatter formatter() {
        io.netty.handler.codec.DateFormatter formatter = INSTANCES.get();
        formatter.reset();
        return formatter;
    }

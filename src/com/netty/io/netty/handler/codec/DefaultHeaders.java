...
/**
 * Default implementation of {@link io.netty.handler.codec.Headers};
 *
 ...
 */
public class DefaultHeaders<K, V, T extends io.netty.handler.codec.Headers<K, V, T>> implements io.netty.handler.codec.Headers<K, V, T> {
    /**
    ...
    public DefaultHeaders(HashingStrategy<K> nameHashingStrategy,
        ...
        entries = new io.netty.handler.codec.DefaultHeaders.HeaderEntry[findNextPositivePowerOfTwo(max(2, min(arraySizeHint, 128)))];
    ...
    @Override
    public T add(io.netty.handler.codec.Headers<? extends K, ? extends V, ?> headers) {
        if (headers == this) {
    ...
    protected void addImpl(io.netty.handler.codec.Headers<? extends K, ? extends V, ?> headers) {
        if (headers instanceof io.netty.handler.codec.DefaultHeaders) {
            @SuppressWarnings("unchecked")
            final io.netty.handler.codec.DefaultHeaders<? extends K, ? extends V, T> defaultHeaders =
                    (io.netty.handler.codec.DefaultHeaders<? extends K, ? extends V, T>) headers;
    ...
    @Override
    public T set(io.netty.handler.codec.Headers<? extends K, ? extends V, ?> headers) {
        if (headers != this) {
            clear();
            addImpl(headers);
        }
    ...
    @Override
    public T setAll(io.netty.handler.codec.Headers<? extends K, ? extends V, ?> headers) {
        if (headers != this) {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof io.netty.handler.codec.Headers)) {
            return false;
        }

        return equals((io.netty.handler.codec.Headers<K, V, ?>) o, JAVA_HASHER);
    }
     ...
     */
    public io.netty.handler.codec.DefaultHeaders<K, V, T> copy() {
        io.netty.handler.codec.DefaultHeaders<K, V, T> copy = new io.netty.handler.codec.DefaultHeaders<K, V, T>(

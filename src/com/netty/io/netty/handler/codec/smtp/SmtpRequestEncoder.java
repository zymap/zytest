...
public final class SmtpRequestEncoder extends MessageToMessageEncoder<Object> {
    ...
    public boolean acceptOutboundMessage(Object msg) throws Exception {
        return msg instanceof io.netty.handler.codec.smtp.SmtpRequest || msg instanceof SmtpContent;
    }

    @Override
    protected void encode(ChannelHandlerContext ctx, Object msg, List<Object> out) throws Exception {
        if (msg instanceof io.netty.handler.codec.smtp.SmtpRequest) {
            final io.netty.handler.codec.smtp.SmtpRequest req = (SmtpRequest) msg;
            if (contentExpected) {

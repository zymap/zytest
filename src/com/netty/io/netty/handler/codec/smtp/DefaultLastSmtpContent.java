...
public final class DefaultLastSmtpContent extends DefaultSmtpContent implements LastSmtpContent {
    ...
    public LastSmtpContent replace(ByteBuf content) {
        return new io.netty.handler.codec.smtp.DefaultLastSmtpContent(content);
    }
    ...
    @Override
    public io.netty.handler.codec.smtp.DefaultLastSmtpContent retain(int increment) {
    ...
    @Override
    public io.netty.handler.codec.smtp.DefaultLastSmtpContent touch(Object hint) {
        super.touch(hint);
        return this;
    }
}

...
public enum HAProxyCommand {
    ...
    /**
     * Returns the {@link io.netty.handler.codec.haproxy.HAProxyCommand} represented by the lowest 4 bits of the specified byte.
     *
     * @param verCmdByte protocol version and command byte
     */
    public static io.netty.handler.codec.haproxy.HAProxyCommand valueOf(byte verCmdByte) {

...
public class HAProxyTLV extends DefaultByteBufHolder {
    ...
    @Override
    public io.netty.handler.codec.haproxy.HAProxyTLV replace(ByteBuf content) {
        return new io.netty.handler.codec.haproxy.HAProxyTLV(type, typeByteValue, content);
    }
    ...
    @Override
    public io.netty.handler.codec.haproxy.HAProxyTLV retain(int increment) {
    ...
    @Override
    public io.netty.handler.codec.haproxy.HAProxyTLV touch(Object hint) {
        super.touch(hint);
        return this;
    }
}

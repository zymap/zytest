...
/**
 * Represents a {@link io.netty.handler.codec.haproxy.HAProxyTLV} of the type {@link io.netty.handler.codec.haproxy.HAProxyTLV.Type#PP2_TYPE_SSL}.
 * This TLV encapsulates other TLVs and has additional information like verification information and a client bitfield.
 */
public final class HAProxySSLTLV extends io.netty.handler.codec.haproxy.HAProxyTLV {

    private final int verify;
    private final List<io.netty.handler.codec.haproxy.HAProxyTLV> tlvs;
     ...
     * @param tlvs the encapsulated {@link io.netty.handler.codec.haproxy.HAProxyTLV}s
     * @param rawContent the raw TLV content
     */
    HAProxySSLTLV(final int verify, final byte clientBitField, final List<io.netty.handler.codec.haproxy.HAProxyTLV> tlvs, final ByteBuf rawContent) {
    ...
    /**
     * Returns an unmodifiable Set of encapsulated {@link io.netty.handler.codec.haproxy.HAProxyTLV}s.
     */

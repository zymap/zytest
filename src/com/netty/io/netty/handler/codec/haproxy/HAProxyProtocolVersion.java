...
public enum HAProxyProtocolVersion {
    ...
    /**
     * Returns the {@link io.netty.handler.codec.haproxy.HAProxyProtocolVersion} represented by the highest 4 bits of the specified byte.
     *
     * @param verCmdByte protocol version and command byte
     */
    public static io.netty.handler.codec.haproxy.HAProxyProtocolVersion valueOf(byte verCmdByte) {

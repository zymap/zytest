 ...
 * under the License.
 */
package com.netty.io.netty.handler.codec.haproxy;
...
public final class HAProxyMessage {
     ...
     */
    private static final io.netty.handler.codec.haproxy.HAProxyMessage V1_UNKNOWN_MSG = new io.netty.handler.codec.haproxy.HAProxyMessage(
     ...
     * 'UNKNOWN' we must discard all other header values.
     */
    private static final io.netty.handler.codec.haproxy.HAProxyMessage V2_UNKNOWN_MSG = new io.netty.handler.codec.haproxy.HAProxyMessage(
     ...
     */
    private static final io.netty.handler.codec.haproxy.HAProxyMessage V2_LOCAL_MSG = new io.netty.handler.codec.haproxy.HAProxyMessage(
     ...
     * @return                           {@link io.netty.handler.codec.haproxy.HAProxyMessage} instance
     * @throws HAProxyProtocolException  if any portion of the header is invalid
     */
    static io.netty.handler.codec.haproxy.HAProxyMessage decodeHeader(ByteBuf header) {
        if (header == null) {
        ...
        return new io.netty.handler.codec.haproxy.HAProxyMessage(ver, cmd, protAndFam, srcAddress, dstAddress, srcPort, dstPort, tlvs);
    }
    ...
    private static List<HAProxyTLV> readTlvs(final ByteBuf header) {
        ...
        do {
            ...
            if (haProxyTLV instanceof io.netty.handler.codec.haproxy.HAProxySSLTLV) {
                haProxyTLVs.addAll(((io.netty.handler.codec.haproxy.HAProxySSLTLV) haProxyTLV).encapsulatedTLVs());
            }
    ...
    private static HAProxyTLV readNextTLV(final ByteBuf header) {
        ...
        case PP2_TYPE_SSL:
            ...
            if (byteBuf.readableBytes() >= 4) {
                ...
                return new io.netty.handler.codec.haproxy.HAProxySSLTLV(verify, client, encapsulatedTlvs, rawContent);
            }
     ...
     * @throws HAProxyProtocolException  if any portion of the header is invalid
     */
    static io.netty.handler.codec.haproxy.HAProxyMessage decodeHeader(String header) {
        if (header == null) {
        ...
        return new io.netty.handler.codec.haproxy.HAProxyMessage(
    ...
    /**
     * Returns the {@link HAProxyProtocolVersion} of this {@link io.netty.handler.codec.haproxy.HAProxyMessage}.
     */
    ...
    /**
     * Returns the {@link HAProxyCommand} of this {@link io.netty.handler.codec.haproxy.HAProxyMessage}.
     */
    ...
    /**
     * Returns the {@link HAProxyProxiedProtocol} of this {@link io.netty.handler.codec.haproxy.HAProxyMessage}.
     */
    ...
    /**
     * Returns the human-readable source address of this {@link io.netty.handler.codec.haproxy.HAProxyMessage}.
     */
    ...
    /**
     * Returns the human-readable destination address of this {@link io.netty.handler.codec.haproxy.HAProxyMessage}.
     */
    ...
    /**
     * Returns the UDP/TCP source port of this {@link io.netty.handler.codec.haproxy.HAProxyMessage}.
     */
    ...
    /**
     * Returns the UDP/TCP destination port of this {@link io.netty.handler.codec.haproxy.HAProxyMessage}.
     */

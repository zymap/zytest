...
public enum HAProxyProxiedProtocol {
    ...
    /**
     * Returns the {@link io.netty.handler.codec.haproxy.HAProxyProxiedProtocol} represented by the specified byte.
     *
     * @param tpafByte transport protocol and address family byte
     */
    public static io.netty.handler.codec.haproxy.HAProxyProxiedProtocol valueOf(byte tpafByte) {
        switch (tpafByte) {
            case TPAF_TCP4_BYTE:
                return TCP4;
            case TPAF_TCP6_BYTE:

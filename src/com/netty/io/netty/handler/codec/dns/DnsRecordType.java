 ...
 */
@UnstableApi
public class DnsRecordType implements Comparable<io.netty.handler.codec.dns.DnsRecordType> {
     ...
     */
    public static final io.netty.handler.codec.dns.DnsRecordType A = new io.netty.handler.codec.dns.DnsRecordType(0x0001, "A");

    /**
     * Name server record RFC 1035 Delegates a DNS zone to use the given
     * authoritative name servers
     */
    public static final io.netty.handler.codec.dns.DnsRecordType NS = new io.netty.handler.codec.dns.DnsRecordType(0x0002, "NS");
     ...
     */
    public static final io.netty.handler.codec.dns.DnsRecordType CNAME = new io.netty.handler.codec.dns.DnsRecordType(0x0005, "CNAME");
     ...
     */
    public static final io.netty.handler.codec.dns.DnsRecordType SOA = new io.netty.handler.codec.dns.DnsRecordType(0x0006, "SOA");
     ...
     * things as DNS-SD.
     */
    public static final io.netty.handler.codec.dns.DnsRecordType PTR = new io.netty.handler.codec.dns.DnsRecordType(0x000c, "PTR");

    /**
     * Mail exchange record RFC 1035 Maps a domain name to a list of message
     * transfer agents for that domain.
     */
    public static final io.netty.handler.codec.dns.DnsRecordType MX = new io.netty.handler.codec.dns.DnsRecordType(0x000f, "MX");
     ...
     * etc.
     */
    public static final io.netty.handler.codec.dns.DnsRecordType TXT = new io.netty.handler.codec.dns.DnsRecordType(0x0010, "TXT");
     ...
     * a .
     */
    public static final io.netty.handler.codec.dns.DnsRecordType RP = new io.netty.handler.codec.dns.DnsRecordType(0x0011, "RP");
     ...
     * DCE/DFS file system.
     */
    public static final io.netty.handler.codec.dns.DnsRecordType AFSDB = new io.netty.handler.codec.dns.DnsRecordType(0x0012, "AFSDB");
     ...
     * use within DNSSEC.
     */
    public static final io.netty.handler.codec.dns.DnsRecordType SIG = new io.netty.handler.codec.dns.DnsRecordType(0x0018, "SIG");
     ...
     */
    public static final io.netty.handler.codec.dns.DnsRecordType KEY = new io.netty.handler.codec.dns.DnsRecordType(0x0019, "KEY");
     ...
     */
    public static final io.netty.handler.codec.dns.DnsRecordType AAAA = new io.netty.handler.codec.dns.DnsRecordType(0x001c, "AAAA");

    /**
     * Location record RFC 1876 Specifies a geographical location associated
     * with a domain name.
     */
    public static final io.netty.handler.codec.dns.DnsRecordType LOC = new io.netty.handler.codec.dns.DnsRecordType(0x001d, "LOC");
     ...
     */
    public static final io.netty.handler.codec.dns.DnsRecordType SRV = new io.netty.handler.codec.dns.DnsRecordType(0x0021, "SRV");
     ...
     */
    public static final io.netty.handler.codec.dns.DnsRecordType NAPTR = new io.netty.handler.codec.dns.DnsRecordType(0x0023, "NAPTR");
     ...
     */
    public static final io.netty.handler.codec.dns.DnsRecordType KX = new io.netty.handler.codec.dns.DnsRecordType(0x0024, "KX");

    /**
     * Certificate record RFC 4398 Stores PKIX, SPKI, PGP, etc.
     */
    public static final io.netty.handler.codec.dns.DnsRecordType CERT = new io.netty.handler.codec.dns.DnsRecordType(0x0025, "CERT");
     ...
     */
    public static final io.netty.handler.codec.dns.DnsRecordType DNAME = new io.netty.handler.codec.dns.DnsRecordType(0x0027, "DNAME");

    /**
     * Option record RFC 2671 This is a pseudo DNS record type needed to support
     * EDNS.
     */
    public static final io.netty.handler.codec.dns.DnsRecordType OPT = new io.netty.handler.codec.dns.DnsRecordType(0x0029, "OPT");
     ...
     */
    public static final io.netty.handler.codec.dns.DnsRecordType APL = new io.netty.handler.codec.dns.DnsRecordType(0x002a, "APL");

    /**
     * Delegation signer record RFC 4034 The record used to identify the DNSSEC
     * signing key of a delegated zone.
     */
    public static final io.netty.handler.codec.dns.DnsRecordType DS = new io.netty.handler.codec.dns.DnsRecordType(0x002b, "DS");
     ...
     */
    public static final io.netty.handler.codec.dns.DnsRecordType SSHFP = new io.netty.handler.codec.dns.DnsRecordType(0x002c, "SSHFP");

    /**
     * IPsec Key record RFC 4025 Key record that can be used with IPsec.
     */
    public static final io.netty.handler.codec.dns.DnsRecordType IPSECKEY = new io.netty.handler.codec.dns.DnsRecordType(0x002d, "IPSECKEY");

    /**
     * DNSSEC signature record RFC 4034 Signature for a DNSSEC-secured record
     * set. Uses the same format as the SIG record.
     */
    public static final io.netty.handler.codec.dns.DnsRecordType RRSIG = new io.netty.handler.codec.dns.DnsRecordType(0x002e, "RRSIG");
     ...
     */
    public static final io.netty.handler.codec.dns.DnsRecordType NSEC = new io.netty.handler.codec.dns.DnsRecordType(0x002f, "NSEC");

    /**
     * DNS Key record RFC 4034 The key record used in DNSSEC. Uses the same
     * format as the KEY record.
     */
    public static final io.netty.handler.codec.dns.DnsRecordType DNSKEY = new io.netty.handler.codec.dns.DnsRecordType(0x0030, "DNSKEY");

    /**
     * DHCP identifier record RFC 4701 Used in conjunction with the FQDN option
     * to DHCP.
     */
    public static final io.netty.handler.codec.dns.DnsRecordType DHCID = new io.netty.handler.codec.dns.DnsRecordType(0x0031, "DHCID");
     ...
     */
    public static final io.netty.handler.codec.dns.DnsRecordType NSEC3 = new io.netty.handler.codec.dns.DnsRecordType(0x0032, "NSEC3");

    /**
     * NSEC3 parameters record RFC 5155 Parameter record for use with NSEC3.
     */
    public static final io.netty.handler.codec.dns.DnsRecordType NSEC3PARAM = new io.netty.handler.codec.dns.DnsRecordType(0x0033, "NSEC3PARAM");
     ...
     */
    public static final io.netty.handler.codec.dns.DnsRecordType TLSA = new io.netty.handler.codec.dns.DnsRecordType(0x0034, "TLSA");

    /**
     * Host Identity Protocol record RFC 5205 Method of separating the end-point
     * identifier and locator roles of IP addresses.
     */
    public static final io.netty.handler.codec.dns.DnsRecordType HIP = new io.netty.handler.codec.dns.DnsRecordType(0x0037, "HIP");
     ...
     */
    public static final io.netty.handler.codec.dns.DnsRecordType SPF = new io.netty.handler.codec.dns.DnsRecordType(0x0063, "SPF");
     ...
     * KEY RR..
     */
    public static final io.netty.handler.codec.dns.DnsRecordType TKEY = new io.netty.handler.codec.dns.DnsRecordType(0x00f9, "TKEY");
     ...
     */
    public static final io.netty.handler.codec.dns.DnsRecordType TSIG = new io.netty.handler.codec.dns.DnsRecordType(0x00fa, "TSIG");
     ...
     */
    public static final io.netty.handler.codec.dns.DnsRecordType IXFR = new io.netty.handler.codec.dns.DnsRecordType(0x00fb, "IXFR");
     ...
     */
    public static final io.netty.handler.codec.dns.DnsRecordType AXFR = new io.netty.handler.codec.dns.DnsRecordType(0x00fc, "AXFR");
     ...
     * and Wireshark.
     */
    public static final io.netty.handler.codec.dns.DnsRecordType ANY = new io.netty.handler.codec.dns.DnsRecordType(0x00ff, "ANY");

    /**
     * Certification Authority Authorization record RFC 6844 CA pinning,
     * constraining acceptable CAs for a host/domain.
     */
    public static final io.netty.handler.codec.dns.DnsRecordType CAA = new io.netty.handler.codec.dns.DnsRecordType(0x0101, "CAA");
     ...
     */
    public static final io.netty.handler.codec.dns.DnsRecordType TA = new io.netty.handler.codec.dns.DnsRecordType(0x8000, "TA");
     ...
     */
    public static final io.netty.handler.codec.dns.DnsRecordType DLV = new io.netty.handler.codec.dns.DnsRecordType(0x8001, "DLV");

    private static final Map<String, io.netty.handler.codec.dns.DnsRecordType> BY_NAME = new HashMap<String, io.netty.handler.codec.dns.DnsRecordType>();
    private static final IntObjectHashMap<io.netty.handler.codec.dns.DnsRecordType> BY_TYPE = new IntObjectHashMap<io.netty.handler.codec.dns.DnsRecordType>();
    ...
    static {
        ...
        for (io.netty.handler.codec.dns.DnsRecordType type: all) {
    ...
    public static io.netty.handler.codec.dns.DnsRecordType valueOf(int intValue) {
        io.netty.handler.codec.dns.DnsRecordType result = BY_TYPE.get(intValue);
        if (result == null) {
            return new io.netty.handler.codec.dns.DnsRecordType(intValue);
        }
        return result;
    }

    public static io.netty.handler.codec.dns.DnsRecordType valueOf(String name) {
        io.netty.handler.codec.dns.DnsRecordType result = BY_NAME.get(name);
        if (result == null) {
    ...
    public boolean equals(Object o) {
        return o instanceof io.netty.handler.codec.dns.DnsRecordType && ((io.netty.handler.codec.dns.DnsRecordType) o).intValue == intValue;
    }

    @Override
    public int compareTo(io.netty.handler.codec.dns.DnsRecordType o) {

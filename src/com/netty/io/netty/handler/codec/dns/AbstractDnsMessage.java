...
public abstract class AbstractDnsMessage extends AbstractReferenceCounted implements DnsMessage {
    ...
    /**
     * Creates a new instance with the specified {@code id} and {@link io.netty.handler.codec.dns.DnsOpCode#QUERY} opCode.
     */
    protected AbstractDnsMessage(int id) {
        this(id, io.netty.handler.codec.dns.DnsOpCode.QUERY);
    }

    /**
     * Creates a new instance with the specified {@code id} and {@code opCode}.
     */
    protected AbstractDnsMessage(int id, io.netty.handler.codec.dns.DnsOpCode opCode) {
        setId(id);
        setOpCode(opCode);
    }

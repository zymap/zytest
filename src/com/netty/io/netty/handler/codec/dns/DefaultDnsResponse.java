...
public class DefaultDnsResponse extends AbstractDnsMessage implements DnsResponse {
     ...
     * the {@link io.netty.handler.codec.dns.DnsResponseCode#NOERROR} {@code RCODE}.
     *
     * @param id the {@code ID} of the DNS response
     */
    public DefaultDnsResponse(int id) {
        this(id, DnsOpCode.QUERY, io.netty.handler.codec.dns.DnsResponseCode.NOERROR);
    }

    /**
     * Creates a new instance with the {@link io.netty.handler.codec.dns.DnsResponseCode#NOERROR} {@code RCODE}.
     *
     * @param id the {@code ID} of the DNS response
     * @param opCode the {@code opCode} of the DNS response
     */
    public DefaultDnsResponse(int id, DnsOpCode opCode) {
        this(id, opCode, io.netty.handler.codec.dns.DnsResponseCode.NOERROR);
    }
     ...
     */
    public DefaultDnsResponse(int id, DnsOpCode opCode, io.netty.handler.codec.dns.DnsResponseCode code) {
        super(id, opCode);
        setCode(code);
    }
    ...
    public String toString() {
        return io.netty.handler.codec.dns.DnsMessageUtil.appendResponse(new StringBuilder(128), this).toString();
    }
}

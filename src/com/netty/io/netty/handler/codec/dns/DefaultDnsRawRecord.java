...
public class DefaultDnsRawRecord extends AbstractDnsRecord implements DnsRawRecord {
    ...
    public DnsRawRecord replace(ByteBuf content) {
        return new io.netty.handler.codec.dns.DefaultDnsRawRecord(name(), type(), dnsClass(), timeToLive(), content);
    }
    ...
    public String toString() {
        ...
        if (type != DnsRecordType.OPT) {
            ...
            io.netty.handler.codec.dns.DnsMessageUtil.appendRecordClass(buf, dnsClass())
                          .append(' ')
                          .append(type.name());
        } else {

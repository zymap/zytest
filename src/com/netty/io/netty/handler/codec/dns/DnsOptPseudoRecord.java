...
public interface DnsOptPseudoRecord extends DnsRecord {
    ...
    /**
     * Returns the {@code EXTENDED-RCODE} which is encoded into {@link io.netty.handler.codec.dns.DnsOptPseudoRecord#timeToLive()}.
     */
    int extendedRcode();

    /**
     * Returns the {@code VERSION} which is encoded into {@link io.netty.handler.codec.dns.DnsOptPseudoRecord#timeToLive()}.
     */
    int version();

    /**
     * Returns the {@code flags} which includes {@code DO} and {@code Z} which is encoded
     * into {@link io.netty.handler.codec.dns.DnsOptPseudoRecord#timeToLive()}.
     */
    int flags();
}

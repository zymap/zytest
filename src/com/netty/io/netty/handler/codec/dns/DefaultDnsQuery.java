...
public class DefaultDnsQuery extends AbstractDnsMessage implements DnsQuery {
    ...
    /**
     * Creates a new instance with the {@link io.netty.handler.codec.dns.DnsOpCode#QUERY} {@code opCode}.
     *
     ...
     */
    public DefaultDnsQuery(int id, io.netty.handler.codec.dns.DnsOpCode opCode) {
        super(id, opCode);
    }
    ...
    public String toString() {
        return io.netty.handler.codec.dns.DnsMessageUtil.appendQuery(new StringBuilder(128), this).toString();
    }
}

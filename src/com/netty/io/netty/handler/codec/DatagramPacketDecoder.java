 ...
 * pipeline.addLast("udpDecoder", new {@link io.netty.handler.codec.DatagramPacketDecoder}(new {@link ProtobufDecoder}(...));
 * </code></pre>
 */
public class DatagramPacketDecoder extends io.netty.handler.codec.MessageToMessageDecoder<DatagramPacket> {

    private final io.netty.handler.codec.MessageToMessageDecoder<ByteBuf> decoder;

...
public class DefaultFullBinaryMemcacheResponse extends DefaultBinaryMemcacheResponse
    ...
    /**
     * Create a new {@link io.netty.handler.codec.memcache.binary.DefaultFullBinaryMemcacheResponse} with the header, key and extras.
     *
    ...
    /**
     * Create a new {@link io.netty.handler.codec.memcache.binary.DefaultFullBinaryMemcacheResponse} with the header, key, extras and content.
     *
     * @param key     the key to use.
     * @param extras  the extras to use.
    ...
    public FullBinaryMemcacheResponse copy() {
        ...
        return new io.netty.handler.codec.memcache.binary.DefaultFullBinaryMemcacheResponse(key, extras, content().copy());
    }
    ...
    public FullBinaryMemcacheResponse duplicate() {
        ...
        return new io.netty.handler.codec.memcache.binary.DefaultFullBinaryMemcacheResponse(key, extras, content().duplicate());
    }
    ...
    public FullBinaryMemcacheResponse replace(ByteBuf content) {
        ...
        return new io.netty.handler.codec.memcache.binary.DefaultFullBinaryMemcacheResponse(key, extras, content);
    }
}

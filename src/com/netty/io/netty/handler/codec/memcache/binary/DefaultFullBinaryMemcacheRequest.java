...
public class DefaultFullBinaryMemcacheRequest extends DefaultBinaryMemcacheRequest
    ...
    public FullBinaryMemcacheRequest copy() {
        ...
        return new io.netty.handler.codec.memcache.binary.DefaultFullBinaryMemcacheRequest(key, extras, content().copy());
    }
    ...
    public FullBinaryMemcacheRequest duplicate() {
        ...
        return new io.netty.handler.codec.memcache.binary.DefaultFullBinaryMemcacheRequest(key, extras, content().duplicate());
    }
    ...
    public FullBinaryMemcacheRequest replace(ByteBuf content) {
        ...
        return new io.netty.handler.codec.memcache.binary.DefaultFullBinaryMemcacheRequest(key, extras, content);
    }
}

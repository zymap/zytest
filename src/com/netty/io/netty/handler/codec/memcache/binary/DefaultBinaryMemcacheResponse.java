...
public class DefaultBinaryMemcacheResponse extends AbstractBinaryMemcacheMessage implements BinaryMemcacheResponse {
    ...
    /**
     * Create a new {@link io.netty.handler.codec.memcache.binary.DefaultBinaryMemcacheResponse} with the header only.
     */
    ...
    /**
     * Create a new {@link io.netty.handler.codec.memcache.binary.DefaultBinaryMemcacheResponse} with the header and key.
     *
    ...
    /**
     * Create a new {@link io.netty.handler.codec.memcache.binary.DefaultBinaryMemcacheResponse} with the header, key and extras.
     *
     * @param key    the key to use.

...
public final class BinaryMemcacheClientCodec extends
    ...
    /**
     * Create a new {@link io.netty.handler.codec.memcache.binary.BinaryMemcacheClientCodec} with the default settings applied.
     */
    ...
    /**
     * Create a new {@link io.netty.handler.codec.memcache.binary.BinaryMemcacheClientCodec} and set a custom chunk size.
     *
    ...
    /**
     * Create a new {@link io.netty.handler.codec.memcache.binary.BinaryMemcacheClientCodec} with custom settings.
     *
     * @param decodeChunkSize       the maximum chunk size.

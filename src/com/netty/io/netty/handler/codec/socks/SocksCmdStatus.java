...
public enum SocksCmdStatus {
     ...
     */
    @Deprecated
    public static io.netty.handler.codec.socks.SocksCmdStatus fromByte(byte b) {
        return valueOf(b);
    }

    public static io.netty.handler.codec.socks.SocksCmdStatus valueOf(byte b) {
        for (io.netty.handler.codec.socks.SocksCmdStatus code : values()) {
            if (code.b == b) {
                return code;
            }
        }

...
/**
 * Encodes a {@link io.netty.handler.codec.stomp.StompFrame} or a {@link StompSubframe} into a {@link ByteBuf}.
 */
public class StompSubframeEncoder extends MessageToMessageEncoder<StompSubframe> {
    ...
    protected void encode(ChannelHandlerContext ctx, StompSubframe msg, List<Object> out) throws Exception {
        if (msg instanceof io.netty.handler.codec.stomp.StompFrame) {
            io.netty.handler.codec.stomp.StompFrame frame = (StompFrame) msg;

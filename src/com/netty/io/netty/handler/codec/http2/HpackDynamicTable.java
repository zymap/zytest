...
final class HpackDynamicTable {
     ...
     */
    public io.netty.handler.codec.http2.HpackHeaderField getEntry(int index) {
     ...
     * cleared.
     */
    public void add(io.netty.handler.codec.http2.HpackHeaderField header) {
    ...
    public io.netty.handler.codec.http2.HpackHeaderField remove() {
        io.netty.handler.codec.http2.HpackHeaderField removed = hpackHeaderFields[tail];
        if (removed == null) {
            return null;
        }
        size -= removed.size();
    ...
    public void setCapacity(long capacity) {
        ...
        int maxEntries = (int) (capacity / io.netty.handler.codec.http2.HpackHeaderField.HEADER_ENTRY_OVERHEAD);
        if (capacity % io.netty.handler.codec.http2.HpackHeaderField.HEADER_ENTRY_OVERHEAD != 0) {
            maxEntries++;
        }
        ...
        io.netty.handler.codec.http2.HpackHeaderField[] tmp = new io.netty.handler.codec.http2.HpackHeaderField[maxEntries];

        // initially length will be 0 so there will be no copy
        int len = length();
        int cursor = tail;
        for (int i = 0; i < len; i++) {
            io.netty.handler.codec.http2.HpackHeaderField entry = hpackHeaderFields[cursor++];
            tmp[i] = entry;

...
public class DefaultHttp2Connection implements Http2Connection {
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.handler.codec.http2.DefaultHttp2Connection.class);
    ...
    final DefaultEndpoint<io.netty.handler.codec.http2.Http2LocalFlowController> localEndpoint;
    ...
    public DefaultHttp2Connection(boolean server, int maxReservedStreams) {
        ...
        localEndpoint = new DefaultEndpoint<io.netty.handler.codec.http2.Http2LocalFlowController>(server, server ? MAX_VALUE : maxReservedStreams);
    ...
    private class DefaultStream implements Http2Stream {
        ...
        /**
         * Provides the lazy initialization for the {@link io.netty.handler.codec.http2.DefaultHttp2Connection.DefaultStream} data map.
         */
    ...
    final class DefaultPropertyKey implements PropertyKey {
        ...
        DefaultPropertyKey verifyConnection(Http2Connection connection) {
            if (connection != io.netty.handler.codec.http2.DefaultHttp2Connection.this) {

...
public final class DefaultHttp2HeadersFrame extends AbstractHttp2StreamFrame implements Http2HeadersFrame {
    ...
    @Override
    public io.netty.handler.codec.http2.DefaultHttp2HeadersFrame stream(Http2FrameStream stream) {
        super.stream(stream);
        return this;
    }
    ...
    public boolean equals(Object o) {
        if (!(o instanceof io.netty.handler.codec.http2.DefaultHttp2HeadersFrame)) {
            return false;
        }
        io.netty.handler.codec.http2.DefaultHttp2HeadersFrame other = (io.netty.handler.codec.http2.DefaultHttp2HeadersFrame) o;

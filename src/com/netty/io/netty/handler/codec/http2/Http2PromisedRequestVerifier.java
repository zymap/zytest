...
public interface Http2PromisedRequestVerifier {
    /**
     * Determine if a {@link io.netty.handler.codec.http2.Http2Headers} are authoritative for a particular {@link ChannelHandlerContext}.
     ...
     */
    boolean isAuthoritative(ChannelHandlerContext ctx, io.netty.handler.codec.http2.Http2Headers headers);
     ...
     */
    boolean isCacheable(io.netty.handler.codec.http2.Http2Headers headers);
     ...
     */
    boolean isSafe(io.netty.handler.codec.http2.Http2Headers headers);

    /**
     * A default implementation of {@link io.netty.handler.codec.http2.Http2PromisedRequestVerifier} which always returns positive responses for
     * all verification challenges.
     */
    io.netty.handler.codec.http2.Http2PromisedRequestVerifier ALWAYS_VERIFY = new io.netty.handler.codec.http2.Http2PromisedRequestVerifier() {
        @Override
        public boolean isAuthoritative(ChannelHandlerContext ctx, io.netty.handler.codec.http2.Http2Headers headers) {
            return true;
        }

        @Override
        public boolean isCacheable(io.netty.handler.codec.http2.Http2Headers headers) {
            return true;
        }

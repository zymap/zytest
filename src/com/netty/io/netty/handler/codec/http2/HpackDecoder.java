...
final class HpackDecoder {
    private static final Http2Exception DECODE_ULE_128_DECOMPRESSION_EXCEPTION = unknownStackTrace(
            connectionError(COMPRESSION_ERROR, "HPACK - decompression failure"), io.netty.handler.codec.http2.HpackDecoder.class,
            "decodeULE128(..)");
    private static final Http2Exception DECODE_ULE_128_TO_LONG_DECOMPRESSION_EXCEPTION = unknownStackTrace(
            connectionError(COMPRESSION_ERROR, "HPACK - long overflow"), io.netty.handler.codec.http2.HpackDecoder.class, "decodeULE128(..)");
    private static final Http2Exception DECODE_ULE_128_TO_INT_DECOMPRESSION_EXCEPTION = unknownStackTrace(
            connectionError(COMPRESSION_ERROR, "HPACK - int overflow"), io.netty.handler.codec.http2.HpackDecoder.class, "decodeULE128ToInt(..)");
    private static final Http2Exception DECODE_ILLEGAL_INDEX_VALUE = unknownStackTrace(
            connectionError(COMPRESSION_ERROR, "HPACK - illegal index value"), io.netty.handler.codec.http2.HpackDecoder.class, "decode(..)");
    private static final Http2Exception INDEX_HEADER_ILLEGAL_INDEX_VALUE = unknownStackTrace(
            connectionError(COMPRESSION_ERROR, "HPACK - illegal index value"), io.netty.handler.codec.http2.HpackDecoder.class, "indexHeader(..)");
    private static final Http2Exception READ_NAME_ILLEGAL_INDEX_VALUE = unknownStackTrace(
            connectionError(COMPRESSION_ERROR, "HPACK - illegal index value"), io.netty.handler.codec.http2.HpackDecoder.class, "readName(..)");
    private static final Http2Exception INVALID_MAX_DYNAMIC_TABLE_SIZE = unknownStackTrace(
            connectionError(COMPRESSION_ERROR, "HPACK - invalid max dynamic table size"), io.netty.handler.codec.http2.HpackDecoder.class,
            "setDynamicTableSize(..)");
    private static final Http2Exception MAX_DYNAMIC_TABLE_SIZE_CHANGE_REQUIRED = unknownStackTrace(
            connectionError(COMPRESSION_ERROR, "HPACK - max dynamic table size change required"), io.netty.handler.codec.http2.HpackDecoder.class,
            "decode(..)");
    ...
    private CharSequence readName(int index) throws Http2Exception {
        if (index <= io.netty.handler.codec.http2.HpackStaticTable.length) {
            HpackHeaderField hpackHeaderField = io.netty.handler.codec.http2.HpackStaticTable.getEntry(index);
            return hpackHeaderField.name;
        }
        if (index - io.netty.handler.codec.http2.HpackStaticTable.length <= hpackDynamicTable.length()) {
            HpackHeaderField hpackHeaderField = hpackDynamicTable.getEntry(index - io.netty.handler.codec.http2.HpackStaticTable.length);
            return hpackHeaderField.name;
        }
    ...
    private HpackHeaderField getIndexedHeader(int index) throws Http2Exception {
        if (index <= io.netty.handler.codec.http2.HpackStaticTable.length) {
            return io.netty.handler.codec.http2.HpackStaticTable.getEntry(index);
        }
        if (index - io.netty.handler.codec.http2.HpackStaticTable.length <= hpackDynamicTable.length()) {
            return hpackDynamicTable.getEntry(index - io.netty.handler.codec.http2.HpackStaticTable.length);
        }

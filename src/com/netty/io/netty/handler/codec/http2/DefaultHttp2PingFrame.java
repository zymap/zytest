...
/**
 * The default {@link io.netty.handler.codec.http2.Http2PingFrame} implementation.
 */
@UnstableApi
public class DefaultHttp2PingFrame implements io.netty.handler.codec.http2.Http2PingFrame {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof io.netty.handler.codec.http2.Http2PingFrame)) {
            return false;
        }
        io.netty.handler.codec.http2.Http2PingFrame other = (Http2PingFrame) o;

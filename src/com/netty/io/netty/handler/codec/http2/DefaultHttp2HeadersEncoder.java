...
@UnstableApi
public class DefaultHttp2HeadersEncoder implements io.netty.handler.codec.http2.Http2HeadersEncoder, Http2HeadersEncoder.Configuration {
    ...
    public DefaultHttp2HeadersEncoder(SensitivityDetector sensitivityDetector) {
        this(sensitivityDetector, new io.netty.handler.codec.http2.HpackEncoder());
    }

    public DefaultHttp2HeadersEncoder(SensitivityDetector sensitivityDetector, boolean ignoreMaxHeaderListSize) {
        this(sensitivityDetector, new io.netty.handler.codec.http2.HpackEncoder(ignoreMaxHeaderListSize));
    }

    public DefaultHttp2HeadersEncoder(SensitivityDetector sensitivityDetector, boolean ignoreMaxHeaderListSize,
                                      int dynamicTableArraySizeHint) {
        this(sensitivityDetector, new io.netty.handler.codec.http2.HpackEncoder(ignoreMaxHeaderListSize, dynamicTableArraySizeHint));
    }
     ...
     */
    DefaultHttp2HeadersEncoder(SensitivityDetector sensitivityDetector, io.netty.handler.codec.http2.HpackEncoder hpackEncoder) {

 ...
 * implement the {@link Http2StreamFrame} interface. The {@link io.netty.handler.codec.http2.Http2FrameCodec} is instantiated using the
 * {@link Http2FrameCodecBuilder}. It's recommended for channel handlers to inherit from the
 * {@link io.netty.handler.codec.http2.Http2ChannelDuplexHandler}, as it provides additional functionality like iterating over all active streams or
 ...
 * the {@link io.netty.handler.codec.http2.Http2FrameCodec} can be build with

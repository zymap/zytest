...
public interface Http2Stream {
     ...
     * </ul>
     */
    io.netty.handler.codec.http2.Http2Stream open(boolean halfClosed) throws Http2Exception;

    /**
     * Closes the stream.
     */
    io.netty.handler.codec.http2.Http2Stream close();

    /**
     * Closes the local side of this stream. If this makes the stream closed, the child is closed as
     * well.
     */
    io.netty.handler.codec.http2.Http2Stream closeLocalSide();

    /**
     * Closes the remote side of this stream. If this makes the stream closed, the child is closed
     * as well.
     */
    io.netty.handler.codec.http2.Http2Stream closeRemoteSide();
     ...
     */
    io.netty.handler.codec.http2.Http2Stream resetSent();
     ...
     */
    io.netty.handler.codec.http2.Http2Stream headersSent(boolean isInformational);
     ...
     * @param isInformational {@code true} if the headers contain an informational status code (for responses only).
     */
    io.netty.handler.codec.http2.Http2Stream headersReceived(boolean isInformational);

...
public final class DefaultHttp2DataFrame extends AbstractHttp2StreamFrame implements Http2DataFrame {
    ...
    @Override
    public io.netty.handler.codec.http2.DefaultHttp2DataFrame stream(Http2FrameStream stream) {
        super.stream(stream);
        return this;
    }
    ...
    @Override
    public io.netty.handler.codec.http2.DefaultHttp2DataFrame replace(ByteBuf content) {
        return new io.netty.handler.codec.http2.DefaultHttp2DataFrame(content, endStream, padding);
    }
    ...
    @Override
    public io.netty.handler.codec.http2.DefaultHttp2DataFrame retain(int increment) {
    ...
    @Override
    public io.netty.handler.codec.http2.DefaultHttp2DataFrame touch(Object hint) {
        content.touch(hint);
        return this;
    }
    ...
    public boolean equals(Object o) {
        if (!(o instanceof io.netty.handler.codec.http2.DefaultHttp2DataFrame)) {
            return false;
        }
        io.netty.handler.codec.http2.DefaultHttp2DataFrame other = (io.netty.handler.codec.http2.DefaultHttp2DataFrame) o;

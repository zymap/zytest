...
public final class DefaultHttp2UnknownFrame extends DefaultByteBufHolder implements Http2UnknownFrame {
    ...
    @Override
    public io.netty.handler.codec.http2.DefaultHttp2UnknownFrame stream(Http2FrameStream stream) {
        this.stream = stream;
        return this;
    }
    ...
    @Override
    public io.netty.handler.codec.http2.DefaultHttp2UnknownFrame replace(ByteBuf content) {
        return new io.netty.handler.codec.http2.DefaultHttp2UnknownFrame(frameType, flags, content).stream(stream());
    }
    ...
    @Override
    public io.netty.handler.codec.http2.DefaultHttp2UnknownFrame retain(int increment) {
    ...
    @Override
    public io.netty.handler.codec.http2.DefaultHttp2UnknownFrame touch(Object hint) {
        super.touch(hint);
        return this;
    }
    ...
    public boolean equals(Object o) {
        if (!(o instanceof io.netty.handler.codec.http2.DefaultHttp2UnknownFrame)) {
            return false;
        }
        io.netty.handler.codec.http2.DefaultHttp2UnknownFrame other = (io.netty.handler.codec.http2.DefaultHttp2UnknownFrame) o;

...
/**
 * A skeletal builder implementation of {@link io.netty.handler.codec.http2.InboundHttp2ToHttpAdapter} and its subtypes.
 */
@UnstableApi
public abstract class AbstractInboundHttp2ToHttpAdapterBuilder<
        T extends io.netty.handler.codec.http2.InboundHttp2ToHttpAdapter, B extends io.netty.handler.codec.http2.AbstractInboundHttp2ToHttpAdapterBuilder<T, B>> {
    ...
    /**
     * Creates a new {@link io.netty.handler.codec.http2.InboundHttp2ToHttpAdapter} builder for the specified {@link Http2Connection}.
     *
     ...
     * @return {@link io.netty.handler.codec.http2.AbstractInboundHttp2ToHttpAdapterBuilder} the builder for the {@link io.netty.handler.codec.http2.InboundHttp2ToHttpAdapter}
     */
    ...
    /**
     * Builds/creates a new {@link io.netty.handler.codec.http2.InboundHttp2ToHttpAdapter} instance using this builder's current settings.
     */
    protected T build() {
        final T instance;
        try {

...
public interface Http2FrameWriter extends Http2DataWriter, Closeable {
    /**
     * Configuration specific to {@link io.netty.handler.codec.http2.Http2FrameWriter}
     */
    interface Configuration {
        /**
         * Get the {@link Http2HeadersEncoder.Configuration} for this {@link io.netty.handler.codec.http2.Http2FrameWriter}
         */
        Http2HeadersEncoder.Configuration headersConfiguration();

        /**
         * Get the {@link Http2FrameSizePolicy} for this {@link io.netty.handler.codec.http2.Http2FrameWriter}
         */
    ...
    /**
     * Get the configuration related elements for this {@link io.netty.handler.codec.http2.Http2FrameWriter}
     */

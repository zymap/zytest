 ...
 */
@UnstableApi
public interface Http2Headers extends Headers<CharSequence, CharSequence, io.netty.handler.codec.http2.Http2Headers> {
    ...
    enum PseudoHeaderName {
        ...
        private static final io.netty.handler.codec.http2.CharSequenceMap<PseudoHeaderName> PSEUDO_HEADERS = new CharSequenceMap<PseudoHeaderName>();
     ...
     */
    io.netty.handler.codec.http2.Http2Headers method(CharSequence value);

    /**
     * Sets the {@link PseudoHeaderName#SCHEME} header if there is no such header
     */
    io.netty.handler.codec.http2.Http2Headers scheme(CharSequence value);

    /**
     * Sets the {@link PseudoHeaderName#AUTHORITY} header or {@code null} if there is no such header
     */
    io.netty.handler.codec.http2.Http2Headers authority(CharSequence value);

    /**
     * Sets the {@link PseudoHeaderName#PATH} header or {@code null} if there is no such header
     */
    io.netty.handler.codec.http2.Http2Headers path(CharSequence value);

    /**
     * Sets the {@link PseudoHeaderName#STATUS} header or {@code null} if there is no such header
     */
    io.netty.handler.codec.http2.Http2Headers status(CharSequence value);

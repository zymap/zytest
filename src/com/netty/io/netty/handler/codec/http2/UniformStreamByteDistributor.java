...
/**
 * A {@link io.netty.handler.codec.http2.StreamByteDistributor} that ignores stream priority and uniformly allocates bytes to all
 * streams. This class uses a minimum chunk size that will be allocated to each stream. While
 * fewer streams may be written to in each call to {@link #distribute(int, io.netty.handler.codec.http2.StreamByteDistributor.Writer)}, doing this

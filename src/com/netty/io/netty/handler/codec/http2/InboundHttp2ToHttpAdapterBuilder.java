...
public final class InboundHttp2ToHttpAdapterBuilder
        extends AbstractInboundHttp2ToHttpAdapterBuilder<InboundHttp2ToHttpAdapter, io.netty.handler.codec.http2.InboundHttp2ToHttpAdapterBuilder> {
    ...
    @Override
    public io.netty.handler.codec.http2.InboundHttp2ToHttpAdapterBuilder maxContentLength(int maxContentLength) {
        return super.maxContentLength(maxContentLength);
    }

    @Override
    public io.netty.handler.codec.http2.InboundHttp2ToHttpAdapterBuilder validateHttpHeaders(boolean validate) {
        return super.validateHttpHeaders(validate);
    }

    @Override
    public io.netty.handler.codec.http2.InboundHttp2ToHttpAdapterBuilder propagateSettings(boolean propagate) {

...
/**
 * A HTTP/2 exception for a specific {@link io.netty.handler.codec.http2.Http2FrameStream}.
 */
@UnstableApi
public final class Http2FrameStreamException extends Exception {
    ...
    public Http2FrameStreamException(io.netty.handler.codec.http2.Http2FrameStream stream, Http2Error error, Throwable cause) {

...
/**
 * The default {@link io.netty.handler.codec.http2.Http2GoAwayFrame} implementation.
 */
@UnstableApi
public final class DefaultHttp2GoAwayFrame extends DefaultByteBufHolder implements io.netty.handler.codec.http2.Http2GoAwayFrame {
    ...
    @Override
    public io.netty.handler.codec.http2.Http2GoAwayFrame setExtraStreamIds(int extraStreamIds) {
        if (extraStreamIds < 0) {
    ...
    public io.netty.handler.codec.http2.Http2GoAwayFrame copy() {
        return new io.netty.handler.codec.http2.DefaultHttp2GoAwayFrame(lastStreamId, errorCode, content().copy());
    }

    @Override
    public io.netty.handler.codec.http2.Http2GoAwayFrame duplicate() {
        return (io.netty.handler.codec.http2.Http2GoAwayFrame) super.duplicate();
    }

    @Override
    public io.netty.handler.codec.http2.Http2GoAwayFrame retainedDuplicate() {
        return (io.netty.handler.codec.http2.Http2GoAwayFrame) super.retainedDuplicate();
    }

    @Override
    public io.netty.handler.codec.http2.Http2GoAwayFrame replace(ByteBuf content) {
    ...
    @Override
    public io.netty.handler.codec.http2.Http2GoAwayFrame retain(int increment) {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof io.netty.handler.codec.http2.DefaultHttp2GoAwayFrame)) {
            return false;
        }
        io.netty.handler.codec.http2.DefaultHttp2GoAwayFrame other = (io.netty.handler.codec.http2.DefaultHttp2GoAwayFrame) o;

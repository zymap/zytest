...
public interface StreamByteDistributor {
    ...
    interface StreamState {
         ...
         * @see io.netty.handler.codec.http2.Http2CodecUtil#streamableBytes(StreamState)
         */
        long pendingBytes();
         ...
         * <p>A {@link io.netty.handler.codec.http2.StreamByteDistributor} needs to know the stream's window size in order to avoid allocating bytes

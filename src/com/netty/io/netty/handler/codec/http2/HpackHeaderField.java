...
class HpackHeaderField {
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof io.netty.handler.codec.http2.HpackHeaderField)) {
            return false;
        }
        io.netty.handler.codec.http2.HpackHeaderField other = (io.netty.handler.codec.http2.HpackHeaderField) obj;

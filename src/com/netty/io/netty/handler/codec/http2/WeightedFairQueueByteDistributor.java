    ...
    public WeightedFairQueueByteDistributor(Http2Connection connection, int maxStateOnlySize) {
        ...
        connection.addListener(new Http2ConnectionAdapter() {
            ...
            public void onStreamRemoved(Http2Stream stream) {
                ...
                if (io.netty.handler.codec.http2.WeightedFairQueueByteDistributor.this.maxStateOnlySize == 0) {
                    state.parent.removeChild(state);
                    return;
                }
                if (stateOnlyRemovalQueue.size() == io.netty.handler.codec.http2.WeightedFairQueueByteDistributor.this.maxStateOnlySize) {

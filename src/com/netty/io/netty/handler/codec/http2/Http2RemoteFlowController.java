...
public interface Http2RemoteFlowController extends Http2FlowController {
    ...
    interface FlowControlled {
         ...
         * <p>
         * The {@link io.netty.handler.codec.http2.Http2RemoteFlowController} will make exactly one call to either
         ...
         * <p>
         * When an exception is thrown the {@link io.netty.handler.codec.http2.Http2RemoteFlowController} will make a call to
    ...
    interface Listener {
        /**
         * Notification that {@link io.netty.handler.codec.http2.Http2RemoteFlowController#isWritable(Http2Stream)} has changed for {@code stream}.
         * <p>

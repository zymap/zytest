...
public class Http2Exception extends Exception {
     ...
     */
    public static io.netty.handler.codec.http2.Http2Exception connectionError(Http2Error error, String fmt, Object... args) {
        return new io.netty.handler.codec.http2.Http2Exception(error, String.format(fmt, args));
    }
     ...
     * @return An exception which can be translated into a HTTP/2 error.
     */
    public static io.netty.handler.codec.http2.Http2Exception connectionError(Http2Error error, Throwable cause,
                                                                              String fmt, Object... args) {
        return new io.netty.handler.codec.http2.Http2Exception(error, String.format(fmt, args), cause);
    }
     ...
     * @return An exception which can be translated into a HTTP/2 error.
     */
    public static io.netty.handler.codec.http2.Http2Exception closedStreamError(Http2Error error, String fmt, Object... args) {
     ...
     * {@link io.netty.handler.codec.http2.Http2CodecUtil#CONNECTION_STREAM_ID} then a {@link io.netty.handler.codec.http2.Http2Exception.StreamException} will be returned.
     * Otherwise the error is considered a connection error and a {@link io.netty.handler.codec.http2.Http2Exception} is returned.
     ...
     * Otherwise the error is considered a connection error and a {@link io.netty.handler.codec.http2.Http2Exception} is returned.
     */
    public static io.netty.handler.codec.http2.Http2Exception streamError(int id, Http2Error error, String fmt, Object... args) {
        return CONNECTION_STREAM_ID == id ?
                io.netty.handler.codec.http2.Http2Exception.connectionError(error, fmt, args) :
     ...
     * Otherwise the error is considered a connection error and a {@link io.netty.handler.codec.http2.Http2Exception} is returned.
     */
    public static io.netty.handler.codec.http2.Http2Exception streamError(int id, Http2Error error, Throwable cause,
                                                                          String fmt, Object... args) {
        return CONNECTION_STREAM_ID == id ?
                io.netty.handler.codec.http2.Http2Exception.connectionError(error, cause, fmt, args) :
     ...
     * If the {@code id} is not {@link io.netty.handler.codec.http2.Http2CodecUtil#CONNECTION_STREAM_ID} then a
     * {@link io.netty.handler.codec.http2.Http2Exception.StreamException} will be returned. Otherwise the error is considered a
     * connection error and a {@link io.netty.handler.codec.http2.Http2Exception} is returned.
     * @param id The stream id for which the error is isolated to.
     * @param error The type of error as defined by the HTTP/2 specification.
     ...
     * @param args Objects which fit into the format defined by {@code fmt}.
     * @return If the {@code id} is not
     * {@link io.netty.handler.codec.http2.Http2CodecUtil#CONNECTION_STREAM_ID} then a {@link HeaderListSizeException}
     * will be returned. Otherwise the error is considered a connection error and a {@link io.netty.handler.codec.http2.Http2Exception} is
     * returned.
     */
    public static io.netty.handler.codec.http2.Http2Exception headerListSizeError(int id, Http2Error error, boolean onDecode,
                                                                                  String fmt, Object... args) {
        return CONNECTION_STREAM_ID == id ?
                io.netty.handler.codec.http2.Http2Exception.connectionError(error, fmt, args) :
     ...
     * @return {@code true} if {@code e} is an instance of {@link io.netty.handler.codec.http2.Http2Exception.StreamException}.
     * {@code false} otherwise.
     */
    public static boolean isStreamError(io.netty.handler.codec.http2.Http2Exception e) {
     ...
     */
    public static int streamId(io.netty.handler.codec.http2.Http2Exception e) {
     ...
     */
    public static final class ClosedStreamCreationException extends io.netty.handler.codec.http2.Http2Exception {
     ...
     */
    public static class StreamException extends io.netty.handler.codec.http2.Http2Exception {
     ...
     */
    public static final class CompositeStreamException extends io.netty.handler.codec.http2.Http2Exception implements Iterable<StreamException> {

...
public interface Http2FrameReader extends Closeable {
    /**
     * Configuration specific to {@link io.netty.handler.codec.http2.Http2FrameReader}
     */
    interface Configuration {
        /**
         * Get the {@link Http2HeadersDecoder.Configuration} for this {@link io.netty.handler.codec.http2.Http2FrameReader}
         */
        Http2HeadersDecoder.Configuration headersConfiguration();

        /**
         * Get the {@link io.netty.handler.codec.http2.Http2FrameSizePolicy} for this {@link io.netty.handler.codec.http2.Http2FrameReader}
         */
    ...
    /**
     * Get the configuration related elements for this {@link io.netty.handler.codec.http2.Http2FrameReader}
     */

...
public final class Http2Flags {
     ...
     */
    public io.netty.handler.codec.http2.Http2Flags endOfStream(boolean endOfStream) {
     ...
     */
    public io.netty.handler.codec.http2.Http2Flags endOfHeaders(boolean endOfHeaders) {
     ...
     */
    public io.netty.handler.codec.http2.Http2Flags priorityPresent(boolean priorityPresent) {
     ...
     */
    public io.netty.handler.codec.http2.Http2Flags paddingPresent(boolean paddingPresent) {
     ...
     */
    public io.netty.handler.codec.http2.Http2Flags ack(boolean ack) {
     ...
     */
    public io.netty.handler.codec.http2.Http2Flags setFlag(boolean on, short mask) {
        if (on) {
            value |= mask;
        } else {
            value &= ~mask;
    ...
    public boolean equals(Object obj) {
        ...
        return value == ((io.netty.handler.codec.http2.Http2Flags) obj).value;
    }

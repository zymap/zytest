...
public interface Http2Connection {
    ...
    interface Listener {
         ...
         * will no longer be returned via {@link io.netty.handler.codec.http2.Http2Connection#stream(int)}. The connection may
         ...
         * io.netty.handler.codec.http2.Http2FrameListener#onGoAwayRead(io.netty.channel.ChannelHandlerContext, int, long, ByteBuf)}
    ...
    /**
     * Creates a new key that is unique within this {@link io.netty.handler.codec.http2.Http2Connection}.
     */
    PropertyKey newKey();

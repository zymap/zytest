...
public class Http2ServerUpgradeCodec implements HttpServerUpgradeHandler.UpgradeCodec {
    ...
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.handler.codec.http2.Http2ServerUpgradeCodec.class);
     ...
     */
    public Http2ServerUpgradeCodec(io.netty.handler.codec.http2.Http2MultiplexCodec http2Codec) {

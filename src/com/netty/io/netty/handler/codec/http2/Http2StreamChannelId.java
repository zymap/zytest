...
final class Http2StreamChannelId implements ChannelId {
    ...
    public int compareTo(ChannelId o) {
        if (o instanceof io.netty.handler.codec.http2.Http2StreamChannelId) {
            io.netty.handler.codec.http2.Http2StreamChannelId otherId = (io.netty.handler.codec.http2.Http2StreamChannelId) o;
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof io.netty.handler.codec.http2.Http2StreamChannelId)) {
            return false;
        }
        io.netty.handler.codec.http2.Http2StreamChannelId otherId = (io.netty.handler.codec.http2.Http2StreamChannelId) obj;

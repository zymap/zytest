    ...
    private final class DefaultHttp2StreamChannel extends DefaultAttributeMap implements Http2StreamChannel {
        ...
        private final class Http2ChannelUnsafe implements Unsafe {
            private final VoidChannelPromise unsafeVoidPromise =
                    new VoidChannelPromise(io.netty.handler.codec.http2.Http2MultiplexCodec.DefaultHttp2StreamChannel.this, false);
            ...
            public void beginRead() {
                ...
                if (continueReading && parentReadInProgress) {
                    ...
                    addChildChannelToReadPendingQueue(io.netty.handler.codec.http2.Http2MultiplexCodec.DefaultHttp2StreamChannel.this);
                } else {
            ...
            private void firstWriteComplete(ChannelFuture future, ChannelPromise promise) {
                ...
                if (cause == null) {
                    ...
                    writabilityChanged(io.netty.handler.codec.http2.Http2MultiplexCodec.this.isWritable(stream));
                    promise.setSuccess();
                } else {
            ...
            private ChannelFuture write0(Object msg) {
                ...
                io.netty.handler.codec.http2.Http2MultiplexCodec.this.write(ctx, msg, promise);
                return promise;
            }

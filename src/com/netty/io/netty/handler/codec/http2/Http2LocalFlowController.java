...
public interface Http2LocalFlowController extends Http2FlowController {
     ...
     */
    io.netty.handler.codec.http2.Http2LocalFlowController frameWriter(Http2FrameWriter frameWriter);
     ...
     * @throws io.netty.handler.codec.http2.Http2Exception if any flow control errors are encountered.
     */
    void receiveFlowControlledFrame(Http2Stream stream, ByteBuf data, int padding,
                                    boolean endOfStream) throws io.netty.handler.codec.http2.Http2Exception;
     ...
     * @throws io.netty.handler.codec.http2.Http2Exception if the number of bytes returned exceeds the {@link #unconsumedBytes(Http2Stream)} for the
     * stream.
     */

...
public class DefaultHttp2HeadersDecoder implements Http2HeadersDecoder, Http2HeadersDecoder.Configuration {
    ...
    public DefaultHttp2HeadersDecoder(boolean validateHeaders, long maxHeaderListSize,
        ...
        this(validateHeaders, new io.netty.handler.codec.http2.HpackDecoder(maxHeaderListSize, initialHuffmanDecodeCapacity));
    }
     ...
     */
    DefaultHttp2HeadersDecoder(boolean validateHeaders, io.netty.handler.codec.http2.HpackDecoder hpackDecoder) {

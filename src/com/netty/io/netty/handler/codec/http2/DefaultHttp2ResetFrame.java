...
public final class DefaultHttp2ResetFrame extends AbstractHttp2StreamFrame implements Http2ResetFrame {
    ...
    @Override
    public io.netty.handler.codec.http2.DefaultHttp2ResetFrame stream(Http2FrameStream stream) {
        super.stream(stream);
        return this;
    }
    ...
    public boolean equals(Object o) {
        if (!(o instanceof io.netty.handler.codec.http2.DefaultHttp2ResetFrame)) {
            return false;
        }
        io.netty.handler.codec.http2.DefaultHttp2ResetFrame other = (io.netty.handler.codec.http2.DefaultHttp2ResetFrame) o;

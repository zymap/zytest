...
public final class Http2Settings extends CharObjectHashMap<Long> {
     ...
     */
    public io.netty.handler.codec.http2.Http2Settings headerTableSize(long value) {
     ...
     */
    public io.netty.handler.codec.http2.Http2Settings pushEnabled(boolean enabled) {
     ...
     * @throws IllegalArgumentException if verification of the setting fails.
     */
    public io.netty.handler.codec.http2.Http2Settings maxConcurrentStreams(long value) {
     ...
     * @throws IllegalArgumentException if verification of the setting fails.
     */
    public io.netty.handler.codec.http2.Http2Settings initialWindowSize(int value) {
     ...
     * @throws IllegalArgumentException if verification of the setting fails.
     */
    public io.netty.handler.codec.http2.Http2Settings maxFrameSize(int value) {
     ...
     * @throws IllegalArgumentException if verification of the setting fails.
     */
    public io.netty.handler.codec.http2.Http2Settings maxHeaderListSize(long value) {
     ...
     */
    public io.netty.handler.codec.http2.Http2Settings copyFrom(io.netty.handler.codec.http2.Http2Settings settings) {
        clear();
        putAll(settings);
        return this;
    }
    ...
    public static io.netty.handler.codec.http2.Http2Settings defaultSettings() {
        return new io.netty.handler.codec.http2.Http2Settings().maxHeaderListSize(DEFAULT_HEADER_LIST_SIZE);
    }
}

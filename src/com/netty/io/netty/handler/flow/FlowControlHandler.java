 ...
 * the License.
 */
package com.netty.io.netty.handler.flow;
...
/**
 * The {@link io.netty.handler.flow.FlowControlHandler} ensures that only one message per {@code read()} is sent downstream.
 *
...
public class FlowControlHandler extends ChannelDuplexHandler {
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.handler.flow.FlowControlHandler.class);
    ...
    private static final class RecyclableArrayDeque extends ArrayDeque<Object> {
        ...
        private static final Recycler<RecyclableArrayDeque> RECYCLER = new Recycler<io.netty.handler.flow.FlowControlHandler.RecyclableArrayDeque>() {
            @Override
            protected io.netty.handler.flow.FlowControlHandler.RecyclableArrayDeque newObject(Handle<io.netty.handler.flow.FlowControlHandler.RecyclableArrayDeque> handle) {
                return new io.netty.handler.flow.FlowControlHandler.RecyclableArrayDeque(DEFAULT_NUM_ELEMENTS, handle);
            }
        };

...
/**
 * A {@link io.netty.handler.stream.ChunkedInput} that fetches data from an {@link InputStream} chunk by
 * chunk.
 * <p>
 * Please note that the {@link InputStream} instance that feeds data into
 * {@link io.netty.handler.stream.ChunkedStream} must implement {@link InputStream#available()} as
 * accurately as possible, rather than using the default implementation.
 * Otherwise, {@link io.netty.handler.stream.ChunkedStream} will generate many too small chunks or

...
package com.netty.io.netty.handler.proxy;
...
public abstract class ProxyHandler extends ChannelDuplexHandler {
    ...
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.handler.proxy.ProxyHandler.class);

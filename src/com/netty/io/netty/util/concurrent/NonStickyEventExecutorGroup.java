...
/**
 * {@link io.netty.util.concurrent.EventExecutorGroup} which will preserve {@link Runnable} execution order but makes no guarantees about what
 * {@link EventExecutor} (and therefore {@link Thread}) will be used to execute the {@link Runnable}s.
 *
 * <p>The {@link io.netty.util.concurrent.EventExecutorGroup#next()} for the wrapped {@link io.netty.util.concurrent.EventExecutorGroup} must <strong>NOT</strong> return
 * executors of type {@link OrderedEventExecutor}.
 */
@UnstableApi
public final class NonStickyEventExecutorGroup implements io.netty.util.concurrent.EventExecutorGroup {
    private final io.netty.util.concurrent.EventExecutorGroup group;
    private final int maxTaskExecutePerRun;

    /**
     * Creates a new instance. Be aware that the given {@link io.netty.util.concurrent.EventExecutorGroup} <strong>MUST NOT</strong> contain
     * any {@link OrderedEventExecutor}s.
     */
    public NonStickyEventExecutorGroup(io.netty.util.concurrent.EventExecutorGroup group) {
        this(group, 1024);
    }
     ...
     * any {@link OrderedEventExecutor}s.
     */
    public NonStickyEventExecutorGroup(io.netty.util.concurrent.EventExecutorGroup group, int maxTaskExecutePerRun) {
        this.group = verify(group);
        this.maxTaskExecutePerRun = ObjectUtil.checkPositive(maxTaskExecutePerRun, "maxTaskExecutePerRun");
    }

    private static io.netty.util.concurrent.EventExecutorGroup verify(EventExecutorGroup group) {

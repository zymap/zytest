 ...
 * {@link io.netty.util.concurrent.PromiseCombiner#add(Future)} and {@link io.netty.util.concurrent.PromiseCombiner#addAll(Future[])} methods. When all futures to be
 * combined have been added, callers must provide an aggregate promise to be notified when all combined promises have
 * finished via the {@link io.netty.util.concurrent.PromiseCombiner#finish(Promise)} method.</p>
 */
public final class PromiseCombiner {
    ...
    private final io.netty.util.concurrent.GenericFutureListener<Future<?>> listener = new GenericFutureListener<Future<?>>() {
        @Override
     ...
     * {@link io.netty.util.concurrent.PromiseCombiner#finish(Promise)} method.
     *
     ...
     *
     * <p>After this method is called, no more futures may be added via the {@link io.netty.util.concurrent.PromiseCombiner#add(Future)} or

...
public final class GlobalEventExecutor extends AbstractScheduledEventExecutor {
    ...
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.util.concurrent.GlobalEventExecutor.class);

    private static final long SCHEDULE_QUIET_PERIOD_INTERVAL = TimeUnit.SECONDS.toNanos(1);

    public static final io.netty.util.concurrent.GlobalEventExecutor INSTANCE = new io.netty.util.concurrent.GlobalEventExecutor();
    ...
    final class TaskRunner implements Runnable {
        ...
        public void run() {
            for (;;) {
                ...
                Queue<ScheduledFutureTask<?>> scheduledTaskQueue = io.netty.util.concurrent.GlobalEventExecutor.this.scheduledTaskQueue;

...
public final class UnorderedThreadPoolEventExecutor extends ScheduledThreadPoolExecutor implements EventExecutor {
    ...
    /**
     * Calls {@link io.netty.util.concurrent.UnorderedThreadPoolEventExecutor#UnorderedThreadPoolEventExecutor(int, ThreadFactory)}
     * using {@link DefaultThreadFactory}.
     */
    public UnorderedThreadPoolEventExecutor(int corePoolSize) {
        this(corePoolSize, new DefaultThreadFactory(io.netty.util.concurrent.UnorderedThreadPoolEventExecutor.class));
    }
    ...
    /**
     * Calls {@link io.netty.util.concurrent.UnorderedThreadPoolEventExecutor#UnorderedThreadPoolEventExecutor(int,
    ...
    public UnorderedThreadPoolEventExecutor(int corePoolSize, RejectedExecutionHandler handler) {
        this(corePoolSize, new DefaultThreadFactory(io.netty.util.concurrent.UnorderedThreadPoolEventExecutor.class), handler);
    }
    ...
    private static final class RunnableScheduledFutureTask<V> extends io.netty.util.concurrent.PromiseTask<V>

...
public final class ThreadDeathWatcher {
    ...
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.util.ThreadDeathWatcher.class);
    // visible for testing
    ...
    private static void schedule(Thread thread, Runnable task, boolean isWatch) {
        ...
        if (started.compareAndSet(false, true)) {
            ...
            watcherThread.start();
            io.netty.util.ThreadDeathWatcher.watcherThread = watcherThread;
        }
    }
    ...
    public static boolean awaitInactivity(long timeout, TimeUnit unit) throws InterruptedException {
        ...
        Thread watcherThread = io.netty.util.ThreadDeathWatcher.watcherThread;

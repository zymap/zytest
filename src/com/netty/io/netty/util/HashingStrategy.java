...
public interface HashingStrategy<T> {
    ...
    /**
     * A {@link io.netty.util.HashingStrategy} which delegates to java's {@link Object#hashCode()}
     * and {@link Object#equals(Object)}.
     */
    @SuppressWarnings("rawtypes")
    io.netty.util.HashingStrategy JAVA_HASHER = new io.netty.util.HashingStrategy() {
        @Override

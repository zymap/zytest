...
public class DomainNameMapping<V> implements Mapping<String, V> {
     ...
     * @deprecated use {@link io.netty.util.DomainNameMappingBuilder} to create and fill the mapping instead
     */
    @Deprecated
     ...
     */
    @Deprecated
    public io.netty.util.DomainNameMapping<V> add(String hostname, V output) {

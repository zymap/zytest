...
public final class Version {
     ...
     *
     * @return A {@link Map} whose keys are Maven artifact IDs and whose values are {@link io.netty.util.Version}s
     */
    public static Map<String, io.netty.util.Version> identify() {
     ...
     * @return A {@link Map} whose keys are Maven artifact IDs and whose values are {@link io.netty.util.Version}s
     */
    public static Map<String, io.netty.util.Version> identify(ClassLoader classLoader) {
        if (classLoader == null) {
        ...
        Map<String, io.netty.util.Version> versions = new TreeMap<String, io.netty.util.Version>();
        for (String artifactId: artifactIds) {
            versions.put(
                    artifactId,
                    new io.netty.util.Version(
                            artifactId,
    ...
    public static void main(String[] args) {
        for (io.netty.util.Version v: identify().values()) {

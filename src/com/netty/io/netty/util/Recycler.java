...
public abstract class Recycler<T> {
    ...
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.util.Recycler.class);
    ...
    private final FastThreadLocal<Stack<T>> threadLocal = new FastThreadLocal<Stack<T>>() {
        ...
        protected Stack<T> initialValue() {
            return new Stack<T>(io.netty.util.Recycler.this, Thread.currentThread(), maxCapacityPerThread, maxSharedCapacityFactor,
    ...
    static final class Stack<T> {
        ...
        Stack(io.netty.util.Recycler<T> parent, Thread thread, int maxCapacity, int maxSharedCapacityFactor,

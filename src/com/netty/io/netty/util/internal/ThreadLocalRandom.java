...
public final class ThreadLocalRandom extends Random {
    ...
    public static void setInitialSeedUniquifier(long initialSeedUniquifier) {
        io.netty.util.internal.ThreadLocalRandom.initialSeedUniquifier = initialSeedUniquifier;
    }

    public static long getInitialSeedUniquifier() {
        // Use the value set via the setter.
        long initialSeedUniquifier = io.netty.util.internal.ThreadLocalRandom.initialSeedUniquifier;
        if (initialSeedUniquifier != 0) {
            return initialSeedUniquifier;
        }

        synchronized (io.netty.util.internal.ThreadLocalRandom.class) {
            initialSeedUniquifier = io.netty.util.internal.ThreadLocalRandom.initialSeedUniquifier;
            if (initialSeedUniquifier != 0) {
                return initialSeedUniquifier;
            }

...
public final class MacAddressUtil {
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.util.internal.MacAddressUtil.class);
        ...
        try {
            ...
            if (interfaces != null) {
                while (interfaces.hasMoreElements()) {
                    ...
                    Enumeration<InetAddress> addrs = io.netty.util.internal.SocketUtils.addressesFromNetworkInterface(iface);

...
public abstract class TypeParameterMatcher {
    ...
    private static final io.netty.util.internal.TypeParameterMatcher NOOP = new io.netty.util.internal.TypeParameterMatcher() {
        @Override
    ...
    public static io.netty.util.internal.TypeParameterMatcher get(final Class<?> parameterType) {
        final Map<Class<?>, io.netty.util.internal.TypeParameterMatcher> getCache =
                io.netty.util.internal.InternalThreadLocalMap.get().typeParameterMatcherGetCache();

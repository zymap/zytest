...
public final class PlatformDependent {
    ...
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.util.internal.PlatformDependent.class);
    ...
    static {
         ...
         * guard.
         */
        if (!hasUnsafe() && !isAndroid() && !io.netty.util.internal.PlatformDependent0.isExplicitNoUnsafe()) {
            logger.info(
        ...
        if (maxDirectMemory == 0 || !hasUnsafe() || !io.netty.util.internal.PlatformDependent0.hasDirectBufferNoCleanerConstructor()) {
        ...
        UNINITIALIZED_ARRAY_ALLOCATION_THRESHOLD = javaVersion() >= 9 && io.netty.util.internal.PlatformDependent0.hasAllocateArrayMethod() ?
        ...
        if (!isAndroid() && hasUnsafe()) {
            ...
            if (javaVersion() >= 9) {
                ...
                CLEANER = io.netty.util.internal.CleanerJava6.isSupported() ? new io.netty.util.internal.CleanerJava6() : NOOP;
            }
        } else {
            CLEANER = NOOP;
        }
    ...
    public static boolean hasDirectBufferNoCleanerConstructor() {
        return io.netty.util.internal.PlatformDependent0.hasDirectBufferNoCleanerConstructor();
    }

    public static byte[] allocateUninitializedArray(int size) {
        return UNINITIALIZED_ARRAY_ALLOCATION_THRESHOLD < 0 || UNINITIALIZED_ARRAY_ALLOCATION_THRESHOLD > size ?
                new byte[size] : io.netty.util.internal.PlatformDependent0.allocateUninitializedArray(size);
    }
    ...
    public static boolean isAndroid() {
        return io.netty.util.internal.PlatformDependent0.isAndroid();
    }
    ...
    public static int javaVersion() {
        return io.netty.util.internal.PlatformDependent0.javaVersion();
    }
    ...
    public static boolean isUnaligned() {
        return io.netty.util.internal.PlatformDependent0.isUnaligned();
    }
    ...
    public static long allocateMemory(long size) {
        return io.netty.util.internal.PlatformDependent0.allocateMemory(size);
    }

    public static void freeMemory(long address) {
        io.netty.util.internal.PlatformDependent0.freeMemory(address);
    }

    public static long reallocateMemory(long address, long newSize) {
        return io.netty.util.internal.PlatformDependent0.reallocateMemory(address, newSize);
    }
    ...
    public static void throwException(Throwable t) {
        if (hasUnsafe()) {
            io.netty.util.internal.PlatformDependent0.throwException(t);
        } else {
            io.netty.util.internal.PlatformDependent.<RuntimeException>throwException0(t);
        }
    }
    ...
    public static long directBufferAddress(ByteBuffer buffer) {
        return io.netty.util.internal.PlatformDependent0.directBufferAddress(buffer);
    }

    public static ByteBuffer directBuffer(long memoryAddress, int size) {
        if (io.netty.util.internal.PlatformDependent0.hasDirectBufferNoCleanerConstructor()) {
            return io.netty.util.internal.PlatformDependent0.newDirectBuffer(memoryAddress, size);
        }
    ...
    public static int getInt(Object object, long fieldOffset) {
        return io.netty.util.internal.PlatformDependent0.getInt(object, fieldOffset);
    }

    public static byte getByte(long address) {
        return io.netty.util.internal.PlatformDependent0.getByte(address);
    }

    public static short getShort(long address) {
        return io.netty.util.internal.PlatformDependent0.getShort(address);
    }

    public static int getInt(long address) {
        return io.netty.util.internal.PlatformDependent0.getInt(address);
    }

    public static long getLong(long address) {
        return io.netty.util.internal.PlatformDependent0.getLong(address);
    }

    public static byte getByte(byte[] data, int index) {
        return io.netty.util.internal.PlatformDependent0.getByte(data, index);
    }

    public static short getShort(byte[] data, int index) {
        return io.netty.util.internal.PlatformDependent0.getShort(data, index);
    }

    public static int getInt(byte[] data, int index) {
        return io.netty.util.internal.PlatformDependent0.getInt(data, index);
    }

    public static long getLong(byte[] data, int index) {
        return io.netty.util.internal.PlatformDependent0.getLong(data, index);
    }
    ...
    public static void putByte(long address, byte value) {
        io.netty.util.internal.PlatformDependent0.putByte(address, value);
    }

    public static void putShort(long address, short value) {
        io.netty.util.internal.PlatformDependent0.putShort(address, value);
    }

    public static void putInt(long address, int value) {
        io.netty.util.internal.PlatformDependent0.putInt(address, value);
    }

    public static void putLong(long address, long value) {
        io.netty.util.internal.PlatformDependent0.putLong(address, value);
    }

    public static void putByte(byte[] data, int index, byte value) {
        io.netty.util.internal.PlatformDependent0.putByte(data, index, value);
    }

    public static void putShort(byte[] data, int index, short value) {
        io.netty.util.internal.PlatformDependent0.putShort(data, index, value);
    }

    public static void putInt(byte[] data, int index, int value) {
        io.netty.util.internal.PlatformDependent0.putInt(data, index, value);
    }

    public static void putLong(byte[] data, int index, long value) {
        io.netty.util.internal.PlatformDependent0.putLong(data, index, value);
    }

    public static void copyMemory(long srcAddr, long dstAddr, long length) {
        io.netty.util.internal.PlatformDependent0.copyMemory(srcAddr, dstAddr, length);
    }

    public static void copyMemory(byte[] src, int srcIndex, long dstAddr, long length) {
        io.netty.util.internal.PlatformDependent0.copyMemory(src, BYTE_ARRAY_BASE_OFFSET + srcIndex, null, dstAddr, length);
    }

    public static void copyMemory(long srcAddr, byte[] dst, int dstIndex, long length) {
        io.netty.util.internal.PlatformDependent0.copyMemory(null, srcAddr, dst, BYTE_ARRAY_BASE_OFFSET + dstIndex, length);
    }

    public static void setMemory(byte[] dst, int dstIndex, long bytes, byte value) {
        io.netty.util.internal.PlatformDependent0.setMemory(dst, BYTE_ARRAY_BASE_OFFSET + dstIndex, bytes, value);
    }

    public static void setMemory(long address, long bytes, byte value) {
        io.netty.util.internal.PlatformDependent0.setMemory(address, bytes, value);
    }
    ...
    public static ByteBuffer allocateDirectNoCleaner(int capacity) {
        ...
        try {
            return io.netty.util.internal.PlatformDependent0.allocateDirectNoCleaner(capacity);
        } catch (Throwable e) {
    ...
    public static ByteBuffer reallocateDirectNoCleaner(ByteBuffer buffer, int capacity) {
        ...
        try {
            return io.netty.util.internal.PlatformDependent0.reallocateDirectNoCleaner(buffer, capacity);
        } catch (Throwable e) {
    ...
    public static void freeDirectNoCleaner(ByteBuffer buffer) {
        ...
        io.netty.util.internal.PlatformDependent0.freeMemory(io.netty.util.internal.PlatformDependent0.directBufferAddress(buffer));
        decrementMemoryCounter(capacity);
    }
    ...
    public static boolean equals(byte[] bytes1, int startPos1, byte[] bytes2, int startPos2, int length) {
        return !hasUnsafe() || !unalignedAccess() ?
                  ...
                  io.netty.util.internal.PlatformDependent0.equals(bytes1, startPos1, bytes2, startPos2, length);
    }
    ...
    public static boolean isZero(byte[] bytes, int startPos, int length) {
        return !hasUnsafe() || !unalignedAccess() ?
                ...
                io.netty.util.internal.PlatformDependent0.isZero(bytes, startPos, length);
    }
    ...
    public static int equalsConstantTime(byte[] bytes1, int startPos1, byte[] bytes2, int startPos2, int length) {
        return !hasUnsafe() || !unalignedAccess() ?
                  ...
                  io.netty.util.internal.PlatformDependent0.equalsConstantTime(bytes1, startPos1, bytes2, startPos2, length);
    }
    ...
    public static int hashCodeAscii(byte[] bytes, int startPos, int length) {
        return !hasUnsafe() || !unalignedAccess() ?
                ...
                io.netty.util.internal.PlatformDependent0.hashCodeAscii(bytes, startPos, length);
    }
    ...
    public static ClassLoader getClassLoader(final Class<?> clazz) {
        return io.netty.util.internal.PlatformDependent0.getClassLoader(clazz);
    }
    ...
    public static ClassLoader getContextClassLoader() {
        return io.netty.util.internal.PlatformDependent0.getContextClassLoader();
    }
    ...
    public static ClassLoader getSystemClassLoader() {
        return io.netty.util.internal.PlatformDependent0.getSystemClassLoader();
    }
    ...
    private static Throwable unsafeUnavailabilityCause0() {
        ...
        Throwable cause = io.netty.util.internal.PlatformDependent0.getUnsafeUnavailabilityCause();
        if (cause != null) {
            return cause;
        }

        try {
            boolean hasUnsafe = io.netty.util.internal.PlatformDependent0.hasUnsafe();
            logger.debug("sun.misc.Unsafe: {}", hasUnsafe ? "available" : "unavailable");
            return hasUnsafe ? null : io.netty.util.internal.PlatformDependent0.getUnsafeUnavailabilityCause();
        } catch (Throwable t) {
    ...
    private static int addressSize0() {
        ...
        return io.netty.util.internal.PlatformDependent0.addressSize();
    }
    ...
    private static long byteArrayBaseOffset0() {
        ...
        return io.netty.util.internal.PlatformDependent0.byteArrayBaseOffset();
    }
    ...
    static int hashCodeAsciiSafe(byte[] bytes, int startPos, int length) {
        ...
        for (int i = startPos - 8 + length; i >= end; i -= 8) {
            hash = io.netty.util.internal.PlatformDependent0.hashCodeAsciiCompute(getLongSafe(bytes, i), hash);
        }
        switch(remainingBytes) {
        case 7:

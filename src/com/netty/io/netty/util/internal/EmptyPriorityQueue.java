...
public final class EmptyPriorityQueue<T> implements PriorityQueue<T> {
    private static final PriorityQueue<Object> INSTANCE = new io.netty.util.internal.EmptyPriorityQueue<Object>();
    ...
    public static <V> io.netty.util.internal.EmptyPriorityQueue<V> instance() {
        return (io.netty.util.internal.EmptyPriorityQueue<V>) INSTANCE;
    }
    ...
    public String toString() {
        return io.netty.util.internal.EmptyPriorityQueue.class.getSimpleName();
    }
}

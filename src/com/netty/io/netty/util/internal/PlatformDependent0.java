...
final class PlatformDependent0 {
    ...
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.util.internal.PlatformDependent0.class);
            ...
            final Object maybeUnsafe = AccessController.doPrivileged(new PrivilegedAction<Object>() {
                ...
                public Object run() {
                    try {
                        ...
                        Throwable cause = io.netty.util.internal.ReflectionUtil.trySetAccessible(unsafeField, false);
                        if (cause != null) {
                            return cause;
                        }
                        // the unsafe instance
                        ...
                        AccessController.doPrivileged(new PrivilegedAction<Object>() {
                            ...
                            public Object run() {
                                try {
                                    ...
                                    Throwable cause = io.netty.util.internal.ReflectionUtil.trySetAccessible(constructor, true);
                                    if (cause != null) {
                                        return cause;
                                    }
                                    return constructor;
                ...
                Object maybeException = AccessController.doPrivileged(new PrivilegedAction<Object>() {
                    ...
                    public Object run() {
                        try {
                            ...
                            // sun.misc.Unsafe
                            Class<?> internalUnsafeClass = getClassLoader(io.netty.util.internal.PlatformDependent0.class)

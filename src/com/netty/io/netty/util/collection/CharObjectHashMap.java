...
package com.netty.io.netty.util.collection;
...
/**
 * A hash map implementation of {@link io.netty.util.collection.CharObjectMap} that uses open addressing for keys.
 ...
 */
public class CharObjectHashMap<V> implements io.netty.util.collection.CharObjectMap<V> {
    ...
    public void putAll(Map<? extends Character, ? extends V> sourceMap) {
        if (sourceMap instanceof io.netty.util.collection.CharObjectHashMap) {
            // Optimization - iterate through the arrays.
            @SuppressWarnings("unchecked")
            io.netty.util.collection.CharObjectHashMap<V> source = (io.netty.util.collection.CharObjectHashMap<V>) sourceMap;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof io.netty.util.collection.CharObjectMap)) {
            return false;
        }
        @SuppressWarnings("rawtypes")
        io.netty.util.collection.CharObjectMap other = (CharObjectMap) obj;
        if (size != other.size()) {
            return false;
        }
    ...
    private final class EntrySet extends AbstractSet<Entry<Character, V>> {
        ...
        @Override
        public int size() {
            return io.netty.util.collection.CharObjectHashMap.this.size();
        }
    }
    ...
    private final class KeySet extends AbstractSet<Character> {
        ...
        public boolean contains(Object o) {
            return io.netty.util.collection.CharObjectHashMap.this.containsKey(o);
        }

        @Override
        public boolean remove(Object o) {
            return io.netty.util.collection.CharObjectHashMap.this.remove(o) != null;
        }
        ...
        @Override
        public void clear() {
            io.netty.util.collection.CharObjectHashMap.this.clear();
        }

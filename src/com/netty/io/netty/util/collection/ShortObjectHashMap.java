...
public class ShortObjectHashMap<V> implements ShortObjectMap<V> {
    ...
    public void putAll(Map<? extends Short, ? extends V> sourceMap) {
        if (sourceMap instanceof io.netty.util.collection.ShortObjectHashMap) {
            // Optimization - iterate through the arrays.
            @SuppressWarnings("unchecked")
            io.netty.util.collection.ShortObjectHashMap<V> source = (io.netty.util.collection.ShortObjectHashMap<V>) sourceMap;
    ...
    private final class EntrySet extends AbstractSet<Entry<Short, V>> {
        ...
        @Override
        public int size() {
            return io.netty.util.collection.ShortObjectHashMap.this.size();
        }
    }
    ...
    private final class KeySet extends AbstractSet<Short> {
        ...
        public boolean contains(Object o) {
            return io.netty.util.collection.ShortObjectHashMap.this.containsKey(o);
        }

        @Override
        public boolean remove(Object o) {
            return io.netty.util.collection.ShortObjectHashMap.this.remove(o) != null;
        }
        ...
        @Override
        public void clear() {
            io.netty.util.collection.ShortObjectHashMap.this.clear();
        }

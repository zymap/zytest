...
public class ByteObjectHashMap<V> implements ByteObjectMap<V> {
    ...
    public void putAll(Map<? extends Byte, ? extends V> sourceMap) {
        if (sourceMap instanceof io.netty.util.collection.ByteObjectHashMap) {
            // Optimization - iterate through the arrays.
            @SuppressWarnings("unchecked")
            io.netty.util.collection.ByteObjectHashMap<V> source = (io.netty.util.collection.ByteObjectHashMap<V>) sourceMap;
    ...
    private final class EntrySet extends AbstractSet<Entry<Byte, V>> {
        ...
        @Override
        public int size() {
            return io.netty.util.collection.ByteObjectHashMap.this.size();
        }
    }
    ...
    private final class KeySet extends AbstractSet<Byte> {
        ...
        public boolean contains(Object o) {
            return io.netty.util.collection.ByteObjectHashMap.this.containsKey(o);
        }

        @Override
        public boolean remove(Object o) {
            return io.netty.util.collection.ByteObjectHashMap.this.remove(o) != null;
        }
        ...
        @Override
        public void clear() {
            io.netty.util.collection.ByteObjectHashMap.this.clear();
        }

...
public class LongObjectHashMap<V> implements LongObjectMap<V> {
    ...
    public void putAll(Map<? extends Long, ? extends V> sourceMap) {
        if (sourceMap instanceof io.netty.util.collection.LongObjectHashMap) {
            // Optimization - iterate through the arrays.
            @SuppressWarnings("unchecked")
            io.netty.util.collection.LongObjectHashMap<V> source = (io.netty.util.collection.LongObjectHashMap<V>) sourceMap;
    ...
    private final class EntrySet extends AbstractSet<Entry<Long, V>> {
        ...
        @Override
        public int size() {
            return io.netty.util.collection.LongObjectHashMap.this.size();
        }
    }
    ...
    private final class KeySet extends AbstractSet<Long> {
        ...
        public boolean contains(Object o) {
            return io.netty.util.collection.LongObjectHashMap.this.containsKey(o);
        }

        @Override
        public boolean remove(Object o) {
            return io.netty.util.collection.LongObjectHashMap.this.remove(o) != null;
        }
        ...
        @Override
        public void clear() {
            io.netty.util.collection.LongObjectHashMap.this.clear();
        }

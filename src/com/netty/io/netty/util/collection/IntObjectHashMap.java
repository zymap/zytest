...
public class IntObjectHashMap<V> implements IntObjectMap<V> {
    ...
    public void putAll(Map<? extends Integer, ? extends V> sourceMap) {
        if (sourceMap instanceof io.netty.util.collection.IntObjectHashMap) {
            // Optimization - iterate through the arrays.
            @SuppressWarnings("unchecked")
            io.netty.util.collection.IntObjectHashMap<V> source = (io.netty.util.collection.IntObjectHashMap<V>) sourceMap;
    ...
    private final class EntrySet extends AbstractSet<Entry<Integer, V>> {
        ...
        @Override
        public int size() {
            return io.netty.util.collection.IntObjectHashMap.this.size();
        }
    }
    ...
    private final class KeySet extends AbstractSet<Integer> {
        ...
        public boolean contains(Object o) {
            return io.netty.util.collection.IntObjectHashMap.this.containsKey(o);
        }

        @Override
        public boolean remove(Object o) {
            return io.netty.util.collection.IntObjectHashMap.this.remove(o) != null;
        }
        ...
        @Override
        public void clear() {
            io.netty.util.collection.IntObjectHashMap.this.clear();
        }

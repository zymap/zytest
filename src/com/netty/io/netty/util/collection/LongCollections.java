...
public final class LongCollections {
    ...
    private static final io.netty.util.collection.LongObjectMap<Object> EMPTY_MAP = new EmptyMap();

    private LongCollections() {
    }

    /**
     * Returns an unmodifiable empty {@link io.netty.util.collection.LongObjectMap}.
     */
    @SuppressWarnings("unchecked")
    public static <V> io.netty.util.collection.LongObjectMap<V> emptyMap() {
        return (io.netty.util.collection.LongObjectMap<V>) EMPTY_MAP;
    }

    /**
     * Creates an unmodifiable wrapper around the given map.
     */
    public static <V> io.netty.util.collection.LongObjectMap<V> unmodifiableMap(final io.netty.util.collection.LongObjectMap<V> map) {
     ...
     */
    private static final class EmptyMap implements io.netty.util.collection.LongObjectMap<Object> {
        @Override
    ...
    /**
     * An unmodifiable wrapper around a {@link io.netty.util.collection.LongObjectMap}.
     *
     * @param <V> the value type stored in the map.
     */
    private static final class UnmodifiableMap<V> implements io.netty.util.collection.LongObjectMap<V> {
        private final io.netty.util.collection.LongObjectMap<V> map;

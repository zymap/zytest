...
public final class ReferenceCountUtil {
    ...
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.util.ReferenceCountUtil.class);

    static {
        ResourceLeakDetector.addExclusions(io.netty.util.ReferenceCountUtil.class, "touch");
    }

...
public interface BooleanSupplier {
     ...
     */
    io.netty.util.BooleanSupplier FALSE_SUPPLIER = new io.netty.util.BooleanSupplier() {
        @Override
        public boolean get() {
            return false;
        }
     ...
     */
    io.netty.util.BooleanSupplier TRUE_SUPPLIER = new io.netty.util.BooleanSupplier() {
        @Override
        public boolean get() {
            return true;
        }

...
public final class AsciiString implements CharSequence, Comparable<CharSequence> {
    public static final io.netty.util.AsciiString EMPTY_STRING = cached("");
    ...
    /**
     * Initialize an {@link io.netty.util.AsciiString} based upon the underlying storage from {@code value}.
     * There is a potential to share the underlying array storage if {@link ByteBuffer#hasArray()} is {@code true}.
     * if {@code copy} is {@code true} a copy will be made of the memory.
     * if {@code copy} is {@code false} the underlying storage will be shared, if possible.
     */
    ...
    /**
     * During normal use cases the {@link io.netty.util.AsciiString} should be immutable, but if the underlying array is shared,
     ...
     */
    public io.netty.util.AsciiString concat(CharSequence string) {
        int thisLen = length();
        ...
        if (string.getClass() == io.netty.util.AsciiString.class) {
            io.netty.util.AsciiString that = (io.netty.util.AsciiString) string;
            if (isEmpty()) {
                return that;
            }
            ...
            return new io.netty.util.AsciiString(newValue, false);
        }

        if (isEmpty()) {
            return new io.netty.util.AsciiString(string);
        }
    ...
    public boolean contentEqualsIgnoreCase(CharSequence string) {
        ...
        if (string.getClass() == io.netty.util.AsciiString.class) {
            io.netty.util.AsciiString rhs = (io.netty.util.AsciiString) string;
     ...
     */
    public io.netty.util.AsciiString subSequence(int start) {
     ...
     */
    @Override
    public io.netty.util.AsciiString subSequence(int start, int end) {
     ...
     * @throws IndexOutOfBoundsException if {@code start < 0} or {@code start > length()}.
     */
    public io.netty.util.AsciiString subSequence(int start, int end, boolean copy) {
        ...
        return new io.netty.util.AsciiString(value, start + offset, end - start, copy);
    }
     ...
     */
    public io.netty.util.AsciiString replace(char oldChar, char newChar) {
        ...
        return new io.netty.util.AsciiString(buffer, false);
    }
    ...
    public static CharSequence trim(CharSequence c) {
        if (c.getClass() == io.netty.util.AsciiString.class) {
            return ((io.netty.util.AsciiString) c).trim();
        }
    ...
    public io.netty.util.AsciiString trim() {
        ...
        return new io.netty.util.AsciiString(value, start, end - start + 1, false);
    }
    ...
    public boolean contentEquals(CharSequence a) {
        ...
        if (a.getClass() == io.netty.util.AsciiString.class) {
            return equals(a);
        }
     ...
     */
    public io.netty.util.AsciiString[] split(String expr, int max) {
     ...
     */
    public io.netty.util.AsciiString[] split(char delim) {
        final List<io.netty.util.AsciiString> res = InternalThreadLocalMap.get().arrayList();
        ...
        for (int i = start; i < length; i++) {
            if (charAt(i) == delim) {
                if (start == i) {
                    ...
                    res.add(new io.netty.util.AsciiString(value, start + arrayOffset(), i - start, false));
                }
                start = i + 1;
            }
        }
        ...
        if (start == 0) { // If no delimiter was found in the value
            ...
            if (start != length) {
                ...
                res.add(new io.netty.util.AsciiString(value, start + arrayOffset(), length - start, false));
            } else {
        ...
        return res.toArray(new io.netty.util.AsciiString[res.size()]);
    }
    ...
    public boolean equals(Object obj) {
        if (obj == null || obj.getClass() != io.netty.util.AsciiString.class) {
            return false;
        }
        if (this == obj) {
            return true;
        ...
        io.netty.util.AsciiString other = (io.netty.util.AsciiString) obj;
    ...
    public static final HashingStrategy<CharSequence> CASE_INSENSITIVE_HASHER =
        ...
        public int hashCode(CharSequence o) {
            return io.netty.util.AsciiString.hashCode(o);
        }

        @Override
        public boolean equals(CharSequence a, CharSequence b) {
            return io.netty.util.AsciiString.contentEqualsIgnoreCase(a, b);
        }
    };
    ...
    public static final HashingStrategy<CharSequence> CASE_SENSITIVE_HASHER =
        ...
        @Override
        public boolean equals(CharSequence a, CharSequence b) {
            return io.netty.util.AsciiString.contentEquals(a, b);
        }
    };

    /**
     * Returns an {@link io.netty.util.AsciiString} containing the given character sequence. If the given string is already a
     * {@link io.netty.util.AsciiString}, just returns the same instance.
     */
    public static io.netty.util.AsciiString of(CharSequence string) {
        return string.getClass() == io.netty.util.AsciiString.class ? (io.netty.util.AsciiString) string : new io.netty.util.AsciiString(string);
    }

    /**
     * Returns an {@link io.netty.util.AsciiString} containing the given string and retains/caches the input
     ...
     */
    public static io.netty.util.AsciiString cached(String string) {
        io.netty.util.AsciiString asciiString = new io.netty.util.AsciiString(string);
     ...
     * algorithm with {@link #hashCode()} so that you can put both {@link io.netty.util.AsciiString}s and arbitrary
    ...
    public static int hashCode(CharSequence value) {
        ...
        if (value.getClass() == io.netty.util.AsciiString.class) {
    ...
    public static boolean contentEqualsIgnoreCase(CharSequence a, CharSequence b) {
        ...
        if (a.getClass() == io.netty.util.AsciiString.class) {
            return ((io.netty.util.AsciiString) a).contentEqualsIgnoreCase(b);
        }
        if (b.getClass() == io.netty.util.AsciiString.class) {
            return ((io.netty.util.AsciiString) b).contentEqualsIgnoreCase(a);
        }
    ...
    public static boolean contentEquals(CharSequence a, CharSequence b) {
        ...
        if (a.getClass() == io.netty.util.AsciiString.class) {
            return ((io.netty.util.AsciiString) a).contentEquals(b);
        }

        if (b.getClass() == io.netty.util.AsciiString.class) {
            return ((io.netty.util.AsciiString) b).contentEquals(a);
        }
    ...
    private static io.netty.util.AsciiString[] toAsciiStringArray(String[] jdkResult) {
        io.netty.util.AsciiString[] res = new io.netty.util.AsciiString[jdkResult.length];
        for (int i = 0; i < jdkResult.length; i++) {
            res[i] = new io.netty.util.AsciiString(jdkResult[i]);
        }
        return res;
    }
    ...
    public static boolean regionMatches(final CharSequence cs, final boolean ignoreCase, final int csStart,
        ...
        if (cs instanceof io.netty.util.AsciiString) {
            return ((io.netty.util.AsciiString) cs).regionMatches(ignoreCase, csStart, string, start, length);
        }
    ...
    public static int indexOf(final CharSequence cs, final char searchChar, int start) {
        ...
        } else if (cs instanceof io.netty.util.AsciiString) {
            return ((io.netty.util.AsciiString) cs).indexOf(searchChar, start);
        }
        if (cs == null) {
            return INDEX_NOT_FOUND;
        }

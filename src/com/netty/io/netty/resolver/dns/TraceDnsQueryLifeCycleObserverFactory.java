...
final class TraceDnsQueryLifeCycleObserverFactory implements DnsQueryLifecycleObserverFactory {
    private static final InternalLogger DEFAULT_LOGGER =
            InternalLoggerFactory.getInstance(io.netty.resolver.dns.TraceDnsQueryLifeCycleObserverFactory.class);
    ...
    public DnsQueryLifecycleObserver newDnsQueryLifecycleObserver(DnsQuestion question) {
        return new io.netty.resolver.dns.TraceDnsQueryLifecycleObserver(question, logger, level);
    }
}

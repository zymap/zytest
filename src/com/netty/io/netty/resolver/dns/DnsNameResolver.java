...
public class DnsNameResolver extends InetNameResolver {
    ...
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.resolver.dns.DnsNameResolver.class);
     ...
     */
    final io.netty.resolver.dns.DnsQueryContextManager queryContextManager = new io.netty.resolver.dns.DnsQueryContextManager();
    ...
    static final class SingleResolverContext extends DnsNameResolverContext<InetAddress> {
        SingleResolverContext(io.netty.resolver.dns.DnsNameResolver parent, String hostname,
        ...
        @Override
        DnsNameResolverContext<InetAddress> newResolverContext(io.netty.resolver.dns.DnsNameResolver parent, String hostname,
    ...
    static final class ListResolverContext extends DnsNameResolverContext<List<InetAddress>> {
        ListResolverContext(io.netty.resolver.dns.DnsNameResolver parent, String hostname,
                            DnsRecord[] additionals, DnsCache resolveCache, DnsServerAddressStream nameServerAddrs) {
            super(parent, hostname, additionals, resolveCache, nameServerAddrs);
        }
        ...
        DnsNameResolverContext<List<InetAddress>> newResolverContext(
                io.netty.resolver.dns.DnsNameResolver parent, String hostname, DnsRecord[] additionals, DnsCache resolveCache,
                DnsServerAddressStream nameServerAddrs) {
     ...
     * {@link io.netty.resolver.dns.DnsNameResolver}.
     */

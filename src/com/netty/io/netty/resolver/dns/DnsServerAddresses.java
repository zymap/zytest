...
public abstract class DnsServerAddresses {
    /**
     * @deprecated Use {@link io.netty.resolver.dns.DefaultDnsServerAddressStreamProvider#defaultAddressList()}.
     * <p>
    ...
    public static List<InetSocketAddress> defaultAddressList() {
        return io.netty.resolver.dns.DefaultDnsServerAddressStreamProvider.defaultAddressList();
    }

    /**
     * @deprecated Use {@link io.netty.resolver.dns.DefaultDnsServerAddressStreamProvider#defaultAddresses()}.
     * <p>
     * Returns the {@link io.netty.resolver.dns.DnsServerAddresses} that yields the system DNS server addresses sequentially. If it failed to
    ...
    /**
     * Returns the {@link io.netty.resolver.dns.DnsServerAddresses} that yields the specified {@code addresses} sequentially. Once the
     * last address is yielded, it will start again from the first address.
     */
    public static io.netty.resolver.dns.DnsServerAddresses sequential(Iterable<? extends InetSocketAddress> addresses) {
     ...
     * last address is yielded, it will start again from the first address.
     */
    public static io.netty.resolver.dns.DnsServerAddresses sequential(InetSocketAddress... addresses) {
        return sequential0(sanitize(addresses));
    }

    private static io.netty.resolver.dns.DnsServerAddresses sequential0(final InetSocketAddress... addresses) {
    ...
    /**
     * Returns the {@link io.netty.resolver.dns.DnsServerAddresses} that yields the specified {@code address} in a shuffled order. Once all
     * addresses are yielded, the addresses are shuffled again.
     */
    public static io.netty.resolver.dns.DnsServerAddresses shuffled(Iterable<? extends InetSocketAddress> addresses) {
        return shuffled0(sanitize(addresses));
    }

    /**
     * Returns the {@link io.netty.resolver.dns.DnsServerAddresses} that yields the specified {@code addresses} in a shuffled order. Once all
     * addresses are yielded, the addresses are shuffled again.
     */
    public static io.netty.resolver.dns.DnsServerAddresses shuffled(InetSocketAddress... addresses) {
        return shuffled0(sanitize(addresses));
    }

    private static io.netty.resolver.dns.DnsServerAddresses shuffled0(final InetSocketAddress[] addresses) {
        if (addresses.length == 1) {
            return singleton(addresses[0]);
        }
    ...
    /**
     * Returns the {@link io.netty.resolver.dns.DnsServerAddresses} that yields the specified {@code addresses} in a rotational sequential
     ...
     */
    public static io.netty.resolver.dns.DnsServerAddresses rotational(Iterable<? extends InetSocketAddress> addresses) {
     ...
     * second one will start from the second address, and so on.
     */
    public static io.netty.resolver.dns.DnsServerAddresses rotational(InetSocketAddress... addresses) {
        return rotational0(sanitize(addresses));
    }

    private static io.netty.resolver.dns.DnsServerAddresses rotational0(final InetSocketAddress[] addresses) {
        if (addresses.length == 1) {
            return singleton(addresses[0]);
        }
    ...
    /**
     * Returns the {@link io.netty.resolver.dns.DnsServerAddresses} that yields only a single {@code address}.
     */
    public static io.netty.resolver.dns.DnsServerAddresses singleton(final InetSocketAddress address) {
        if (address == null) {
        ...
        return new io.netty.resolver.dns.SingletonDnsServerAddresses(address);
    }

...
abstract class DnsNameResolverContext<T> {
    ...
    private void doSearchDomainQuery(String hostname, FutureListener<T> listener) {
        io.netty.resolver.dns.DnsNameResolverContext<T> nextContext = newResolverContext(parent, hostname, additionals, resolveCache,
                nameServerAddrs);
            ...
            public void operationComplete(Future<AddressedEnvelope<DnsResponse, InetSocketAddress>> future) {
                ...
                try {
                    ...
                    tryToFinishResolve(nameServerAddrStream, nameServerAddrStreamIndex, question,
                                       ...
                                       io.netty.resolver.dns.NoopDnsQueryLifecycleObserver.INSTANCE,
                                       promise, queryCause);
                }
            }
        });
    ...
    void tryToFinishResolve(final DnsServerAddressStream nameServerAddrStream,
        ...
        if (resolvedEntries == null) {
            if (nameServerAddrStreamIndex < nameServerAddrStream.size()) {
                if (queryLifecycleObserver == io.netty.resolver.dns.NoopDnsQueryLifecycleObserver.INSTANCE) {
    ...
    abstract io.netty.resolver.dns.DnsNameResolverContext<T> newResolverContext(DnsNameResolver parent, String hostname,

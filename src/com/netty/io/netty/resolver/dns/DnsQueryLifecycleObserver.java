 ...
 * return an object of type {@link io.netty.resolver.dns.DnsQueryLifecycleObserver}. Implementations may use this to build a query tree to
...
public interface DnsQueryLifecycleObserver {
     ...
     */
    io.netty.resolver.dns.DnsQueryLifecycleObserver queryRedirected(List<InetSocketAddress> nameServers);
     ...
     * @return An observer for the new query which we may issue.
     */
    io.netty.resolver.dns.DnsQueryLifecycleObserver queryCNAMEd(DnsQuestion cnameQuestion);
     ...
     * @return An observer for the new query which we may issue.
     */
    io.netty.resolver.dns.DnsQueryLifecycleObserver queryNoAnswer(DnsResponseCode code);

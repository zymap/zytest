...
/**
 * Provides an opportunity to override which {@link io.netty.resolver.dns.DnsServerAddressStream} is used to resolve a specific hostname.
 * <p>
...
public interface DnsServerAddressStreamProvider {
     ...
     *                 If this is the final {@link io.netty.resolver.dns.DnsServerAddressStreamProvider} to be queried then generally empty
     *                 string or {@code '.'} correspond to the default {@link io.netty.resolver.dns.DnsServerAddressStream}.
     * @return The {@link io.netty.resolver.dns.DnsServerAddressStream} which should be used to resolve {@code hostname}.
     */

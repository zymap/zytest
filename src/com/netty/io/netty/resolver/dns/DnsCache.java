...
public interface DnsCache {
     ...
     */
    List<? extends io.netty.resolver.dns.DnsCacheEntry> get(String hostname, DnsRecord[] additionals);

    /**
     * Create a new {@link io.netty.resolver.dns.DnsCacheEntry} and cache a resolved address for a given hostname.
     * @param hostname the hostname
     * @param additionals the additional records
     ...
     * @return The {@link io.netty.resolver.dns.DnsCacheEntry} corresponding to this cache entry.
     */
    io.netty.resolver.dns.DnsCacheEntry cache(String hostname, DnsRecord[] additionals, InetAddress address, long originalTtl,
                                              EventLoop loop);
     ...
     * @param loop the {@link EventLoop} used to register the TTL timeout
     * @return The {@link io.netty.resolver.dns.DnsCacheEntry} corresponding to this cache entry, or {@code null} if this cache doesn't

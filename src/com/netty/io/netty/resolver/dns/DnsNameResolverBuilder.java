...
public final class DnsNameResolverBuilder {
     ...
     * @return {@code this}
     */
    public io.netty.resolver.dns.DnsNameResolverBuilder channelFactory(ChannelFactory<? extends DatagramChannel> channelFactory) {
     ...
     * @return {@code this}
     */
    public io.netty.resolver.dns.DnsNameResolverBuilder channelType(Class<? extends DatagramChannel> channelType) {
     ...
     * @return {@code this}
     */
    public io.netty.resolver.dns.DnsNameResolverBuilder resolveCache(DnsCache resolveCache) {
     ...
     * @return {@code this}
     */
    public io.netty.resolver.dns.DnsNameResolverBuilder dnsQueryLifecycleObserverFactory(DnsQueryLifecycleObserverFactory
     ...
     * @return {@code this}
     */
    public io.netty.resolver.dns.DnsNameResolverBuilder authoritativeDnsServerCache(DnsCache authoritativeDnsServerCache) {
     ...
     * @return {@code this}
     */
    public io.netty.resolver.dns.DnsNameResolverBuilder ttl(int minTtl, int maxTtl) {
        this.maxTtl = maxTtl;
        this.minTtl = minTtl;
        return this;
    }
     ...
     * @return {@code this}
     */
    public io.netty.resolver.dns.DnsNameResolverBuilder negativeTtl(int negativeTtl) {
     ...
     * @return {@code this}
     */
    public io.netty.resolver.dns.DnsNameResolverBuilder queryTimeoutMillis(long queryTimeoutMillis) {
     ...
     * You can use {@link io.netty.resolver.dns.DnsNameResolverBuilder#computeResolvedAddressTypes(InternetProtocolFamily...)}
     * to get a {@link ResolvedAddressTypes} out of some {@link InternetProtocolFamily}s.
     *
     * @param resolvedAddressTypes the address types
     * @return {@code this}
     */
    public io.netty.resolver.dns.DnsNameResolverBuilder resolvedAddressTypes(ResolvedAddressTypes resolvedAddressTypes) {
     ...
     * @return {@code this}
     */
    public io.netty.resolver.dns.DnsNameResolverBuilder recursionDesired(boolean recursionDesired) {
     ...
     * @return {@code this}
     */
    public io.netty.resolver.dns.DnsNameResolverBuilder maxQueriesPerResolve(int maxQueriesPerResolve) {
     ...
     * @return {@code this}
     */
    public io.netty.resolver.dns.DnsNameResolverBuilder traceEnabled(boolean traceEnabled) {
     ...
     * @return {@code this}
     */
    public io.netty.resolver.dns.DnsNameResolverBuilder maxPayloadSize(int maxPayloadSize) {
     ...
     * @return {@code this}
     */
    public io.netty.resolver.dns.DnsNameResolverBuilder optResourceEnabled(boolean optResourceEnabled) {
     ...
     * @return {@code this}
     */
    public io.netty.resolver.dns.DnsNameResolverBuilder hostsFileEntriesResolver(HostsFileEntriesResolver hostsFileEntriesResolver) {
     ...
     * @return {@code this}.
     */
    public io.netty.resolver.dns.DnsNameResolverBuilder nameServerProvider(DnsServerAddressStreamProvider dnsServerAddressStreamProvider) {
     ...
     * @return {@code this}
     */
    public io.netty.resolver.dns.DnsNameResolverBuilder searchDomains(Iterable<String> searchDomains) {
   ...
   * @return {@code this}
   */
    public io.netty.resolver.dns.DnsNameResolverBuilder ndots(int ndots) {
        this.ndots = ndots;
        return this;
    }
     ...
     * @return {@code this}
     */
    public io.netty.resolver.dns.DnsNameResolverBuilder decodeIdn(boolean decodeIdn) {

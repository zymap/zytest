...
final class AdvancedLeakAwareByteBuf extends io.netty.buffer.SimpleLeakAwareByteBuf {

    private static final String PROP_ACQUIRE_AND_RELEASE_ONLY = "io.netty.leakDetection.acquireAndReleaseOnly";
    private static final boolean ACQUIRE_AND_RELEASE_ONLY;

    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.buffer.AdvancedLeakAwareByteBuf.class);
    ...
    static {
        ...
        ResourceLeakDetector.addExclusions(
                io.netty.buffer.AdvancedLeakAwareByteBuf.class, "touch", "recordLeakNonRefCountingOperation");
    }
    ...
    @Override
    protected io.netty.buffer.AdvancedLeakAwareByteBuf newLeakAwareByteBuf(
            ByteBuf buf, ByteBuf trackedByteBuf, ResourceLeakTracker<ByteBuf> leakTracker) {
        return new io.netty.buffer.AdvancedLeakAwareByteBuf(buf, trackedByteBuf, leakTracker);
    }
}

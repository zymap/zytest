...
public class PooledByteBufAllocator extends AbstractByteBufAllocator implements ByteBufAllocatorMetricProvider {
    ...
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.buffer.PooledByteBufAllocator.class);
    ...
    public static final io.netty.buffer.PooledByteBufAllocator DEFAULT =
            new io.netty.buffer.PooledByteBufAllocator(PlatformDependent.directBufferPreferred());
    ...
    /**
     * @deprecated use
     * {@link io.netty.buffer.PooledByteBufAllocator#PooledByteBufAllocator(boolean, int, int, int, int, int, int, int, boolean)}
     */
    @Deprecated
    ...
    protected ByteBuf newHeapBuffer(int initialCapacity, int maxCapacity) {
        io.netty.buffer.PoolThreadCache cache = threadCache.get();
        ...
        if (heapArena != null) {
            ...
            buf = PlatformDependent.hasUnsafe() ?
                    new io.netty.buffer.UnpooledUnsafeHeapByteBuf(this, initialCapacity, maxCapacity) :
    ...
    final class PoolThreadLocalCache extends FastThreadLocal<io.netty.buffer.PoolThreadCache> {
        ...
        protected synchronized io.netty.buffer.PoolThreadCache initialValue() {
            ...
            if (useCacheForAllThreads || current instanceof FastThreadLocalThread) {
                return new io.netty.buffer.PoolThreadCache(
                        heapArena, directArena, tinyCacheSize, smallCacheSize, normalCacheSize,
                        DEFAULT_MAX_CACHED_BUFFER_CAPACITY, DEFAULT_CACHE_TRIM_INTERVAL);
            }
            // No caching so just use 0 as sizes.
            return new io.netty.buffer.PoolThreadCache(heapArena, directArena, 0, 0, 0, 0, 0);
        }

        @Override
        protected void onRemoval(io.netty.buffer.PoolThreadCache threadCache) {
            threadCache.free();
        }
    ...
    /**
     * Return the number of thread local caches used by this {@link io.netty.buffer.PooledByteBufAllocator}.
     *

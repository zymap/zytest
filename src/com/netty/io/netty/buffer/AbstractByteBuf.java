...
public abstract class AbstractByteBuf extends ByteBuf {
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.buffer.AbstractByteBuf.class);
    ...
    public ByteBuf duplicate() {
        return new io.netty.buffer.UnpooledDuplicatedByteBuf(this);
    }

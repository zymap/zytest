...
public final class ByteBufUtil {
    ...
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.buffer.ByteBufUtil.class);
    ...
    public static int reserveAndWriteUtf8(ByteBuf buf, CharSequence seq, int reserveBytes) {
        for (;;) {
            if (buf instanceof AbstractByteBuf) {
                ...
                return written;
            } else if (buf instanceof io.netty.buffer.WrappedByteBuf) {

...
final class PooledDuplicatedByteBuf extends io.netty.buffer.AbstractPooledDerivedByteBuf {

    private static final Recycler<io.netty.buffer.PooledDuplicatedByteBuf> RECYCLER = new Recycler<io.netty.buffer.PooledDuplicatedByteBuf>() {
        @Override
        protected io.netty.buffer.PooledDuplicatedByteBuf newObject(Handle<io.netty.buffer.PooledDuplicatedByteBuf> handle) {
            return new io.netty.buffer.PooledDuplicatedByteBuf(handle);
        }
    };

    static io.netty.buffer.PooledDuplicatedByteBuf newInstance(AbstractByteBuf unwrapped, ByteBuf wrapped,
                                                               int readerIndex, int writerIndex) {
        final io.netty.buffer.PooledDuplicatedByteBuf duplicate = RECYCLER.get();
    ...
    private PooledDuplicatedByteBuf(Handle<io.netty.buffer.PooledDuplicatedByteBuf> handle) {
        super(handle);
    }
    ...
    public ByteBuf retainedSlice(int index, int length) {
        return io.netty.buffer.PooledSlicedByteBuf.newInstance(unwrap(), this, index, length);
    }
    ...
    public ByteBuf retainedDuplicate() {
        return io.netty.buffer.PooledDuplicatedByteBuf.newInstance(unwrap(), this, readerIndex(), writerIndex());
    }

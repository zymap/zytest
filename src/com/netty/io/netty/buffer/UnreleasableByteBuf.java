 ...
 */
final class UnreleasableByteBuf extends io.netty.buffer.WrappedByteBuf {

    private SwappedByteBuf swappedBuf;

    UnreleasableByteBuf(ByteBuf buf) {
        super(buf instanceof io.netty.buffer.UnreleasableByteBuf ? buf.unwrap() : buf);
    }
    ...
    public ByteBuf asReadOnly() {
        return buf.isReadOnly() ? this : new io.netty.buffer.UnreleasableByteBuf(buf.asReadOnly());
    }

    @Override
    public ByteBuf readSlice(int length) {
        return new io.netty.buffer.UnreleasableByteBuf(buf.readSlice(length));
    }
    ...
    public ByteBuf slice() {
        return new io.netty.buffer.UnreleasableByteBuf(buf.slice());
    }
    ...
    public ByteBuf slice(int index, int length) {
        return new io.netty.buffer.UnreleasableByteBuf(buf.slice(index, length));
    }
    ...
    public ByteBuf duplicate() {
        return new io.netty.buffer.UnreleasableByteBuf(buf.duplicate());
    }

...
/**
 * Default implementation of a {@link io.netty.buffer.ByteBufHolder} that holds it's data in a {@link ByteBuf}.
 *
 */
public class DefaultByteBufHolder implements io.netty.buffer.ByteBufHolder {
     ...
     */
    @Override
    public io.netty.buffer.ByteBufHolder replace(ByteBuf content) {
        return new io.netty.buffer.DefaultByteBufHolder(content);
    }
    ...
    @Override
    public io.netty.buffer.ByteBufHolder touch(Object hint) {
        data.touch(hint);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof io.netty.buffer.ByteBufHolder) {

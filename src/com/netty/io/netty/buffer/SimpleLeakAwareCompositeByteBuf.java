...
class SimpleLeakAwareCompositeByteBuf extends io.netty.buffer.WrappedCompositeByteBuf {
    ...
    private io.netty.buffer.SimpleLeakAwareByteBuf newLeakAwareByteBuf(ByteBuf wrapped) {
    ...
    protected io.netty.buffer.SimpleLeakAwareByteBuf newLeakAwareByteBuf(
        ...
        return new io.netty.buffer.SimpleLeakAwareByteBuf(wrapped, trackedByteBuf, leakTracker);
    }
}

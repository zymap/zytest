...
final class PooledUnsafeHeapByteBuf extends PooledHeapByteBuf {
    ...
    private static final Recycler<io.netty.buffer.PooledUnsafeHeapByteBuf> RECYCLER = new Recycler<io.netty.buffer.PooledUnsafeHeapByteBuf>() {
        @Override
        protected io.netty.buffer.PooledUnsafeHeapByteBuf newObject(Handle<io.netty.buffer.PooledUnsafeHeapByteBuf> handle) {
            return new io.netty.buffer.PooledUnsafeHeapByteBuf(handle, 0);
        }
    };

    static io.netty.buffer.PooledUnsafeHeapByteBuf newUnsafeInstance(int maxCapacity) {
        io.netty.buffer.PooledUnsafeHeapByteBuf buf = RECYCLER.get();
        buf.reuse(maxCapacity);
        return buf;
    }

    private PooledUnsafeHeapByteBuf(Handle<io.netty.buffer.PooledUnsafeHeapByteBuf> recyclerHandle, int maxCapacity) {

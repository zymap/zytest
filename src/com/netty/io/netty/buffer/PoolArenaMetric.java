...
public interface PoolArenaMetric {
    ...
    /**
     * Returns an unmodifiable {@link List} which holds {@link io.netty.buffer.PoolSubpageMetric}s for tiny sub-pages.
     */
    List<io.netty.buffer.PoolSubpageMetric> tinySubpages();

    /**
     * Returns an unmodifiable {@link List} which holds {@link io.netty.buffer.PoolSubpageMetric}s for small sub-pages.
     */

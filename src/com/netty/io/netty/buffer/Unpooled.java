...
public final class Unpooled {
        ...
        if (!buffer.isDirect() && buffer.hasArray()) {
            ...
            if (buffer.isReadOnly()) {
                if (buffer.isDirect()) {
                    ...
                    return new io.netty.buffer.ReadOnlyByteBufferBuf(ALLOC, buffer);
                }
            } else {
    ...
    public static ByteBuf unreleasableBuffer(ByteBuf buf) {
        return new io.netty.buffer.UnreleasableByteBuf(buf);
    }
    ...
    public static ByteBuf unmodifiableBuffer(ByteBuf... buffers) {
        return new io.netty.buffer.FixedCompositeByteBuf(ALLOC, buffers);
    }

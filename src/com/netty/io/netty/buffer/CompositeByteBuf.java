...
public class CompositeByteBuf extends AbstractReferenceCountedByteBuf implements Iterable<ByteBuf> {
     ...
     * <p>
     * {@link ByteBuf#release()} ownership of {@code buffer} is transfered to this {@link io.netty.buffer.CompositeByteBuf}.
     ...
     */
    public io.netty.buffer.CompositeByteBuf addComponent(ByteBuf buffer) {
     ...
     * ownership of all {@link ByteBuf} objects is transfered to this {@link io.netty.buffer.CompositeByteBuf}.
     */
    public io.netty.buffer.CompositeByteBuf addComponents(ByteBuf... buffers) {
     ...
     * ownership of all {@link ByteBuf} objects is transfered to this {@link io.netty.buffer.CompositeByteBuf}.
     */
    public io.netty.buffer.CompositeByteBuf addComponents(Iterable<ByteBuf> buffers) {
        return addComponents(false, buffers);
    }
     ...
     * {@link io.netty.buffer.CompositeByteBuf}.
     */
    public io.netty.buffer.CompositeByteBuf addComponent(int cIndex, ByteBuf buffer) {
     ...
     * {@link io.netty.buffer.CompositeByteBuf}.
     */
    public io.netty.buffer.CompositeByteBuf addComponent(boolean increaseWriterIndex, ByteBuf buffer) {
     ...
     * ownership of all {@link ByteBuf} objects is transfered to this {@link io.netty.buffer.CompositeByteBuf}.
     */
    public io.netty.buffer.CompositeByteBuf addComponents(boolean increaseWriterIndex, ByteBuf... buffers) {
     ...
     * ownership of all {@link ByteBuf} objects is transfered to this {@link io.netty.buffer.CompositeByteBuf}.
     */
    public io.netty.buffer.CompositeByteBuf addComponents(boolean increaseWriterIndex, Iterable<ByteBuf> buffers) {
     ...
     * {@link io.netty.buffer.CompositeByteBuf}.
     */
    public io.netty.buffer.CompositeByteBuf addComponent(boolean increaseWriterIndex, int cIndex, ByteBuf buffer) {
        checkNotNull(buffer, "buffer");
     ...
     * ownership of all {@link ByteBuf} objects is transfered to this {@link io.netty.buffer.CompositeByteBuf}.
     */
    public io.netty.buffer.CompositeByteBuf addComponents(int cIndex, ByteBuf... buffers) {
     ...
     * {@link io.netty.buffer.CompositeByteBuf}.
     */
    public io.netty.buffer.CompositeByteBuf addComponents(int cIndex, Iterable<ByteBuf> buffers) {
     ...
     */
    public io.netty.buffer.CompositeByteBuf removeComponent(int cIndex) {
        checkComponentIndex(cIndex);
     ...
     */
    public io.netty.buffer.CompositeByteBuf removeComponents(int cIndex, int numComponents) {
    ...
    @Override
    public io.netty.buffer.CompositeByteBuf capacity(int newCapacity) {
    ...
    @Override
    public io.netty.buffer.CompositeByteBuf getBytes(int index, byte[] dst, int dstIndex, int length) {
    ...
    @Override
    public io.netty.buffer.CompositeByteBuf getBytes(int index, ByteBuffer dst) {
        int limit = dst.limit();
    ...
    @Override
    public io.netty.buffer.CompositeByteBuf getBytes(int index, ByteBuf dst, int dstIndex, int length) {
    ...
    @Override
    public io.netty.buffer.CompositeByteBuf getBytes(int index, OutputStream out, int length) throws IOException {
        checkIndex(index, length);
        if (length == 0) {
            return this;
        }
    ...
    @Override
    public io.netty.buffer.CompositeByteBuf setByte(int index, int value) {
        Component c = findComponent(index);
    ...
    @Override
    public io.netty.buffer.CompositeByteBuf setShort(int index, int value) {
        return (io.netty.buffer.CompositeByteBuf) super.setShort(index, value);
    }
    ...
    @Override
    public io.netty.buffer.CompositeByteBuf setMedium(int index, int value) {
        return (io.netty.buffer.CompositeByteBuf) super.setMedium(index, value);
    }
    ...
    @Override
    public io.netty.buffer.CompositeByteBuf setInt(int index, int value) {
        return (io.netty.buffer.CompositeByteBuf) super.setInt(index, value);
    }
    ...
    @Override
    public io.netty.buffer.CompositeByteBuf setLong(int index, long value) {
        return (io.netty.buffer.CompositeByteBuf) super.setLong(index, value);
    }
    ...
    @Override
    public io.netty.buffer.CompositeByteBuf setBytes(int index, byte[] src, int srcIndex, int length) {
    ...
    @Override
    public io.netty.buffer.CompositeByteBuf setBytes(int index, ByteBuffer src) {
        int limit = src.limit();
    ...
    @Override
    public io.netty.buffer.CompositeByteBuf setBytes(int index, ByteBuf src, int srcIndex, int length) {
     ...
     */
    public io.netty.buffer.CompositeByteBuf consolidate(int cIndex, int numComponents) {
        checkComponentIndex(cIndex, numComponents);
        if (numComponents <= 1) {
            return this;
        }
    ...
    @Override
    public io.netty.buffer.CompositeByteBuf readerIndex(int readerIndex) {
        return (io.netty.buffer.CompositeByteBuf) super.readerIndex(readerIndex);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf writerIndex(int writerIndex) {
        return (io.netty.buffer.CompositeByteBuf) super.writerIndex(writerIndex);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf setIndex(int readerIndex, int writerIndex) {
        return (io.netty.buffer.CompositeByteBuf) super.setIndex(readerIndex, writerIndex);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf clear() {
        return (io.netty.buffer.CompositeByteBuf) super.clear();
    }

    @Override
    public io.netty.buffer.CompositeByteBuf markReaderIndex() {
        return (io.netty.buffer.CompositeByteBuf) super.markReaderIndex();
    }

    @Override
    public io.netty.buffer.CompositeByteBuf resetReaderIndex() {
        return (io.netty.buffer.CompositeByteBuf) super.resetReaderIndex();
    }

    @Override
    public io.netty.buffer.CompositeByteBuf markWriterIndex() {
        return (io.netty.buffer.CompositeByteBuf) super.markWriterIndex();
    }

    @Override
    public io.netty.buffer.CompositeByteBuf resetWriterIndex() {
        return (io.netty.buffer.CompositeByteBuf) super.resetWriterIndex();
    }

    @Override
    public io.netty.buffer.CompositeByteBuf ensureWritable(int minWritableBytes) {
        return (io.netty.buffer.CompositeByteBuf) super.ensureWritable(minWritableBytes);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf getBytes(int index, ByteBuf dst) {
        return (io.netty.buffer.CompositeByteBuf) super.getBytes(index, dst);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf getBytes(int index, ByteBuf dst, int length) {
        return (io.netty.buffer.CompositeByteBuf) super.getBytes(index, dst, length);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf getBytes(int index, byte[] dst) {
        return (io.netty.buffer.CompositeByteBuf) super.getBytes(index, dst);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf setBoolean(int index, boolean value) {
        return (io.netty.buffer.CompositeByteBuf) super.setBoolean(index, value);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf setChar(int index, int value) {
        return (io.netty.buffer.CompositeByteBuf) super.setChar(index, value);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf setFloat(int index, float value) {
        return (io.netty.buffer.CompositeByteBuf) super.setFloat(index, value);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf setDouble(int index, double value) {
        return (io.netty.buffer.CompositeByteBuf) super.setDouble(index, value);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf setBytes(int index, ByteBuf src) {
        return (io.netty.buffer.CompositeByteBuf) super.setBytes(index, src);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf setBytes(int index, ByteBuf src, int length) {
        return (io.netty.buffer.CompositeByteBuf) super.setBytes(index, src, length);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf setBytes(int index, byte[] src) {
        return (io.netty.buffer.CompositeByteBuf) super.setBytes(index, src);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf setZero(int index, int length) {
        return (io.netty.buffer.CompositeByteBuf) super.setZero(index, length);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf readBytes(ByteBuf dst) {
        return (io.netty.buffer.CompositeByteBuf) super.readBytes(dst);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf readBytes(ByteBuf dst, int length) {
        return (io.netty.buffer.CompositeByteBuf) super.readBytes(dst, length);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf readBytes(ByteBuf dst, int dstIndex, int length) {
        return (io.netty.buffer.CompositeByteBuf) super.readBytes(dst, dstIndex, length);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf readBytes(byte[] dst) {
        return (io.netty.buffer.CompositeByteBuf) super.readBytes(dst);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf readBytes(byte[] dst, int dstIndex, int length) {
        return (io.netty.buffer.CompositeByteBuf) super.readBytes(dst, dstIndex, length);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf readBytes(ByteBuffer dst) {
        return (io.netty.buffer.CompositeByteBuf) super.readBytes(dst);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf readBytes(OutputStream out, int length) throws IOException {
        return (io.netty.buffer.CompositeByteBuf) super.readBytes(out, length);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf skipBytes(int length) {
        return (io.netty.buffer.CompositeByteBuf) super.skipBytes(length);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf writeBoolean(boolean value) {
        return (io.netty.buffer.CompositeByteBuf) super.writeBoolean(value);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf writeByte(int value) {
        return (io.netty.buffer.CompositeByteBuf) super.writeByte(value);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf writeShort(int value) {
        return (io.netty.buffer.CompositeByteBuf) super.writeShort(value);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf writeMedium(int value) {
        return (io.netty.buffer.CompositeByteBuf) super.writeMedium(value);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf writeInt(int value) {
        return (io.netty.buffer.CompositeByteBuf) super.writeInt(value);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf writeLong(long value) {
        return (io.netty.buffer.CompositeByteBuf) super.writeLong(value);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf writeChar(int value) {
        return (io.netty.buffer.CompositeByteBuf) super.writeChar(value);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf writeFloat(float value) {
        return (io.netty.buffer.CompositeByteBuf) super.writeFloat(value);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf writeDouble(double value) {
        return (io.netty.buffer.CompositeByteBuf) super.writeDouble(value);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf writeBytes(ByteBuf src) {
        return (io.netty.buffer.CompositeByteBuf) super.writeBytes(src);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf writeBytes(ByteBuf src, int length) {
        return (io.netty.buffer.CompositeByteBuf) super.writeBytes(src, length);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf writeBytes(ByteBuf src, int srcIndex, int length) {
        return (io.netty.buffer.CompositeByteBuf) super.writeBytes(src, srcIndex, length);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf writeBytes(byte[] src) {
        return (io.netty.buffer.CompositeByteBuf) super.writeBytes(src);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf writeBytes(byte[] src, int srcIndex, int length) {
        return (io.netty.buffer.CompositeByteBuf) super.writeBytes(src, srcIndex, length);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf writeBytes(ByteBuffer src) {
        return (io.netty.buffer.CompositeByteBuf) super.writeBytes(src);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf writeZero(int length) {
        return (io.netty.buffer.CompositeByteBuf) super.writeZero(length);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf retain(int increment) {
        return (io.netty.buffer.CompositeByteBuf) super.retain(increment);
    }

    @Override
    public io.netty.buffer.CompositeByteBuf retain() {
        return (io.netty.buffer.CompositeByteBuf) super.retain();
    }
    ...
    @Override
    public io.netty.buffer.CompositeByteBuf touch(Object hint) {
        return this;
    }

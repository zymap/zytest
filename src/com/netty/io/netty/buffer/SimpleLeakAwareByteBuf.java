...
class SimpleLeakAwareByteBuf extends io.netty.buffer.WrappedByteBuf {
    ...
    private io.netty.buffer.SimpleLeakAwareByteBuf newSharedLeakAwareByteBuf(
            ByteBuf wrapped) {
        return newLeakAwareByteBuf(wrapped, trackedByteBuf, leak);
    }

    private io.netty.buffer.SimpleLeakAwareByteBuf newLeakAwareByteBuf(
            ByteBuf wrapped, ResourceLeakTracker<ByteBuf> leakTracker) {
        return newLeakAwareByteBuf(wrapped, wrapped, leakTracker);
    }

    protected io.netty.buffer.SimpleLeakAwareByteBuf newLeakAwareByteBuf(
            ByteBuf buf, ByteBuf trackedByteBuf, ResourceLeakTracker<ByteBuf> leakTracker) {
        return new io.netty.buffer.SimpleLeakAwareByteBuf(buf, trackedByteBuf, leakTracker);
    }
}

...
abstract class AbstractUnpooledSlicedByteBuf extends AbstractDerivedByteBuf {
    ...
    AbstractUnpooledSlicedByteBuf(ByteBuf buffer, int index, int length) {
        ...
        if (buffer instanceof io.netty.buffer.AbstractUnpooledSlicedByteBuf) {
            this.buffer = ((io.netty.buffer.AbstractUnpooledSlicedByteBuf) buffer).buffer;
            adjustment = ((io.netty.buffer.AbstractUnpooledSlicedByteBuf) buffer).adjustment + index;

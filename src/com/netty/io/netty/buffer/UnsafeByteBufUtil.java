...
final class UnsafeByteBufUtil {
    ...
    static ByteBuf copy(io.netty.buffer.AbstractByteBuf buf, long addr, int index, int length) {
    ...
    static int setBytes(io.netty.buffer.AbstractByteBuf buf, long addr, int index, InputStream in, int length) throws IOException {
        buf.checkIndex(index, length);
    ...
    static void getBytes(io.netty.buffer.AbstractByteBuf buf, long addr, int index, ByteBuf dst, int dstIndex, int length) {
        buf.checkIndex(index, length);
    ...
    static void getBytes(io.netty.buffer.AbstractByteBuf buf, long addr, int index, byte[] dst, int dstIndex, int length) {
        buf.checkIndex(index, length);
        checkNotNull(dst, "dst");
    ...
    static void getBytes(io.netty.buffer.AbstractByteBuf buf, long addr, int index, ByteBuffer dst) {
    ...
    static void setBytes(io.netty.buffer.AbstractByteBuf buf, long addr, int index, ByteBuf src, int srcIndex, int length) {
        buf.checkIndex(index, length);
    ...
    static void setBytes(io.netty.buffer.AbstractByteBuf buf, long addr, int index, byte[] src, int srcIndex, int length) {
        buf.checkIndex(index, length);
        if (length != 0) {
    ...
    static void setBytes(io.netty.buffer.AbstractByteBuf buf, long addr, int index, ByteBuffer src) {
    ...
    static UnpooledUnsafeDirectByteBuf newUnsafeDirectByteBuf(
        ...
        if (PlatformDependent.useDirectBufferNoCleaner()) {
            return new io.netty.buffer.UnpooledUnsafeNoCleanerDirectByteBuf(alloc, initialCapacity, maxCapacity);
        }

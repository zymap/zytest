...
abstract class AbstractPooledDerivedByteBuf extends AbstractReferenceCountedByteBuf {
    ...
    private final Handle<io.netty.buffer.AbstractPooledDerivedByteBuf> recyclerHandle;
    ...
    AbstractPooledDerivedByteBuf(Handle<? extends io.netty.buffer.AbstractPooledDerivedByteBuf> recyclerHandle) {
        super(0);
        this.recyclerHandle = (Handle<io.netty.buffer.AbstractPooledDerivedByteBuf>) recyclerHandle;
    }

    // Called from within SimpleLeakAwareByteBuf and AdvancedLeakAwareByteBuf.
    final void parent(ByteBuf newParent) {
        assert newParent instanceof io.netty.buffer.SimpleLeakAwareByteBuf;
        parent = newParent;
    }
    ...
    final <U extends io.netty.buffer.AbstractPooledDerivedByteBuf> U init(
    ...
    private static final class PooledNonRetainedDuplicateByteBuf extends io.netty.buffer.UnpooledDuplicatedByteBuf {

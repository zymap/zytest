...
final class PooledDirectByteBuf extends io.netty.buffer.PooledByteBuf<ByteBuffer> {

    private static final Recycler<io.netty.buffer.PooledDirectByteBuf> RECYCLER = new Recycler<io.netty.buffer.PooledDirectByteBuf>() {
        @Override
        protected io.netty.buffer.PooledDirectByteBuf newObject(Handle<io.netty.buffer.PooledDirectByteBuf> handle) {
            return new io.netty.buffer.PooledDirectByteBuf(handle, 0);
        }
    };

    static io.netty.buffer.PooledDirectByteBuf newInstance(int maxCapacity) {
        io.netty.buffer.PooledDirectByteBuf buf = RECYCLER.get();
        buf.reuse(maxCapacity);
        return buf;
    }

    private PooledDirectByteBuf(Recycler.Handle<io.netty.buffer.PooledDirectByteBuf> recyclerHandle, int maxCapacity) {

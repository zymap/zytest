...
public interface AddressedEnvelope<M, A extends SocketAddress> extends ReferenceCounted {
    ...
    @Override
    io.netty.channel.AddressedEnvelope<M, A> retain();

    @Override
    io.netty.channel.AddressedEnvelope<M, A> retain(int increment);

    @Override
    io.netty.channel.AddressedEnvelope<M, A> touch();

    @Override
    io.netty.channel.AddressedEnvelope<M, A> touch(Object hint);
}

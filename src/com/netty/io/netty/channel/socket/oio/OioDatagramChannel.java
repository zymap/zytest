...
public class OioDatagramChannel extends AbstractOioMessageChannel
    ...
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.channel.socket.oio.OioDatagramChannel.class);
    ...
    public OioDatagramChannel(MulticastSocket socket) {
        ...
        this.socket = socket;
        config = new io.netty.channel.socket.oio.DefaultOioDatagramChannelConfig(this, socket);
    }

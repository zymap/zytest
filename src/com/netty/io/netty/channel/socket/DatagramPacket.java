...
public final class DatagramPacket
    ...
    @Override
    public io.netty.channel.socket.DatagramPacket replace(ByteBuf content) {
        return new io.netty.channel.socket.DatagramPacket(content, recipient(), sender());
    }
    ...
    @Override
    public io.netty.channel.socket.DatagramPacket retain(int increment) {
    ...
    @Override
    public io.netty.channel.socket.DatagramPacket touch(Object hint) {
        super.touch(hint);
        return this;
    }
}

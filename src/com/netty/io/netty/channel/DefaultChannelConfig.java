...
public class DefaultChannelConfig implements ChannelConfig {
    ...
    private static final AtomicIntegerFieldUpdater<io.netty.channel.DefaultChannelConfig> AUTOREAD_UPDATER =
            AtomicIntegerFieldUpdater.newUpdater(io.netty.channel.DefaultChannelConfig.class, "autoRead");
    private static final AtomicReferenceFieldUpdater<io.netty.channel.DefaultChannelConfig, WriteBufferWaterMark> WATERMARK_UPDATER =
            AtomicReferenceFieldUpdater.newUpdater(
                    io.netty.channel.DefaultChannelConfig.class, WriteBufferWaterMark.class, "writeBufferWaterMark");

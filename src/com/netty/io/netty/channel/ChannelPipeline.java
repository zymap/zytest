 ...
 * {@link Channel}.  {@link io.netty.channel.ChannelPipeline} implements an advanced form of the
 ...
 *
 * The following diagram describes how I/O events are processed by {@link ChannelHandler}s in a {@link io.netty.channel.ChannelPipeline}
 * typically. An I/O event is handled by either a {@link io.netty.channel.ChannelInboundHandler} or a {@link ChannelOutboundHandler}
 ...
 * <h3>Thread safety</h3>
 * <p>
 * A {@link ChannelHandler} can be added or removed at any time because a {@link io.netty.channel.ChannelPipeline} is thread safe.
...
public interface ChannelPipeline
     ...
     */
    io.netty.channel.ChannelPipeline addFirst(String name, ChannelHandler handler);
     ...
     *         if the specified handler is {@code null}
     */
    io.netty.channel.ChannelPipeline addFirst(EventExecutorGroup group, String name, ChannelHandler handler);
     ...
     *         if the specified handler is {@code null}
     */
    io.netty.channel.ChannelPipeline addLast(String name, ChannelHandler handler);
     ...
     *         if the specified handler is {@code null}
     */
    io.netty.channel.ChannelPipeline addLast(EventExecutorGroup group, String name, ChannelHandler handler);
     ...
     */
    io.netty.channel.ChannelPipeline addBefore(String baseName, String name, ChannelHandler handler);
     ...
     *         if the specified baseName or handler is {@code null}
     */
    io.netty.channel.ChannelPipeline addBefore(EventExecutorGroup group, String baseName, String name, ChannelHandler handler);
     ...
     *         if the specified baseName or handler is {@code null}
     */
    io.netty.channel.ChannelPipeline addAfter(String baseName, String name, ChannelHandler handler);
     ...
     *         if the specified baseName or handler is {@code null}
     */
    io.netty.channel.ChannelPipeline addAfter(EventExecutorGroup group, String baseName, String name, ChannelHandler handler);
     ...
     *
     */
    io.netty.channel.ChannelPipeline addFirst(ChannelHandler... handlers);
     ...
     *
     */
    io.netty.channel.ChannelPipeline addFirst(EventExecutorGroup group, ChannelHandler... handlers);
     ...
     *
     */
    io.netty.channel.ChannelPipeline addLast(ChannelHandler... handlers);
     ...
     *
     */
    io.netty.channel.ChannelPipeline addLast(EventExecutorGroup group, ChannelHandler... handlers);
     ...
     *         if the specified handler is {@code null}
     */
    io.netty.channel.ChannelPipeline remove(ChannelHandler handler);
     ...
     *         {@code null}
     */
    io.netty.channel.ChannelPipeline replace(ChannelHandler oldHandler, String newName, ChannelHandler newHandler);
    ...
    @Override
    io.netty.channel.ChannelPipeline fireChannelRegistered();
    ...
    @Override
    io.netty.channel.ChannelPipeline fireChannelInactive();

    @Override
    io.netty.channel.ChannelPipeline fireExceptionCaught(Throwable cause);

    @Override
    io.netty.channel.ChannelPipeline fireUserEventTriggered(Object event);

    @Override
    io.netty.channel.ChannelPipeline fireChannelRead(Object msg);

    @Override
    io.netty.channel.ChannelPipeline fireChannelReadComplete();

    @Override
    io.netty.channel.ChannelPipeline fireChannelWritabilityChanged();

    @Override
    io.netty.channel.ChannelPipeline flush();
}

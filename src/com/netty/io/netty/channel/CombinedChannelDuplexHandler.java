...
/**
 *  Combines a {@link io.netty.channel.ChannelInboundHandler} and a {@link ChannelOutboundHandler} into one {@link ChannelHandler}.
 */
public class CombinedChannelDuplexHandler<I extends io.netty.channel.ChannelInboundHandler, O extends ChannelOutboundHandler>
        extends ChannelDuplexHandler {

    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.channel.CombinedChannelDuplexHandler.class);
     ...
     * {@link #init(io.netty.channel.ChannelInboundHandler, ChannelOutboundHandler)} before adding this handler into a
    ...
    private void validate(I inboundHandler, O outboundHandler) {
        if (this.inboundHandler != null) {
            throw new IllegalStateException(
                    "init() can not be invoked if " + io.netty.channel.CombinedChannelDuplexHandler.class.getSimpleName() +
        ...
        if (outboundHandler instanceof io.netty.channel.ChannelInboundHandler) {
            throw new IllegalArgumentException(
                    "outboundHandler must not implement " +
                    io.netty.channel.ChannelInboundHandler.class.getSimpleName() + " to get combined.");
        }
    }
    ...
    /**
     * Removes the {@link ChannelInboundHandler} that was combined in this {@link io.netty.channel.CombinedChannelDuplexHandler}.
     */
    ...
    /**
     * Removes the {@link ChannelOutboundHandler} that was combined in this {@link io.netty.channel.CombinedChannelDuplexHandler}.
     */
        ...
        if (inboundHandler == null) {
            throw new IllegalStateException(
                    "init() must be invoked before being added to a " + ChannelPipeline.class.getSimpleName() +
                            " if " +  io.netty.channel.CombinedChannelDuplexHandler.class.getSimpleName() +

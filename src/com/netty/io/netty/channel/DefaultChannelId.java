...
/**
 * The default {@link io.netty.channel.ChannelId} implementation.
 */
public final class DefaultChannelId implements io.netty.channel.ChannelId {

    private static final long serialVersionUID = 3884076183504074063L;

    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.channel.DefaultChannelId.class);
    ...
    /**
     * Returns a new {@link io.netty.channel.DefaultChannelId} instance.
     */
    public static io.netty.channel.DefaultChannelId newInstance() {
        return new io.netty.channel.DefaultChannelId();
    }
    ...
    private static int defaultProcessId() {
        ...
        String value;
        try {
            loader = PlatformDependent.getClassLoader(io.netty.channel.DefaultChannelId.class);
    ...
    public int compareTo(final ChannelId o) {
        ...
        if (o instanceof io.netty.channel.DefaultChannelId) {
            // lexicographic comparison
            final byte[] otherData = ((io.netty.channel.DefaultChannelId) o).data;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof io.netty.channel.DefaultChannelId)) {
            return false;
        }
        io.netty.channel.DefaultChannelId other = (io.netty.channel.DefaultChannelId) obj;

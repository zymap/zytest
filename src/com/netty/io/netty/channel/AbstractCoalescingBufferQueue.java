...
public abstract class AbstractCoalescingBufferQueue {
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.channel.AbstractCoalescingBufferQueue.class);
     ...
     *
     * @param channel the {@link io.netty.channel.Channel} which will have the {@link io.netty.channel.Channel#isWritable()} reflect the amount of queued
    ...
    protected AbstractCoalescingBufferQueue(Channel channel, int initSize) {
        ...
        tracker = channel == null ? null : io.netty.channel.PendingBytesTracker.newTracker(channel);
    }
     ...
     */
    public final void copyTo(io.netty.channel.AbstractCoalescingBufferQueue dest) {

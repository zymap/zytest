...
public final class ChannelFlushPromiseNotifier {
     ...
     */
    @Deprecated
    public io.netty.channel.ChannelFlushPromiseNotifier add(ChannelPromise promise, int pendingDataSize) {
        return add(promise, (long) pendingDataSize);
    }

    /**
     * Add a {@link ChannelPromise} to this {@link io.netty.channel.ChannelFlushPromiseNotifier} which will be notified after the given
     * {@code pendingDataSize} was reached.
     */
    public io.netty.channel.ChannelFlushPromiseNotifier add(ChannelPromise promise, long pendingDataSize) {
        if (promise == null) {
     ...
     */
    public io.netty.channel.ChannelFlushPromiseNotifier increaseWriteCounter(long delta) {
        if (delta < 0) {
     ...
     *
     * After a {@link ChannelFuture} was notified it will be removed from this {@link io.netty.channel.ChannelFlushPromiseNotifier} and
     ...
     */
    public io.netty.channel.ChannelFlushPromiseNotifier notifyPromises(Throwable cause) {
        notifyPromises();
        for (;;) {
     ...
     */
    @Deprecated
    public io.netty.channel.ChannelFlushPromiseNotifier notifyFlushFutures(Throwable cause) {
     ...
     */
    public io.netty.channel.ChannelFlushPromiseNotifier notifyPromises(Throwable cause1, Throwable cause2) {
     ...
     */
    @Deprecated
    public io.netty.channel.ChannelFlushPromiseNotifier notifyFlushFutures(Throwable cause1, Throwable cause2) {

...
public interface ChannelHealthChecker {
    ...
    /**
     * {@link io.netty.channel.pool.ChannelHealthChecker} implementation that checks if {@link Channel#isActive()} returns {@code true}.
     */
    io.netty.channel.pool.ChannelHealthChecker ACTIVE = new io.netty.channel.pool.ChannelHealthChecker() {
        @Override

 ...
 * under the License.
 */
package com.netty.io.netty.channel.pool;
...
public class SimpleChannelPool implements ChannelPool {
    private static final AttributeKey<io.netty.channel.pool.SimpleChannelPool> POOL_KEY = AttributeKey.newInstance("channelPool");
     ...
     * @param handler           the {@link io.netty.channel.pool.ChannelPoolHandler} that will be notified for the different pool actions
     */
    public SimpleChannelPool(Bootstrap bootstrap, final io.netty.channel.pool.ChannelPoolHandler handler) {
     ...
     */
    public SimpleChannelPool(Bootstrap bootstrap, final io.netty.channel.pool.ChannelPoolHandler handler, ChannelHealthChecker healthCheck) {

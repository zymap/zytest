...
/**
 * {@link io.netty.channel.RecvByteBufAllocator} that limits a read operation based upon a maximum value per individual read
...
public interface MaxBytesRecvByteBufAllocator extends RecvByteBufAllocator {
     ...
     */
    io.netty.channel.MaxBytesRecvByteBufAllocator maxBytesPerReadPair(int maxBytesPerRead, int maxBytesPerIndividualRead);
}

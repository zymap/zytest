...
/**
 * Default {@link io.netty.channel.FileRegion} implementation which transfer data from a {@link FileChannel} or {@link File}.
 *
 * Be aware that the {@link FileChannel} will be automatically closed once {@link #refCnt()} returns
 * {@code 0}.
 */
public class DefaultFileRegion extends AbstractReferenceCounted implements io.netty.channel.FileRegion {

    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.channel.DefaultFileRegion.class);
    ...
    /**
     * Returns {@code true} if the {@link io.netty.channel.FileRegion} has a open file-descriptor
     */
    ...
    @Override
    public io.netty.channel.FileRegion retain(int increment) {

...
public class DefaultMaxBytesRecvByteBufAllocator implements MaxBytesRecvByteBufAllocator {
    ...
    @Override
    public io.netty.channel.DefaultMaxBytesRecvByteBufAllocator maxBytesPerRead(int maxBytesPerRead) {
    ...
    @Override
    public io.netty.channel.DefaultMaxBytesRecvByteBufAllocator maxBytesPerIndividualRead(int maxBytesPerIndividualRead) {
    ...
    @Override
    public io.netty.channel.DefaultMaxBytesRecvByteBufAllocator maxBytesPerReadPair(int maxBytesPerRead,

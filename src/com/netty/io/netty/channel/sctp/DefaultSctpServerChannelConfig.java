...
public class DefaultSctpServerChannelConfig extends DefaultChannelConfig implements SctpServerChannelConfig {
    ...
    public Map<ChannelOption<?>, Object> getOptions() {
        return getOptions(
                super.getOptions(),
                ChannelOption.SO_RCVBUF, ChannelOption.SO_SNDBUF, io.netty.channel.sctp.SctpChannelOption.SCTP_INIT_MAXSTREAMS);
    }
    ...
    public <T> T getOption(ChannelOption<T> option) {
        ...
        if (option == io.netty.channel.sctp.SctpChannelOption.SCTP_INIT_MAXSTREAMS) {

...
public class OioSctpChannel extends AbstractOioMessageChannel
    ...
    private static final InternalLogger logger =
            InternalLoggerFactory.getInstance(io.netty.channel.sctp.oio.OioSctpChannel.class);
    ...
    private final class OioSctpChannelConfig extends DefaultSctpChannelConfig {
        private OioSctpChannelConfig(io.netty.channel.sctp.oio.OioSctpChannel channel, SctpChannel javaChannel) {

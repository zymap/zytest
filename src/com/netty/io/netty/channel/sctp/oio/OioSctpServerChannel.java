 ...
 * under the License.
 */
package com.netty.io.netty.channel.sctp.oio;
...
import io.netty.channel.sctp.oio.*;
 ...
 * connections and create the {@link io.netty.channel.sctp.oio.OioSctpChannel} for them.
 *
...
public class OioSctpServerChannel extends AbstractOioMessageChannel
    ...
    private static final InternalLogger logger =
            InternalLoggerFactory.getInstance(io.netty.channel.sctp.oio.OioSctpServerChannel.class);
    ...
    private final class OioSctpServerChannelConfig extends DefaultSctpServerChannelConfig {
        private OioSctpServerChannelConfig(io.netty.channel.sctp.oio.OioSctpServerChannel channel, SctpServerChannel javaChannel) {

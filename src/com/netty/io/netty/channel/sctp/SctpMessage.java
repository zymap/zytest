...
public final class SctpMessage extends DefaultByteBufHolder {
    ...
    public boolean equals(Object o) {
        ...
        io.netty.channel.sctp.SctpMessage sctpFrame = (io.netty.channel.sctp.SctpMessage) o;
    ...
    public io.netty.channel.sctp.SctpMessage copy() {
        return (io.netty.channel.sctp.SctpMessage) super.copy();
    }

    @Override
    public io.netty.channel.sctp.SctpMessage duplicate() {
        return (io.netty.channel.sctp.SctpMessage) super.duplicate();
    }

    @Override
    public io.netty.channel.sctp.SctpMessage retainedDuplicate() {
        return (io.netty.channel.sctp.SctpMessage) super.retainedDuplicate();
    }

    @Override
    public io.netty.channel.sctp.SctpMessage replace(ByteBuf content) {
        if (msgInfo == null) {
            return new io.netty.channel.sctp.SctpMessage(protocolIdentifier, streamIdentifier, unordered, content);
        } else {
            return new io.netty.channel.sctp.SctpMessage(msgInfo, content);
        }
    }
    ...
    @Override
    public io.netty.channel.sctp.SctpMessage retain(int increment) {
    ...
    @Override
    public io.netty.channel.sctp.SctpMessage touch(Object hint) {
        super.touch(hint);
        return this;
    }

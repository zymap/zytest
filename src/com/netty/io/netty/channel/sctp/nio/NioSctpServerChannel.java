...
import io.netty.channel.sctp.nio.*;
 ...
 * connections and create the {@link io.netty.channel.sctp.nio.NioSctpChannel} for them.
 *
...
public class NioSctpServerChannel extends AbstractNioMessageChannel
    ...
    private final class NioSctpServerChannelConfig extends DefaultSctpServerChannelConfig {
        private NioSctpServerChannelConfig(io.netty.channel.sctp.nio.NioSctpServerChannel channel, SctpServerChannel javaChannel) {

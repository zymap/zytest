 ...
 * under the License.
 */
package com.netty.io.netty.channel.sctp.nio;
...
public class NioSctpChannel extends AbstractNioMessageChannel implements io.netty.channel.sctp.SctpChannel {
    ...
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.channel.sctp.nio.NioSctpChannel.class);
     ...
     * Create a new instance
     *
     * @param parent        the {@link Channel} which is the parent of this {@link io.netty.channel.sctp.nio.NioSctpChannel}
     *                      or {@code null}.
    ...
    private final class NioSctpChannelConfig extends DefaultSctpChannelConfig {
        private NioSctpChannelConfig(io.netty.channel.sctp.nio.NioSctpChannel channel, SctpChannel javaChannel) {

 ...
 */
public final class LocalAddress extends SocketAddress implements Comparable<io.netty.channel.local.LocalAddress> {
    ...
    public boolean equals(Object o) {
        ...
        return id.equals(((io.netty.channel.local.LocalAddress) o).id);
    }

    @Override
    public int compareTo(io.netty.channel.local.LocalAddress o) {

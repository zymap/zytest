 ...
 * {@link io.netty.channel.Channel#newProgressivePromise()} to create a new {@link ChannelProgressivePromise} rather than calling the
...
public class DefaultChannelProgressivePromise
     ...
     */
    public DefaultChannelProgressivePromise(io.netty.channel.Channel channel) {
     ...
     *        the {@link io.netty.channel.Channel} associated with this future
     */
    public DefaultChannelProgressivePromise(io.netty.channel.Channel channel, EventExecutor executor) {
        super(executor);
        this.channel = channel;
    }

...
public final class IovArray implements MessageProcessor {
    ...
    /**
     * Add a {@link ByteBuf} to this {@link io.netty.channel.unix.IovArray}.
     * @param buf The {@link ByteBuf} to add.
     * @return {@code true} if the entire {@link ByteBuf} has been added to this {@link io.netty.channel.unix.IovArray}. Note in the event
    ...
    /**
     * Set the maximum amount of bytes that can be added to this {@link io.netty.channel.unix.IovArray} via {@link #add(ByteBuf)}.
     * <p>
     * This will not impact the existing state of the {@link io.netty.channel.unix.IovArray}, and only applies to subsequent calls to
     * {@link #add(ByteBuf)}.
     * <p>
     * In order to ensure some progress is made at least one {@link ByteBuf} will be accepted even if it's size exceeds
     * this value.
     * @param maxBytes the maximum amount of bytes that can be added to this {@link io.netty.channel.unix.IovArray} via {@link #add(ByteBuf)}.
     */
    ...
    /**
     * Get the maximum amount of bytes that can be added to this {@link io.netty.channel.unix.IovArray} via {@link #add(ByteBuf)}.
     * @return the maximum amount of bytes that can be added to this {@link io.netty.channel.unix.IovArray} via {@link #add(ByteBuf)}.
     */
    ...
    /**
     * Release the {@link io.netty.channel.unix.IovArray}. Once release further using of it may crash the JVM!
     */
    public void release() {

...
/**
 * Native {@link io.netty.channel.unix.FileDescriptor} implementation which allows to wrap an {@code int} and provide a
 * {@link io.netty.channel.unix.FileDescriptor} for it.
 */
public class FileDescriptor {
    private static final ClosedChannelException WRITE_CLOSED_CHANNEL_EXCEPTION = ThrowableUtil.unknownStackTrace(
            new ClosedChannelException(), io.netty.channel.unix.FileDescriptor.class, "write(..)");
    private static final ClosedChannelException WRITE_ADDRESS_CLOSED_CHANNEL_EXCEPTION =
            ThrowableUtil.unknownStackTrace(new ClosedChannelException(), io.netty.channel.unix.FileDescriptor.class, "writeAddress(..)");
    private static final ClosedChannelException WRITEV_CLOSED_CHANNEL_EXCEPTION = ThrowableUtil.unknownStackTrace(
            new ClosedChannelException(), io.netty.channel.unix.FileDescriptor.class, "writev(..)");
    private static final ClosedChannelException WRITEV_ADDRESSES_CLOSED_CHANNEL_EXCEPTION =
            ThrowableUtil.unknownStackTrace(new ClosedChannelException(), io.netty.channel.unix.FileDescriptor.class, "writevAddresses(..)");
    private static final ClosedChannelException READ_CLOSED_CHANNEL_EXCEPTION = ThrowableUtil.unknownStackTrace(
            new ClosedChannelException(), io.netty.channel.unix.FileDescriptor.class, "read(..)");
    private static final ClosedChannelException READ_ADDRESS_CLOSED_CHANNEL_EXCEPTION = ThrowableUtil.unknownStackTrace(
            new ClosedChannelException(), io.netty.channel.unix.FileDescriptor.class, "readAddress(..)");
    private static final Errors.NativeIoException WRITE_CONNECTION_RESET_EXCEPTION = ThrowableUtil.unknownStackTrace(
            ...
            io.netty.channel.unix.FileDescriptor.class, "write(..)");
    private static final Errors.NativeIoException WRITE_ADDRESS_CONNECTION_RESET_EXCEPTION =
            ThrowableUtil.unknownStackTrace(Errors.newConnectionResetException("syscall:write",
                    Errors.ERRNO_EPIPE_NEGATIVE), io.netty.channel.unix.FileDescriptor.class, "writeAddress(..)");
    private static final Errors.NativeIoException WRITEV_CONNECTION_RESET_EXCEPTION = ThrowableUtil.unknownStackTrace(
            ...
            io.netty.channel.unix.FileDescriptor.class, "writev(..)");
    private static final Errors.NativeIoException WRITEV_ADDRESSES_CONNECTION_RESET_EXCEPTION =
            ThrowableUtil.unknownStackTrace(Errors.newConnectionResetException("syscall:writev",
                    Errors.ERRNO_EPIPE_NEGATIVE), io.netty.channel.unix.FileDescriptor.class, "writeAddresses(..)");
    private static final Errors.NativeIoException READ_CONNECTION_RESET_EXCEPTION = ThrowableUtil.unknownStackTrace(
            ...
            io.netty.channel.unix.FileDescriptor.class, "read(..)");
    private static final Errors.NativeIoException READ_ADDRESS_CONNECTION_RESET_EXCEPTION =
            ThrowableUtil.unknownStackTrace(Errors.newConnectionResetException("syscall:read",
                    Errors.ERRNO_ECONNRESET_NEGATIVE), io.netty.channel.unix.FileDescriptor.class, "readAddress(..)");

    private static final AtomicIntegerFieldUpdater<io.netty.channel.unix.FileDescriptor> stateUpdater =
            AtomicIntegerFieldUpdater.newUpdater(io.netty.channel.unix.FileDescriptor.class, "state");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof io.netty.channel.unix.FileDescriptor)) {
            return false;
        }

        return fd == ((io.netty.channel.unix.FileDescriptor) o).fd;
    }
    ...
    /**
     * Open a new {@link io.netty.channel.unix.FileDescriptor} for the given path.
     */
    public static io.netty.channel.unix.FileDescriptor from(String path) throws IOException {
        checkNotNull(path, "path");
        int res = open(path);
        if (res < 0) {
            throw newIOException("open", res);
        }
        return new io.netty.channel.unix.FileDescriptor(res);
    }

    /**
     * Open a new {@link io.netty.channel.unix.FileDescriptor} for the given {@link File}.
     */
    public static io.netty.channel.unix.FileDescriptor from(File file) throws IOException {
     ...
     */
    public static io.netty.channel.unix.FileDescriptor[] pipe() throws IOException {
        long res = newPipe();
        if (res < 0) {
            throw newIOException("newPipe", (int) res);
        }
        return new io.netty.channel.unix.FileDescriptor[]{new io.netty.channel.unix.FileDescriptor((int) (res >>> 32)), new io.netty.channel.unix.FileDescriptor((int) res)};
    }

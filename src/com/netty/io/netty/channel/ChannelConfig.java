 ...
 * {@link io.netty.channel.ChannelConfig}.  To update an option map, please call {@link #setOptions(Map)}.
 * <p>
...
public interface ChannelConfig {
     ...
     *                             {@code 0} to disable.
     */
    io.netty.channel.ChannelConfig setConnectTimeoutMillis(int connectTimeoutMillis);
     ...
     */
    io.netty.channel.ChannelConfig setWriteSpinCount(int writeSpinCount);
     ...
     * to allocate buffers.
     */
    io.netty.channel.ChannelConfig setAllocator(ByteBufAllocator allocator);
     ...
     */
    io.netty.channel.ChannelConfig setRecvByteBufAllocator(RecvByteBufAllocator allocator);
     ...
     */
    io.netty.channel.ChannelConfig setAutoRead(boolean autoRead);
     ...
     */
    @Deprecated
    io.netty.channel.ChannelConfig setAutoClose(boolean autoClose);
     ...
     * will start to return {@code false}.
     */
    io.netty.channel.ChannelConfig setWriteBufferHighWaterMark(int writeBufferHighWaterMark);
     ...
     * {@code true} again.
     */
    io.netty.channel.ChannelConfig setWriteBufferLowWaterMark(int writeBufferLowWaterMark);
     ...
     * to detect the size of a message.
     */
    io.netty.channel.ChannelConfig setMessageSizeEstimator(MessageSizeEstimator estimator);
     ...
     * water mark of the write buffer.
     */
    io.netty.channel.ChannelConfig setWriteBufferWaterMark(WriteBufferWaterMark writeBufferWaterMark);
}

 ...
 *         new {@link io.netty.channel.group.DefaultChannelGroup}({@link GlobalEventExecutor}.INSTANCE);</strong>
 ...
 * </pre>
 */
public interface ChannelGroup extends Set<Channel>, Comparable<io.netty.channel.group.ChannelGroup> {
     ...
     *         the operation is done for all channels
     */
    io.netty.channel.group.ChannelGroup flush();
     ...
     *         the operation is done for all channels
     */
    io.netty.channel.group.ChannelGroup flush(ChannelMatcher matcher);

 ...
 * {@link io.netty.channel.group.ChannelGroupFuture} is composed of {@link ChannelFuture}s which
...
public interface ChannelGroupFuture extends Future<Void>, Iterable<ChannelFuture> {
    ...
    @Override
    io.netty.channel.group.ChannelGroupFuture addListener(GenericFutureListener<? extends Future<? super Void>> listener);

    @Override
    io.netty.channel.group.ChannelGroupFuture addListeners(GenericFutureListener<? extends Future<? super Void>>... listeners);

    @Override
    io.netty.channel.group.ChannelGroupFuture removeListener(GenericFutureListener<? extends Future<? super Void>> listener);

    @Override
    io.netty.channel.group.ChannelGroupFuture removeListeners(GenericFutureListener<? extends Future<? super Void>>... listeners);

    @Override
    io.netty.channel.group.ChannelGroupFuture await() throws InterruptedException;

    @Override
    io.netty.channel.group.ChannelGroupFuture awaitUninterruptibly();

    @Override
    io.netty.channel.group.ChannelGroupFuture syncUninterruptibly();

    @Override
    io.netty.channel.group.ChannelGroupFuture sync() throws InterruptedException;

 ...
 * under the License.
 */
package com.netty.io.netty.channel.group;
...
/**
 * The default {@link io.netty.channel.group.ChannelGroupFuture} implementation.
 */
final class DefaultChannelGroupFuture extends DefaultPromise<Void> implements ChannelGroupFuture {
    ...
    private final ChannelFutureListener childListener = new ChannelFutureListener() {
        ...
        public void operationComplete(ChannelFuture future) throws Exception {
            ...
            boolean callSetDone;
            synchronized (io.netty.channel.group.DefaultChannelGroupFuture.this) {
                if (success) {
                    successCount ++;
                } else {
                    failureCount ++;
    ...
    @Override
    public io.netty.channel.group.DefaultChannelGroupFuture addListener(GenericFutureListener<? extends Future<? super Void>> listener) {
        super.addListener(listener);
        return this;
    }

    @Override
    public io.netty.channel.group.DefaultChannelGroupFuture addListeners(GenericFutureListener<? extends Future<? super Void>>... listeners) {
        super.addListeners(listeners);
        return this;
    }

    @Override
    public io.netty.channel.group.DefaultChannelGroupFuture removeListener(GenericFutureListener<? extends Future<? super Void>> listener) {
        super.removeListener(listener);
        return this;
    }

    @Override
    public io.netty.channel.group.DefaultChannelGroupFuture removeListeners(
    ...
    @Override
    public io.netty.channel.group.DefaultChannelGroupFuture await() throws InterruptedException {
        super.await();
        return this;
    }
    ...
    @Override
    public io.netty.channel.group.DefaultChannelGroupFuture sync() throws InterruptedException {
        super.sync();
        return this;
    }
    ...
    @Override
    public io.netty.channel.group.DefaultChannelGroupFuture setSuccess(Void result) {
    ...
    @Override
    public io.netty.channel.group.DefaultChannelGroupFuture setFailure(Throwable cause) {
        throw new IllegalStateException();
    }

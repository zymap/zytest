...
public final class VoidChannelPromise extends AbstractFuture<Void> implements ChannelPromise {
    ...
    @Override
    public io.netty.channel.VoidChannelPromise addListener(GenericFutureListener<? extends Future<? super Void>> listener) {
        fail();
        return this;
    }

    @Override
    public io.netty.channel.VoidChannelPromise addListeners(GenericFutureListener<? extends Future<? super Void>>... listeners) {
        fail();
        return this;
    }

    @Override
    public io.netty.channel.VoidChannelPromise removeListener(GenericFutureListener<? extends Future<? super Void>> listener) {
        // NOOP
        return this;
    }

    @Override
    public io.netty.channel.VoidChannelPromise removeListeners(GenericFutureListener<? extends Future<? super Void>>... listeners) {
        // NOOP
        return this;
    }

    @Override
    public io.netty.channel.VoidChannelPromise await() throws InterruptedException {
    ...
    @Override
    public io.netty.channel.VoidChannelPromise setFailure(Throwable cause) {
        fireException0(cause);
        return this;
    }
    ...
    @Override
    public io.netty.channel.VoidChannelPromise setSuccess(Void result) {
        return this;
    }

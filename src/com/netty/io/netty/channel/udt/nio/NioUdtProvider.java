...
public final class NioUdtProvider<T extends UdtChannel> implements ChannelFactory<T> {
     ...
     */
    public static final ChannelFactory<UdtServerChannel> BYTE_ACCEPTOR = new io.netty.channel.udt.nio.NioUdtProvider<UdtServerChannel>(
     ...
     */
    public static final ChannelFactory<UdtChannel> BYTE_CONNECTOR = new io.netty.channel.udt.nio.NioUdtProvider<UdtChannel>(
     ...
     */
    public static final ChannelFactory<UdtChannel> BYTE_RENDEZVOUS = new io.netty.channel.udt.nio.NioUdtProvider<UdtChannel>(
     ...
     */
    public static final ChannelFactory<UdtServerChannel> MESSAGE_ACCEPTOR = new io.netty.channel.udt.nio.NioUdtProvider<UdtServerChannel>(
     ...
     */
    public static final ChannelFactory<UdtChannel> MESSAGE_CONNECTOR = new io.netty.channel.udt.nio.NioUdtProvider<UdtChannel>(
     ...
     */
    public static final ChannelFactory<UdtChannel> MESSAGE_RENDEZVOUS = new io.netty.channel.udt.nio.NioUdtProvider<UdtChannel>(
    ...
    public static ChannelUDT channelUDT(final Channel channel) {
        ...
        // message
        if (channel instanceof io.netty.channel.udt.nio.NioUdtMessageAcceptorChannel) {
            return ((io.netty.channel.udt.nio.NioUdtMessageAcceptorChannel) channel).javaChannel();
        }

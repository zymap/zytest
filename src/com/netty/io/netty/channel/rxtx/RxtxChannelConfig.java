 ...
 * under the License.
 */
package com.netty.io.netty.channel.rxtx;
 ...
 * {@link io.netty.channel.rxtx.DefaultRxtxChannelConfig} allows the following options in the option map:
 *
...
public interface RxtxChannelConfig extends ChannelConfig {
     ...
     */
    io.netty.channel.rxtx.RxtxChannelConfig setBaudrate(int baudrate);
     ...
     */
    io.netty.channel.rxtx.RxtxChannelConfig setStopbits(Stopbits stopbits);
     ...
     */
    io.netty.channel.rxtx.RxtxChannelConfig setDatabits(Databits databits);
     ...
     */
    io.netty.channel.rxtx.RxtxChannelConfig setParitybit(Paritybit paritybit);
     ...
     */
    io.netty.channel.rxtx.RxtxChannelConfig setDtr(boolean dtr);
     ...
     */
    io.netty.channel.rxtx.RxtxChannelConfig setRts(boolean rts);
     ...
     */
    io.netty.channel.rxtx.RxtxChannelConfig setWaitTimeMillis(int waitTimeMillis);

    /**
     * Sets the maximal time (in ms) to block while try to read from the serial port. Default is 1000ms
     */
    io.netty.channel.rxtx.RxtxChannelConfig setReadTimeout(int readTimeout);
    ...
    @Override
    io.netty.channel.rxtx.RxtxChannelConfig setConnectTimeoutMillis(int connectTimeoutMillis);

    @Override
    @Deprecated
    io.netty.channel.rxtx.RxtxChannelConfig setMaxMessagesPerRead(int maxMessagesPerRead);

    @Override
    io.netty.channel.rxtx.RxtxChannelConfig setWriteSpinCount(int writeSpinCount);

    @Override
    io.netty.channel.rxtx.RxtxChannelConfig setAllocator(ByteBufAllocator allocator);

    @Override
    io.netty.channel.rxtx.RxtxChannelConfig setRecvByteBufAllocator(RecvByteBufAllocator allocator);

    @Override
    io.netty.channel.rxtx.RxtxChannelConfig setAutoRead(boolean autoRead);

    @Override
    io.netty.channel.rxtx.RxtxChannelConfig setAutoClose(boolean autoClose);

    @Override
    io.netty.channel.rxtx.RxtxChannelConfig setWriteBufferHighWaterMark(int writeBufferHighWaterMark);

    @Override
    io.netty.channel.rxtx.RxtxChannelConfig setWriteBufferLowWaterMark(int writeBufferLowWaterMark);

    @Override
    io.netty.channel.rxtx.RxtxChannelConfig setWriteBufferWaterMark(WriteBufferWaterMark writeBufferWaterMark);

    @Override
    io.netty.channel.rxtx.RxtxChannelConfig setMessageSizeEstimator(MessageSizeEstimator estimator);
}

...
public final class DelegatingChannelPromiseNotifier implements ChannelPromise, ChannelFutureListener {
    private static final InternalLogger logger =
            InternalLoggerFactory.getInstance(io.netty.channel.DelegatingChannelPromiseNotifier.class);
    ...
    public ChannelPromise unvoid() {
        return isVoid() ? new io.netty.channel.DelegatingChannelPromiseNotifier(delegate.unvoid()) : this;
    }

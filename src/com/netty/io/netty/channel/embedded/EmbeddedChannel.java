 ...
 * under the License.
 */
package com.netty.io.netty.channel.embedded;
...
public class EmbeddedChannel extends AbstractChannel {
    ...
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.channel.embedded.EmbeddedChannel.class);

    private static final ChannelMetadata METADATA_NO_DISCONNECT = new ChannelMetadata(false);
    private static final ChannelMetadata METADATA_DISCONNECT = new ChannelMetadata(true);

    private final io.netty.channel.embedded.EmbeddedEventLoop loop = new io.netty.channel.embedded.EmbeddedEventLoop();
    ...
    protected boolean isCompatible(EventLoop loop) {
        return loop instanceof io.netty.channel.embedded.EmbeddedEventLoop;
    }
    ...
    private final class EmbeddedUnsafe extends AbstractUnsafe {
        ...
        final Unsafe wrapped = new Unsafe() {
            ...
            public RecvByteBufAllocator.Handle recvBufAllocHandle() {
                return io.netty.channel.embedded.EmbeddedChannel.EmbeddedUnsafe.this.recvBufAllocHandle();
            }

            @Override
            public SocketAddress localAddress() {
                return io.netty.channel.embedded.EmbeddedChannel.EmbeddedUnsafe.this.localAddress();
            }

            @Override
            public SocketAddress remoteAddress() {
                return io.netty.channel.embedded.EmbeddedChannel.EmbeddedUnsafe.this.remoteAddress();
            }

            @Override
            public void register(EventLoop eventLoop, ChannelPromise promise) {
                io.netty.channel.embedded.EmbeddedChannel.EmbeddedUnsafe.this.register(eventLoop, promise);
                runPendingTasks();
            }

            @Override
            public void bind(SocketAddress localAddress, ChannelPromise promise) {
                io.netty.channel.embedded.EmbeddedChannel.EmbeddedUnsafe.this.bind(localAddress, promise);
                runPendingTasks();
            }

            @Override
            public void connect(SocketAddress remoteAddress, SocketAddress localAddress, ChannelPromise promise) {
                io.netty.channel.embedded.EmbeddedChannel.EmbeddedUnsafe.this.connect(remoteAddress, localAddress, promise);
                runPendingTasks();
            }

            @Override
            public void disconnect(ChannelPromise promise) {
                io.netty.channel.embedded.EmbeddedChannel.EmbeddedUnsafe.this.disconnect(promise);
                runPendingTasks();
            }

            @Override
            public void close(ChannelPromise promise) {
                io.netty.channel.embedded.EmbeddedChannel.EmbeddedUnsafe.this.close(promise);
                runPendingTasks();
            }

            @Override
            public void closeForcibly() {
                io.netty.channel.embedded.EmbeddedChannel.EmbeddedUnsafe.this.closeForcibly();
                runPendingTasks();
            }

            @Override
            public void deregister(ChannelPromise promise) {
                io.netty.channel.embedded.EmbeddedChannel.EmbeddedUnsafe.this.deregister(promise);
                runPendingTasks();
            }

            @Override
            public void beginRead() {
                io.netty.channel.embedded.EmbeddedChannel.EmbeddedUnsafe.this.beginRead();
                runPendingTasks();
            }

            @Override
            public void write(Object msg, ChannelPromise promise) {
                io.netty.channel.embedded.EmbeddedChannel.EmbeddedUnsafe.this.write(msg, promise);
                runPendingTasks();
            }

            @Override
            public void flush() {
                io.netty.channel.embedded.EmbeddedChannel.EmbeddedUnsafe.this.flush();
                runPendingTasks();
            }

            @Override
            public ChannelPromise voidPromise() {
                return io.netty.channel.embedded.EmbeddedChannel.EmbeddedUnsafe.this.voidPromise();
            }

            @Override
            public ChannelOutboundBuffer outboundBuffer() {
                return io.netty.channel.embedded.EmbeddedChannel.EmbeddedUnsafe.this.outboundBuffer();
            }
        };
    ...
    private final class EmbeddedChannelPipeline extends DefaultChannelPipeline {
        EmbeddedChannelPipeline(io.netty.channel.embedded.EmbeddedChannel channel) {
            super(channel);
        }

...
final class KQueueEventArray {
    ...
    /**
     * Return the {@code memoryAddress} which points to the start of this {@link io.netty.channel.kqueue.KQueueEventArray}.
     */
    long memoryAddress() {
    ...
    /**
     * Return the capacity of the {@link io.netty.channel.kqueue.KQueueEventArray} which represent the maximum number of {@code kevent}s
    ...
    /**
     * Increase the storage of this {@link io.netty.channel.kqueue.KQueueEventArray}.
     */
    ...
    /**
     * Free this {@link io.netty.channel.kqueue.KQueueEventArray}. Any usage after calling this method may segfault the JVM!
     */
    void free() {
    ...
    io.netty.channel.kqueue.AbstractKQueueChannel channel(int index) {
        return getChannel(getKEventOffset(index));
    }

    private static native void evSet(long keventAddress, io.netty.channel.kqueue.AbstractKQueueChannel ch,
                                     int ident, short filter, short flags, int fflags);
    private static native io.netty.channel.kqueue.AbstractKQueueChannel getChannel(long keventAddress);

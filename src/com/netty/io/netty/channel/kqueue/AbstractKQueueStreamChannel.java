...
public abstract class AbstractKQueueStreamChannel extends AbstractKQueueChannel implements DuplexChannel {
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.channel.kqueue.AbstractKQueueStreamChannel.class);
    ...
    private final class KQueueSocketWritableByteChannel extends SocketWritableByteChannel {
        ...
        protected ByteBufAllocator alloc() {
            return io.netty.channel.kqueue.AbstractKQueueStreamChannel.this.alloc();
        }
    }
}

...
public final class KQueueServerDomainSocketChannel extends AbstractKQueueServerChannel
    ...
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(
            io.netty.channel.kqueue.KQueueServerDomainSocketChannel.class);
    ...
    public KQueueServerDomainSocketChannel(int fd) {
        this(new io.netty.channel.kqueue.BsdSocket(fd), false);
    }

    KQueueServerDomainSocketChannel(io.netty.channel.kqueue.BsdSocket socket, boolean active) {
        super(socket, active);
    }

    @Override
    protected Channel newChildChannel(int fd, byte[] addr, int offset, int len) throws Exception {
        return new KQueueDomainSocketChannel(this, new io.netty.channel.kqueue.BsdSocket(fd));
    }

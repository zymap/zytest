...
public final class KQueueChannelOption<T> extends UnixChannelOption<T> {
    public static final ChannelOption<Integer> SO_SNDLOWAT = valueOf(io.netty.channel.kqueue.KQueueChannelOption.class, "SO_SNDLOWAT");
    public static final ChannelOption<Boolean> TCP_NOPUSH = valueOf(io.netty.channel.kqueue.KQueueChannelOption.class, "TCP_NOPUSH");
    public static final ChannelOption<AcceptFilter> SO_ACCEPTFILTER =
            valueOf(io.netty.channel.kqueue.KQueueChannelOption.class, "SO_ACCEPTFILTER");
    /**
    ...
    public static final ChannelOption<Boolean> RCV_ALLOC_TRANSPORT_PROVIDES_GUESS =
            valueOf(io.netty.channel.kqueue.KQueueChannelOption.class, "RCV_ALLOC_TRANSPORT_PROVIDES_GUESS");

...
abstract class AbstractKQueueChannel extends AbstractChannel implements UnixChannel {
     ...
     * we can ask JNI to give us the {@link io.netty.channel.kqueue.AbstractKQueueChannel} that corresponds to that event.
     */
    long jniSelfPtr;
    ...
    abstract class AbstractKQueueUnsafe extends AbstractUnsafe {
        ...
        final boolean failConnectPromise(Throwable cause) {
            if (connectPromise != null) {
                ...
                ChannelPromise connectPromise = io.netty.channel.kqueue.AbstractKQueueChannel.this.connectPromise;
                io.netty.channel.kqueue.AbstractKQueueChannel.this.connectPromise = null;

 ...
 */
final class Native {
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.channel.kqueue.Native.class);
    ...
    static int keventWait(int kqueueFd, io.netty.channel.kqueue.KQueueEventArray changeList, io.netty.channel.kqueue.KQueueEventArray eventList,
    ...
    private static void loadNativeLibrary() {
        ...
        ClassLoader cl = PlatformDependent.getClassLoader(io.netty.channel.kqueue.Native.class);
        try {

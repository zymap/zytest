...
public final class KQueueServerSocketChannel extends AbstractKQueueServerChannel implements ServerSocketChannel {
    ...
    public KQueueServerSocketChannel(int fd) {
        ...
        this(new io.netty.channel.kqueue.BsdSocket(fd));
    }

    KQueueServerSocketChannel(io.netty.channel.kqueue.BsdSocket fd) {
        super(fd);
        config = new KQueueServerSocketChannelConfig(this);
    }

    KQueueServerSocketChannel(io.netty.channel.kqueue.BsdSocket fd, boolean active) {
        super(fd, active);
        config = new KQueueServerSocketChannelConfig(this);
    }
    ...
    protected Channel newChildChannel(int fd, byte[] address, int offset, int len) throws Exception {
        return new KQueueSocketChannel(this, new io.netty.channel.kqueue.BsdSocket(fd), address(address, offset, len));
    }
}

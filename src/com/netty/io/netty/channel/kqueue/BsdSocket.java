...
final class BsdSocket extends Socket {
    ...
    public static io.netty.channel.kqueue.BsdSocket newSocketStream() {
        return new io.netty.channel.kqueue.BsdSocket(newSocketStream0());
    }

    public static io.netty.channel.kqueue.BsdSocket newSocketDgram() {
        return new io.netty.channel.kqueue.BsdSocket(newSocketDgram0());
    }

    public static io.netty.channel.kqueue.BsdSocket newSocketDomain() {
        return new io.netty.channel.kqueue.BsdSocket(newSocketDomain0());
    }

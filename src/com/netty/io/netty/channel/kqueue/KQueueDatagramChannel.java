...
@UnstableApi
public final class KQueueDatagramChannel extends io.netty.channel.kqueue.AbstractKQueueChannel implements DatagramChannel {
    ...
    public KQueueDatagramChannel(int fd) {
        this(new io.netty.channel.kqueue.BsdSocket(fd), true);
    }

    KQueueDatagramChannel(io.netty.channel.kqueue.BsdSocket socket, boolean active) {

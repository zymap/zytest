...
public final class AcceptFilter {
    static final io.netty.channel.kqueue.AcceptFilter PLATFORM_UNSUPPORTED = new io.netty.channel.kqueue.AcceptFilter("", "");
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof io.netty.channel.kqueue.AcceptFilter)) {
            return false;
        }
        io.netty.channel.kqueue.AcceptFilter rhs = (io.netty.channel.kqueue.AcceptFilter) o;

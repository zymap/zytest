...
public final class KQueueDatagramChannelConfig extends KQueueChannelConfig implements DatagramChannelConfig {
     ...
     * any affect.
     */
    public io.netty.channel.kqueue.KQueueDatagramChannelConfig setReusePort(boolean reusePort) {
        try {
    ...
    @Override
    public io.netty.channel.kqueue.KQueueDatagramChannelConfig setRcvAllocTransportProvidesGuess(boolean transportProvidesGuess) {
        super.setRcvAllocTransportProvidesGuess(transportProvidesGuess);
        return this;
    }

    @Override
    public io.netty.channel.kqueue.KQueueDatagramChannelConfig setMessageSizeEstimator(MessageSizeEstimator estimator) {
    ...
    @Override
    @Deprecated
    public io.netty.channel.kqueue.KQueueDatagramChannelConfig setWriteBufferLowWaterMark(int writeBufferLowWaterMark) {
    ...
    @Override
    @Deprecated
    public io.netty.channel.kqueue.KQueueDatagramChannelConfig setWriteBufferHighWaterMark(int writeBufferHighWaterMark) {
        super.setWriteBufferHighWaterMark(writeBufferHighWaterMark);
        return this;
    }

    @Override
    public io.netty.channel.kqueue.KQueueDatagramChannelConfig setWriteBufferWaterMark(WriteBufferWaterMark writeBufferWaterMark) {
        super.setWriteBufferWaterMark(writeBufferWaterMark);
        return this;
    }

    @Override
    public io.netty.channel.kqueue.KQueueDatagramChannelConfig setAutoClose(boolean autoClose) {
        super.setAutoClose(autoClose);
        return this;
    }

    @Override
    public io.netty.channel.kqueue.KQueueDatagramChannelConfig setAutoRead(boolean autoRead) {
        super.setAutoRead(autoRead);
        return this;
    }

    @Override
    public io.netty.channel.kqueue.KQueueDatagramChannelConfig setRecvByteBufAllocator(RecvByteBufAllocator allocator) {
        super.setRecvByteBufAllocator(allocator);
        return this;
    }

    @Override
    public io.netty.channel.kqueue.KQueueDatagramChannelConfig setWriteSpinCount(int writeSpinCount) {
        super.setWriteSpinCount(writeSpinCount);
        return this;
    }

    @Override
    public io.netty.channel.kqueue.KQueueDatagramChannelConfig setAllocator(ByteBufAllocator allocator) {
        super.setAllocator(allocator);
        return this;
    }

    @Override
    public io.netty.channel.kqueue.KQueueDatagramChannelConfig setConnectTimeoutMillis(int connectTimeoutMillis) {
    ...
    @Override
    @Deprecated
    public io.netty.channel.kqueue.KQueueDatagramChannelConfig setMaxMessagesPerRead(int maxMessagesPerRead) {
    ...
    @Override
    public io.netty.channel.kqueue.KQueueDatagramChannelConfig setSendBufferSize(int sendBufferSize) {
        try {
    ...
    @Override
    public io.netty.channel.kqueue.KQueueDatagramChannelConfig setReceiveBufferSize(int receiveBufferSize) {
        try {
    ...
    @Override
    public io.netty.channel.kqueue.KQueueDatagramChannelConfig setTrafficClass(int trafficClass) {
        try {
    ...
    @Override
    public io.netty.channel.kqueue.KQueueDatagramChannelConfig setReuseAddress(boolean reuseAddress) {
        try {
    ...
    @Override
    public io.netty.channel.kqueue.KQueueDatagramChannelConfig setBroadcast(boolean broadcast) {
        try {
    ...
    @Override
    public io.netty.channel.kqueue.KQueueDatagramChannelConfig setTimeToLive(int ttl) {
        throw new UnsupportedOperationException("Multicast not supported");
    }
    ...
    @Override
    public io.netty.channel.kqueue.KQueueDatagramChannelConfig setInterface(InetAddress interfaceAddress) {
        throw new UnsupportedOperationException("Multicast not supported");
    }
    ...
    @Override
    public io.netty.channel.kqueue.KQueueDatagramChannelConfig setNetworkInterface(NetworkInterface networkInterface) {
        throw new UnsupportedOperationException("Multicast not supported");
    }
}

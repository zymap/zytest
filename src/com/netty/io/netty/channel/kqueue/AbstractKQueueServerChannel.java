...
@UnstableApi
public abstract class AbstractKQueueServerChannel extends io.netty.channel.kqueue.AbstractKQueueChannel implements ServerChannel {
    private static final ChannelMetadata METADATA = new ChannelMetadata(false, 16);

    AbstractKQueueServerChannel(io.netty.channel.kqueue.BsdSocket fd) {
        this(fd, isSoErrorZero(fd));
    }

    AbstractKQueueServerChannel(io.netty.channel.kqueue.BsdSocket fd, boolean active) {
    ...
    final class KQueueServerSocketUnsafe extends AbstractKQueueUnsafe {
        ...
        @Override
        void readReady(io.netty.channel.kqueue.KQueueRecvByteAllocatorHandle allocHandle) {

...
public interface FileRegion extends ReferenceCounted {
    ...
    @Override
    io.netty.channel.FileRegion retain();

    @Override
    io.netty.channel.FileRegion retain(int increment);

    @Override
    io.netty.channel.FileRegion touch();

    @Override
    io.netty.channel.FileRegion touch(Object hint);
}

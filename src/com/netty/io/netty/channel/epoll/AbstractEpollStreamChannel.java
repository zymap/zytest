...
public abstract class AbstractEpollStreamChannel extends io.netty.channel.epoll.AbstractEpollChannel implements DuplexChannel {
    private static final ChannelMetadata METADATA = new ChannelMetadata(false, 16);
    private static final String EXPECTED_TYPES =
            " (expected: " + StringUtil.simpleClassName(ByteBuf.class) + ", " +
                    StringUtil.simpleClassName(DefaultFileRegion.class) + ')';
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.channel.epoll.AbstractEpollStreamChannel.class);
    private static final ClosedChannelException CLEAR_SPLICE_QUEUE_CLOSED_CHANNEL_EXCEPTION =
            ThrowableUtil.unknownStackTrace(new ClosedChannelException(),
                    io.netty.channel.epoll.AbstractEpollStreamChannel.class, "clearSpliceQueue()");
    private static final ClosedChannelException SPLICE_TO_CLOSED_CHANNEL_EXCEPTION = ThrowableUtil.unknownStackTrace(
            new ClosedChannelException(),
            io.netty.channel.epoll.AbstractEpollStreamChannel.class, "spliceTo(...)");
    private static final ClosedChannelException FAIL_SPLICE_IF_CLOSED_CLOSED_CHANNEL_EXCEPTION =
            ThrowableUtil.unknownStackTrace(new ClosedChannelException(),
            io.netty.channel.epoll.AbstractEpollStreamChannel.class, "failSpliceIfClosed(...)");
    ...
    /**
     * Splice from this {@link io.netty.channel.epoll.AbstractEpollStreamChannel} to another {@link io.netty.channel.epoll.AbstractEpollStreamChannel}.
     ...
     *   target {@link io.netty.channel.epoll.AbstractEpollStreamChannel}</li>
     * </ul>
     *
     */
    public final ChannelFuture spliceTo(final io.netty.channel.epoll.AbstractEpollStreamChannel ch, final int len) {
    ...
    /**
     * Splice from this {@link io.netty.channel.epoll.AbstractEpollStreamChannel} to another {@link FileDescriptor}.
     ...
     *   {@link io.netty.channel.epoll.AbstractEpollStreamChannel}</li>
    ...
    class EpollStreamUnsafe extends AbstractEpollUnsafe {
        ...
        @Override
        io.netty.channel.epoll.EpollRecvByteAllocatorHandle newEpollHandle(RecvByteBufAllocator.ExtendedHandle handle) {
            return new io.netty.channel.epoll.EpollRecvByteAllocatorStreamingHandle(handle);
        }
        ...
        void epollInReady() {
            ...
            final io.netty.channel.epoll.EpollRecvByteAllocatorHandle allocHandle = recvBufAllocHandle();
    ...
    private final class SpliceInChannelTask extends SpliceInTask implements ChannelFutureListener {
        ...
        SpliceInChannelTask(io.netty.channel.epoll.AbstractEpollStreamChannel ch, int len, ChannelPromise promise) {
            super(len, promise);
            this.ch = ch;
        }
    ...
    private final class SpliceOutTask {
        ...
        SpliceOutTask(io.netty.channel.epoll.AbstractEpollStreamChannel ch, int len, boolean autoRead) {
            this.ch = ch;
            this.len = len;
    ...
    private final class EpollSocketWritableByteChannel extends SocketWritableByteChannel {
        ...
        protected ByteBufAllocator alloc() {
            return io.netty.channel.epoll.AbstractEpollStreamChannel.this.alloc();
        }
    }
}

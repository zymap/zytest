...
final class NativeDatagramPacketArray implements ChannelOutboundBuffer.MessageProcessor {
    ...
    private static final FastThreadLocal<io.netty.channel.epoll.NativeDatagramPacketArray> ARRAY =
            new FastThreadLocal<io.netty.channel.epoll.NativeDatagramPacketArray>() {
                @Override
                protected io.netty.channel.epoll.NativeDatagramPacketArray initialValue() throws Exception {
                    return new io.netty.channel.epoll.NativeDatagramPacketArray();
                }

                @Override
                protected void onRemoval(io.netty.channel.epoll.NativeDatagramPacketArray value) throws Exception {
    ...
    /**
     * Returns a {@link io.netty.channel.epoll.NativeDatagramPacketArray} which is filled with the flushed messages of
     * {@link ChannelOutboundBuffer}.
     */
    static io.netty.channel.epoll.NativeDatagramPacketArray getInstance(ChannelOutboundBuffer buffer) throws Exception {
        io.netty.channel.epoll.NativeDatagramPacketArray array = ARRAY.get();
        array.count = 0;

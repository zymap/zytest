 ...
 * {@link io.netty.channel.epoll.AbstractEpollChannel} and so be able to map it later.
 */
final class EpollEventArray {
    ...
    /**
     * Return the {@code memoryAddress} which points to the start of this {@link io.netty.channel.epoll.EpollEventArray}.
     */
    long memoryAddress() {
    ...
    /**
     * Return the length of the {@link io.netty.channel.epoll.EpollEventArray} which represent the maximum number of {@code epoll_events}
    ...
    /**
     * Increase the storage of this {@link io.netty.channel.epoll.EpollEventArray}.
     */
    void increase() {
        // double the size
        length <<= 1;
    ...
    /**
     * Free this {@link io.netty.channel.epoll.EpollEventArray}. Any usage after calling this method may segfault the JVM!
     */
    void free() {

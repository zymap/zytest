...
public final class EpollSocketChannelConfig extends EpollChannelConfig implements SocketChannelConfig {
    ...
    @Override
    public io.netty.channel.epoll.EpollSocketChannelConfig setKeepAlive(boolean keepAlive) {
        try {
    ...
    @Override
    public io.netty.channel.epoll.EpollSocketChannelConfig setPerformancePreferences(
            int connectionTime, int latency, int bandwidth) {
        return this;
    }

    @Override
    public io.netty.channel.epoll.EpollSocketChannelConfig setReceiveBufferSize(int receiveBufferSize) {
        try {
    ...
    @Override
    public io.netty.channel.epoll.EpollSocketChannelConfig setReuseAddress(boolean reuseAddress) {
        try {
    ...
    @Override
    public io.netty.channel.epoll.EpollSocketChannelConfig setSendBufferSize(int sendBufferSize) {
        try {
    ...
    @Override
    public io.netty.channel.epoll.EpollSocketChannelConfig setSoLinger(int soLinger) {
        try {
    ...
    @Override
    public io.netty.channel.epoll.EpollSocketChannelConfig setTcpNoDelay(boolean tcpNoDelay) {
        try {
     ...
     */
    public io.netty.channel.epoll.EpollSocketChannelConfig setTcpCork(boolean tcpCork) {
        try {
     ...
     */
    public io.netty.channel.epoll.EpollSocketChannelConfig setTcpNotSentLowAt(long tcpNotSentLowAt) {
        try {
    ...
    @Override
    public io.netty.channel.epoll.EpollSocketChannelConfig setTrafficClass(int trafficClass) {
        try {
     ...
     */
    public io.netty.channel.epoll.EpollSocketChannelConfig setTcpKeepIdle(int seconds) {
        try {
     ...
     */
    public io.netty.channel.epoll.EpollSocketChannelConfig setTcpKeepIntvl(int seconds) {
        try {
     ...
     */
    @Deprecated
    public io.netty.channel.epoll.EpollSocketChannelConfig setTcpKeepCntl(int probes) {
     ...
     */
    public io.netty.channel.epoll.EpollSocketChannelConfig setTcpKeepCnt(int probes) {
        try {
     ...
     */
    public io.netty.channel.epoll.EpollSocketChannelConfig setTcpUserTimeout(int milliseconds) {
        try {
     ...
     */
    public io.netty.channel.epoll.EpollSocketChannelConfig setIpTransparent(boolean transparent) {
        try {
     ...
     */
    public io.netty.channel.epoll.EpollSocketChannelConfig setTcpMd5Sig(Map<InetAddress, byte[]> keys) {
        try {
     ...
     * for more details.
     */
    public io.netty.channel.epoll.EpollSocketChannelConfig setTcpQuickAck(boolean quickAck) {
        try {
     ...
     * for more details.
     */
    public io.netty.channel.epoll.EpollSocketChannelConfig setTcpFastOpenConnect(boolean fastOpenConnect) {
        try {
    ...
    @Override
    public io.netty.channel.epoll.EpollSocketChannelConfig setAllowHalfClosure(boolean allowHalfClosure) {
        this.allowHalfClosure = allowHalfClosure;
        return this;
    }

    @Override
    public io.netty.channel.epoll.EpollSocketChannelConfig setConnectTimeoutMillis(int connectTimeoutMillis) {
    ...
    @Override
    @Deprecated
    public io.netty.channel.epoll.EpollSocketChannelConfig setMaxMessagesPerRead(int maxMessagesPerRead) {
        super.setMaxMessagesPerRead(maxMessagesPerRead);
        return this;
    }

    @Override
    public io.netty.channel.epoll.EpollSocketChannelConfig setWriteSpinCount(int writeSpinCount) {
        super.setWriteSpinCount(writeSpinCount);
        return this;
    }

    @Override
    public io.netty.channel.epoll.EpollSocketChannelConfig setAllocator(ByteBufAllocator allocator) {
        super.setAllocator(allocator);
        return this;
    }

    @Override
    public io.netty.channel.epoll.EpollSocketChannelConfig setRecvByteBufAllocator(RecvByteBufAllocator allocator) {
        super.setRecvByteBufAllocator(allocator);
        return this;
    }

    @Override
    public io.netty.channel.epoll.EpollSocketChannelConfig setAutoRead(boolean autoRead) {
        super.setAutoRead(autoRead);
        return this;
    }

    @Override
    public io.netty.channel.epoll.EpollSocketChannelConfig setAutoClose(boolean autoClose) {
    ...
    @Override
    @Deprecated
    public io.netty.channel.epoll.EpollSocketChannelConfig setWriteBufferHighWaterMark(int writeBufferHighWaterMark) {
    ...
    @Override
    @Deprecated
    public io.netty.channel.epoll.EpollSocketChannelConfig setWriteBufferLowWaterMark(int writeBufferLowWaterMark) {
        super.setWriteBufferLowWaterMark(writeBufferLowWaterMark);
        return this;
    }

    @Override
    public io.netty.channel.epoll.EpollSocketChannelConfig setWriteBufferWaterMark(WriteBufferWaterMark writeBufferWaterMark) {
        super.setWriteBufferWaterMark(writeBufferWaterMark);
        return this;
    }

    @Override
    public io.netty.channel.epoll.EpollSocketChannelConfig setMessageSizeEstimator(MessageSizeEstimator estimator) {
        super.setMessageSizeEstimator(estimator);
        return this;
    }

    @Override
    public io.netty.channel.epoll.EpollSocketChannelConfig setEpollMode(EpollMode mode) {

...
public final class EpollServerSocketChannelConfig extends EpollServerChannelConfig
    ...
    @Override
    public io.netty.channel.epoll.EpollServerSocketChannelConfig setReuseAddress(boolean reuseAddress) {
        super.setReuseAddress(reuseAddress);
        return this;
    }

    @Override
    public io.netty.channel.epoll.EpollServerSocketChannelConfig setReceiveBufferSize(int receiveBufferSize) {
        super.setReceiveBufferSize(receiveBufferSize);
        return this;
    }

    @Override
    public io.netty.channel.epoll.EpollServerSocketChannelConfig setPerformancePreferences(int connectionTime, int latency, int bandwidth) {
        return this;
    }

    @Override
    public io.netty.channel.epoll.EpollServerSocketChannelConfig setBacklog(int backlog) {
        super.setBacklog(backlog);
        return this;
    }

    @Override
    public io.netty.channel.epoll.EpollServerSocketChannelConfig setConnectTimeoutMillis(int connectTimeoutMillis) {
    ...
    @Override
    @Deprecated
    public io.netty.channel.epoll.EpollServerSocketChannelConfig setMaxMessagesPerRead(int maxMessagesPerRead) {
        super.setMaxMessagesPerRead(maxMessagesPerRead);
        return this;
    }

    @Override
    public io.netty.channel.epoll.EpollServerSocketChannelConfig setWriteSpinCount(int writeSpinCount) {
        super.setWriteSpinCount(writeSpinCount);
        return this;
    }

    @Override
    public io.netty.channel.epoll.EpollServerSocketChannelConfig setAllocator(ByteBufAllocator allocator) {
        super.setAllocator(allocator);
        return this;
    }

    @Override
    public io.netty.channel.epoll.EpollServerSocketChannelConfig setRecvByteBufAllocator(RecvByteBufAllocator allocator) {
        super.setRecvByteBufAllocator(allocator);
        return this;
    }

    @Override
    public io.netty.channel.epoll.EpollServerSocketChannelConfig setAutoRead(boolean autoRead) {
    ...
    @Override
    @Deprecated
    public io.netty.channel.epoll.EpollServerSocketChannelConfig setWriteBufferHighWaterMark(int writeBufferHighWaterMark) {
    ...
    @Override
    @Deprecated
    public io.netty.channel.epoll.EpollServerSocketChannelConfig setWriteBufferLowWaterMark(int writeBufferLowWaterMark) {
        super.setWriteBufferLowWaterMark(writeBufferLowWaterMark);
        return this;
    }

    @Override
    public io.netty.channel.epoll.EpollServerSocketChannelConfig setWriteBufferWaterMark(WriteBufferWaterMark writeBufferWaterMark) {
        super.setWriteBufferWaterMark(writeBufferWaterMark);
        return this;
    }

    @Override
    public io.netty.channel.epoll.EpollServerSocketChannelConfig setMessageSizeEstimator(MessageSizeEstimator estimator) {
     ...
     */
    public io.netty.channel.epoll.EpollServerSocketChannelConfig setTcpMd5Sig(Map<InetAddress, byte[]> keys) {
        try {
     ...
     * any affect.
     */
    public io.netty.channel.epoll.EpollServerSocketChannelConfig setReusePort(boolean reusePort) {
        try {
     ...
     */
    public io.netty.channel.epoll.EpollServerSocketChannelConfig setFreeBind(boolean freeBind) {
        try {
     ...
     * {@code false} for disable it. Default is disabled.
     */
    public io.netty.channel.epoll.EpollServerSocketChannelConfig setIpTransparent(boolean transparent) {
        try {
     ...
     */
    public io.netty.channel.epoll.EpollServerSocketChannelConfig setTcpDeferAccept(int deferAccept) {
        try {

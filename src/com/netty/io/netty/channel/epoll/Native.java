 ...
 * <p>Static members which call JNI methods must be defined in {@link io.netty.channel.epoll.NativeStaticallyReferencedJniMethods}.
 */
public final class Native {
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.channel.epoll.Native.class);
    ...
    private static final ClosedChannelException SENDMMSG_CLOSED_CHANNEL_EXCEPTION = ThrowableUtil.unknownStackTrace(
            new ClosedChannelException(), io.netty.channel.epoll.Native.class, "sendmmsg(...)");
    private static final ClosedChannelException SPLICE_CLOSED_CHANNEL_EXCEPTION = ThrowableUtil.unknownStackTrace(
            new ClosedChannelException(), io.netty.channel.epoll.Native.class, "splice(...)");
    ...
    public static int epollWait(FileDescriptor epollFd, io.netty.channel.epoll.EpollEventArray events, FileDescriptor timerFd,
    ...
    public static int sendmmsg(
            int fd, io.netty.channel.epoll.NativeDatagramPacketArray.NativeDatagramPacket[] msgs, int offset, int len) throws IOException {
    ...
    private static native int sendmmsg0(
            int fd, io.netty.channel.epoll.NativeDatagramPacketArray.NativeDatagramPacket[] msgs, int offset, int len);
    ...
    private static void loadNativeLibrary() {
        ...
        ClassLoader cl = PlatformDependent.getClassLoader(io.netty.channel.epoll.Native.class);
        try {

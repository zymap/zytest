...
public abstract class AbstractChannel extends DefaultAttributeMap implements Channel {
    ...
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(io.netty.channel.AbstractChannel.class);
     ...
     * {@link io.netty.channel.ChannelId}s to {@link Channel}s that use the {@link io.netty.channel.AbstractChannel#AbstractChannel(Channel)} constructor.
     */
    ...
    protected abstract class AbstractUnsafe implements Unsafe {
        ...
        private volatile ChannelOutboundBuffer outboundBuffer = new ChannelOutboundBuffer(io.netty.channel.AbstractChannel.this);
        ...
        public final void register(EventLoop eventLoop, final ChannelPromise promise) {
            ...
            io.netty.channel.AbstractChannel.this.eventLoop = eventLoop;
            ...
            if (eventLoop.inEventLoop()) {
                ...
                try {
                    ...
                    logger.warn(
                            ...
                            io.netty.channel.AbstractChannel.this, t);
                    closeForcibly();
    ...
    /**
     * Invoked when a new message is added to a {@link ChannelOutboundBuffer} of this {@link io.netty.channel.AbstractChannel}, so that
    ...
    static final class CloseFuture extends DefaultChannelPromise {
        ...
        CloseFuture(io.netty.channel.AbstractChannel ch) {
            super(ch);
        }
